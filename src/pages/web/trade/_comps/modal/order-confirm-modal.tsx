...
import { Modal, ModalContent, ModalFooter, ModalHeader, ModalTitle, ModalTrigger } from '@/libs/ui/components/modal'
            ...
            <div className="gap-2xl flex flex-col">
              ...
              <div className="gap-medium flex flex-col">
                ...
                <div className="flex justify-between gap-1">
                  ...
                  <div className="text-paragraph-p1 text-white">{BNumber.toFormatNumber(100, { unit: 'USDC', volScale: 2 })}</div>
                </div>
                <div className="flex justify-between gap-1">
                  <div className="text-paragraph-p1 text-content-4">
                    <Trans>合约价值</Trans>
