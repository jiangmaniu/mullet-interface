...
const SettingPendingTpSlModalContent = observer(({ pendingOrderInfo, onConfirm, onClose }: SettingPendingTpSlModalContentProps) => {
  ...
  const { setSl, setSp, slFlag, spFlag, takeProfit, stopLoss, disabledBtnByCondition } = useTrade({ marketItem: pendingOrderInfo })
  ...
  const handleClosePosition = async () => {
    ...
    const params = {
      bagOrderId: pendingOrderInfo.id,
          ...
          <div className="gap-2xl flex flex-col">
            ...
            <div className="gap-2xl flex flex-col">
              <div className="flex justify-between gap-1">
                ...
                {/* <div className="text-paragraph-p2 text-market-rise">{BNumber.toFormatNumber(pendingOrderInfo?.startPrice)}</div> */}
              </div>
              <div className="flex justify-between gap-1">
                <div className="text-paragraph-p2 text-content-4">
                  <Trans>标记价格</Trans>
