...
export const TRADE_ORDER_TYPE_MAP: Record<TradeOrderTypeEnum, TradeOrderTypeOption> = TRADE_ORDER_TYPE_OPTIONS.reduce((map, option) => {
...
export const TRADE_ORDER_DIRECTION_MAP: Record<TradeOrderDirectionEnum, TradeOrderDirectionOption> = TRADE_ORDER_DIRECTION_OPTIONS.reduce(
  (map, option) => {
    map[option.value] = option
    return map
  },
