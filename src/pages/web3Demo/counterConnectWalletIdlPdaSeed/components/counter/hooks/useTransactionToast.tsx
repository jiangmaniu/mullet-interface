 ...
 */
export function useTransactionToast({ transactionSignature }: UseTransactionToastProps) {
  ...
  useEffect(() => {
    if (transactionSignature) {
      ...
      toastIdRef.current = toast.success('Transaction Sent!', {
        description: <ToastContent transactionSignature={transactionSignature} explorerUrl={explorerUrl} />,
        style: {
