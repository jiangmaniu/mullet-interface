...
function Ae(e, t) {
  const i = { ...e }
  for (const o in t)
    'object' != typeof e[o] || null === e[o] || Array.isArray(e[o]) ? void 0 !== t[o] && (i[o] = t[o]) : (i[o] = Ae(e[o], t[o]))
  return i
}
!(function (e) {
...
const De = class {
  ...
  _render(e, t) {
    ...
    const r = (function (e, t) {
      ...
      return `<!DOCTYPE html><html ${(c = { bundles: l, localeLanguage: n, htmlAttrs: s, libraryPath: o }).htmlAttrs}><head><base href="${
        c.libraryPath
