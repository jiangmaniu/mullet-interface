      ...
      function h(e) {
        ...
        return n.createElement(
          V,
          {
            ...
            'aria-selected': h,
            'aria-checked': p,
            className: r(m, R.item, E && R.withIcon, { [R.isActive]: k, [R.isDisabled]: C || x, [R.hovered]: D }),
            title: f,
            href: y,
            target: T,
            rel: M,
          ...
          n.createElement('span', { className: r(R.labelRow, v) }, n.createElement('span', { className: r(R.label, g) }, N)),
          (void 0 !== b || w) && n.createElement('span', { className: R.shortcut }, (q = b) && q.split('+').join(' + ')),
          void 0 !== B &&
            n.createElement('span', { onClick: S ? u : void 0, className: r(R.toolbox, { [R.showOnHover]: _, [R.showOnFocus]: O }) }, B)
        )
        let q
      }
    },
      ...
      function l(e, t) {
        return (o, l, d, u) => {
          ...
          let E = null !== (h = t.verticalAttachEdge) && void 0 !== h ? h : c.verticalAttachEdge,
            k = null !== (p = t.verticalDropDirection) && void 0 !== p ? p : c.verticalDropDirection
          E === n.AutoStrict &&
            (u < m.y + m.height + b + l ? ((E = n.Top), (k = i.FromBottomToTop)) : ((E = n.Bottom), (k = i.FromTopToBottom)))
          const C = E === n.Top ? -1 * b : b,
            D = f === r.Right ? m.right : m.left,
            x = E === n.Top ? m.top : m.bottom,
            N = { x: D - (v === a.FromRightToLeft ? o : 0) + g, y: x - (k === i.FromBottomToTop ? l : 0) + C }
      ...
      const s = a,
        c = n.forwardRef((e, t) => {
          ...
          return 'button' === o
            ...
            : n.createElement(
                'div',
                { ...x, ref: t, 'data-role': 'button', className: N, onClick: u ? void 0 : m, title: g, 'data-name': C, 'data-tooltip': D },
                v && f && n.createElement('div', { className: r('js-button-text', b.text) }, f),
                y,
                !v && f && n.createElement('div', { className: r('js-button-text', b.text) }, f),
      ...
      class v extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleClick = (e) => {
              const t = p.enabled('skip_event_target_check') || e.target instanceof Node
              try {
                t &&
                ...
                console.warn("Using 'skip_event_target_check', code still failed.")
              }
            }),
            ...
            ? n.createElement(
                ...
                o &&
                  n.createElement(
                    'div',
                    { className: f.arrow },
                    n.createElement('div', { className: f.arrowWrap }, n.createElement(s.ToolWidgetCaret, { dropped: b }))
                  ),
                this.state.isOpened &&
                  (v ? n.createElement(h.MatchMedia, { rule: v }, (e) => this._renderContent(e)) : this._renderContent(l))
              )
            : n.createElement(
                'div',
                {
        ...
        _renderContent(e) {
          const { menuDataName: t, minWidth: o, menuClassName: r, maxHeight: i, drawerPosition: s = 'Bottom', children: c } = this.props,
