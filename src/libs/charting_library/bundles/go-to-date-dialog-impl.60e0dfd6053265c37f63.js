  ...
  [1859],
  {
          ...
          !(0, i.isIconOnly)(m, l) &&
            r.createElement(
              ...
              d || u
                ...
                : r.createElement(r.Fragment, null, m, r.createElement('span', { className: h()['visually-hidden'], 'aria-hidden': !0 }, m))
            ),
          (a || s) &&
            ((e) => r.createElement(o.Icon, { className: n(h().icon, e.showCaret && h().caret), icon: e.showCaret ? c : e.endIcon }))(e)
        )
      }
      function y(e) {
    ...
    35057: (e, t, a) => {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            o &&
              ...
              r.createElement(
                'button',
                { className: b.close, onClick: i, onKeyDown: l, 'data-name': 'close', 'aria-label': p, type: 'button', ref: y },
      ...
      class z extends r.PureComponent {
              ...
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, i.hashFromEvent)(e))) {
                  ...
                  if (null !== a) {
                    ...
                    if (r.contains(a)) return this.props.onKeyboardClose && this.props.onKeyboardClose(), void this._handleClose()
                  }
                }
                let t, a
                ;(function (e) {
        ...
        componentDidMount() {
          let e, t
          this.props.ignoreClosePopupsAndDialog || _.subscribe(y.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          let e, t
          this.props.ignoreClosePopupsAndDialog || _.unsubscribe(y.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
