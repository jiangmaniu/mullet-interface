  ...
  [731],
  {
                ...
                ;(r = [].concat(t(r), [m])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !d(o.target) &&
                        ((n && 0 === n.scrollTop && 0 < r) || ((a = n) && a.scrollHeight - a.scrollTop <= a.clientHeight && r < 0)
                          ? u(o)
                          : o.stopPropagation()))
                  }),
            ...
            (e.enableBodyScroll = function (e) {
              if (a) {
                ...
                ;(e.ontouchstart = null),
                  ...
                  l && 0 === r.length && (document.removeEventListener('touchmove', u, o ? { passive: !1 } : void 0), (l = !1))
              } else
    ...
    5811: (e, t, o) => {
      ...
      function s(e) {
        ...
        return n.createElement('span', { className: f, ...h }, n.createElement(r.Icon, { icon: v, className: c().icon }))
      }
    },
    45601: (e, t, o) => {
      'use strict'
    ...
    14283: (e, t, o) => {
      ...
      function B(e) {
        ...
        return [
          (0, n.useMemo)(() => {
            var e, t
            return null !== (t = null === (e = i[r]) || void 0 === e ? void 0 : e.compareOption) && void 0 !== t ? t : i[0].compareOption
          }, [i, r]),
          i
        ]
      }
      ...
      function O(e) {
        const { fullSymbolName: t, isSelected: r, className: l, isYield: c } = e,
          ...
          { compareModel: p, setHoveredItemId: h, clearInput: v, allowExtendTimeScale: f } = (0, w.useEnsuredContext)(y),
        ...
        return d
          ...
          : n.createElement(
              ...
              x.map(({ label: e, compareOption: t }) =>
                n.createElement(N, { key: t, onClick: M, value: t, isItemSelected: Boolean(r), isSelected: r && S === t }, e)
              )
            )
        function D(e) {
          d && g && g(), v && e && v(u, m)
      ...
      function T(e) {
        const { isSelected: t, fullSymbolName: o, onExpandClick: a, actions: l, id: c, isOffset: s, isYield: d } = e,
          ...
          { compareModel: g, hoveredItemId: C, setHoveredItemId: E, clearInput: k, allowExtendTimeScale: D } = (0, w.useEnsuredContext)(y),
          [M, N] = (0, n.useState)(!1),
          B = (0, n.useRef)(null),
            ...
            onClick: function (t) {
              ...
              if ((r.mobiletouch ? R : !M) && o) {
                ;(0, i.getSymbolSearchCompleteOverrideFunction)()(o).then((e) => {
                  const t = g.comparableOnSameScale({ isYield: d }) ? _.CompareOption.SameScale : _.CompareOption.SamePctScale
          ...
          super(e),
            ...
            (this._getContextValue = () => {
              const { compareModel: e } = this.props,
                { selectedCompareOptionIndex: t, selectedCompareIndex: o, hoveredItemId: n, allowExtendTimeScale: a } = this.state
              return {
                compareModel: e,
      ...
      function ee(e) {
        ...
        function r() {
          ...
          t.current &&
            ...
            ('compare' !== a.current ||
            '' ===
              (null === (n = null === (e = null == t ? void 0 : t.current) || void 0 === e ? void 0 : e.value) || void 0 === n
                ? void 0
                : n.trim())
              ? 'symbolSearch' === a.current &&
                '' ===
                  (null === (l = null === (r = null == t ? void 0 : t.current) || void 0 === r ? void 0 : r.value) || void 0 === l
                    ? void 0
                    : l.trim()) &&
                o('compare')
              : o('symbolSearch'))
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(h, { className: r(v.drawer, u[`position${t}`], p), ref: b, 'data-name': e['data-name'] }, d)
            )
          )
        )
      }
            ...
            if (l.CheckMobile.iOS())
              return (
                ...
                () => {
                  c--,
                    null !== s.current &&
                      (i ? 0 === c && (document.body.style.overscrollBehavior = '') : (0, a.enableBodyScroll)(s.current))
                }
              )
          }, []),
