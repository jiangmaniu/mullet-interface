          ...
          (e.fromSymbolSearchResult = function (e, t) {
            {
              ...
              return r.enabled('pay_attention_to_ticker_not_symbol') ? (0, n.ensureDefined)(null != o ? o : s) : (0, n.ensureDefined)(s)
            }
          }),
          (e.fromSymbolInfo = o),
      ...
      class r {
        ...
        includes(e) {
          return (function (e, t) {
            ...
            return (
              s.toLowerCase().includes(o) || n.toLowerCase().includes(o) || (void 0 !== r && r.some((e) => e.toLowerCase().includes(o)))
            )
          })(this._exchange, e)
        }
      ...
      class v {
            ...
            const i = Array.from(new Set(n))
            {
              ...
              Promise.all(t).then((t) =>
                this._handleInitProcess(
                  ...
                  (e, t, o, s) => ('symbol_resolved' === e.method ? _(e.params[1], o, s) : p(t, o, s, this._getSymbolDescription(t)))
                )
              )
            }
          })
        ...
        handleSourcesChange() {
          ...
          Array.from(this._checkedStudiesIds()).forEach((e) => {
            if (!t.has(e)) {
              ...
              o && o.length > 1 ? this._removeStudyIdFromCheckedSymbols(t.symbol, e) : this._checkedSymbols.delete(t.symbol),
                this._updateContentItemList(this._contentItemList.value(), !0)
            }
          })
        }
        ...
        _updateContentItemList(e, t) {
          ...
          if (this._recentSymbolsEnabled) {
            const e = new Set(),
              t = o.reduce((t, o) => (o.checked || e.has(o.symbol) || (t.push(o), e.add(o.symbol)), t), []).slice(0, this._recentLength)
