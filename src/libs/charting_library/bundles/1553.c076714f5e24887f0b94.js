  ...
  [1553],
  {
    11553: (t, e, i) => {
      ...
      !(function (r, s, o, a) {
          ...
          'function' !== typeof Object.assign
            ? function (t) {
                ...
                for (var e = Object(t), i = 1; i < arguments.length; i++) {
                  let n = arguments[i]
                  if (n !== a && null !== n) for (let r in n) n.hasOwnProperty(r) && (e[r] = n[r])
                }
                return e
              }
            : Object.assign
        let T = g(
            function (t, e, i) {
              for (let n = Object.keys(e), r = 0; r < n.length; ) (!i || (i && t[n[r]] === a)) && (t[n[r]] = e[n[r]]), r++
              return t
            },
            'extend',
            'Use `assign`.'
        ...
        function U(t, e, i) {
          ...
          ;(i.isFirst = !!s),
            ...
            (function (t, e) {
              ...
              let c = G(e.deltaTime, e.deltaX, e.deltaY)
        ...
        let J = { mousedown: 1, mousemove: 2, mouseup: 4 },
          K = 'mousedown',
          Q = 'mousemove mouseup'
        function tt() {
        ...
        let et = { pointerdown: 1, pointermove: 2, pointerup: 4, pointercancel: 8, pointerout: 8 },
        ...
        let ot = { touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8 },
          at = 'touchstart',
        ...
        let lt = { touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8 },
        ...
        function gt(t) {
          let e = t.changedPointers[0]
          if (e.identifier === this.primaryTouch) {
            let i = { x: e.clientX, y: e.clientY }
            this.lastTouches.push(i)
            let n = this.lastTouches
            setTimeout(function () {
              let t = n.indexOf(i)
              t > -1 && n.splice(t, 1)
            }, 2500)
          ...
          E(Wt, xt, {
            ...
            process: function (t) {
              ...
              if (n && r && i) {
                ...
                let s = !this.pTime || t.timeStamp - this.pTime < e.interval,
        ...
        ;(Lt.prototype = {
          ...
          get: function (t) {
            ...
            for (let e = this.recognizers, i = 0; i < e.length; i++) if (e[i].options.event == t) return e[i]
            return null
          },
          add: function (t) {
            if (d(t, 'add', this)) return this
            let e = this.get(t.options.event)
          ...
          emit: function (t, e) {
            this.options.domEvents &&
              (function (t, e) {
                let i = s.createEvent('Event')
                i.initEvent(t, !0, !0), (i.gesture = e), e.target.dispatchEvent(i)
              })(t, e)
            let i = this.handlers[t] && this.handlers[t].slice()
            if (i && i.length) {
              ;(e.type = t),
