        ...
        return i
          ...
          : s.createElement(
              ...
              s.createElement(
                'span',
                { className: a()(m.label) },
                !B && E ? E.map(({ text: e, ...t }, n) => s.createElement('span', { key: n, style: t }, e)) : null != B ? B : y
              ),
              !!R &&
                s.createElement(o.Icon, {
                  onClick: function () {
    ...
    68426: (e, t, n) => {
      ...
      const x = (e) => a.t(null, { plural: '{str} minutes', count: e, replace: { str: `${e}` } }, n(5926)),
        ...
        E = {
          ...
          '1D': { resolution: '1D', text: ((R = 1), a.t(null, { plural: '{str} days', count: R, replace: { str: `${R}` } }, n(62368))) },
          '1W': { resolution: '1W', text: ((k = 1), a.t(null, { plural: '{str} weeks', count: k, replace: { str: `${k}` } }, n(49306))) },
          '1M': { resolution: '1M', text: y(1) },
          '3M': { resolution: '3M', text: y(3) },
          '6M': { resolution: '6M', text: y(6) },
          '12M': { resolution: '12M', text: ((M = 1), a.t(null, { plural: '{str} years', count: M, replace: { str: `${M}` } }, n(91549))) }
        }
      var M, k, R
      function B(e) {
        const t = (function (e) {
            ...
            if (s.isMinutes()) {
              ...
              return e % 60 != 0
                ? ((o = e),
                  a.t(null, { plural: '{str} minutes', count: o, replace: { str: `${o}` }, context: 'timeframe_title' }, n(95484)))
                : ((i = e / 60),
                  a.t(null, { plural: '{str} hours', count: i, replace: { str: `${i}` }, context: 'timeframe_title' }, n(72495)))
            }
            var i
            var o
            if (s.isDays()) return w(s.multiplier())
            if (s.isWeeks())
              return ((e) => a.t(null, { plural: '{str} weeks', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, n(6088)))(
                s.multiplier()
              )
            if (s.isMonths()) {
              const e = s.multiplier()
              return e % 12 != 0
                ? ((r = e), a.t(null, { plural: '{str} months', count: r, replace: { str: `${r}` }, context: 'timeframe_title' }, n(12752)))
                : ((e) => a.t(null, { plural: '{str} years', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, n(96325)))(
                    e / 12
                  )
            }
            var r
            ...
            if (s.isMinutes()) {
              ...
              return e % 60 != 0
                ? ((o = e),
                  a.t(
                    null,
                    { plural: '{str} minutes intervals', count: o, replace: { str: `${o}` }, context: 'timeframe_title' },
                    n(15489)
                  ))
                : ((i = e / 60),
                  a.t(null, { plural: '{str} hours intervals', count: i, replace: { str: `${i}` }, context: 'timeframe_title' }, n(14887)))
            }
            var i
            var o
            if (s.isDays())
              return ((e) =>
                a.t(null, { plural: '{str} days intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, n(561)))(
                s.multiplier()
              )
            if (s.isWeeks())
              return ((e) =>
                a.t(null, { plural: '{str} weeks intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, n(60316)))(
                s.multiplier()
              )
            if (s.isMonths()) {
              const e = s.multiplier()
              return e % 12 != 0
                ? ((r = e),
                  a.t(null, { plural: '{str} months intervals', count: r, replace: { str: `${r}` }, context: 'timeframe_title' }, n(48514)))
                : ((e) =>
                    a.t(
                      null,
                      {
      ...
      const w = (e) => a.t(null, { plural: '{str} days', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, n(63808))
      class T {
        constructor(e) {
          ;(this._state = { ranges: [] }),
          ...
          t.withModel(null, () => {
            ...
            s.subscribe(this._rangeChangedListenerBound), this._rangeChangedListenerBound(s.value()), this._updateAvailableRanges(!0)
          })
        }
        state() {
          return this._state
            ...
            (this._renderChildren = (e) => {
              ...
              return e
                ...
                : s.createElement(
                    ...
                    i && s.createElement(p.AccessibleMenuItem, { label: O.goToDate, onClick: this._handleGoToDateClick })
                  )
            }),
      ...
      function Y(e) {
        ...
        return s.createElement(Z.ToolbarButton, { ...h, ref: t, text: n, isActive: a, tooltip: i, className: d, onClick: l })
      }
      var Q = n(41745)
      ...
      var ie = n(61814),
        ...
        re = n(92574),
        le = n(3080)
      const ce = (0, ie.hotKeySerialize)({ keys: [(0, ae.humanReadableModifiers)(ae.Modifiers.Alt, !1), 'G'], text: '{0} + {1}' }),
      ...
      class Ee extends s.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._timeFormatter = new ge.TimeFormatter((0, _e.getHourMinuteSecondFormat)(Ce.timeHoursFormatProperty.value()))),
      ...
      class Te {
        ...
        _setHighlight() {
          ...
          if (null !== s) {
            ...
            null !== i && o.value().axis !== i && (o.setValue({ owner: this._owner, axis: i }), e.lightUpdate(), (this._highlighted = !0))
          }
        }
        _removeHighlight() {
          if (!this._chartWidget.hasModel()) return
      ...
      class Je extends s.PureComponent {
        ...
        updateSessionButton() {
          ...
          const i = s.subsession_id,
            a = null !== (t = null === (e = s.subsessions) || void 0 === e ? void 0 : e.filter((e) => !e.private)) && void 0 !== t ? t : [],
            o = a.find((e) => e.id === i)
          this.setState({
            sessionId: i,
      ...
      const ot = (0, ie.hotKeySerialize)({ keys: [(0, ae.humanReadableModifiers)(ae.Modifiers.Alt, !1), 'Enter'], text: '{0} + {1}' }),
        rt = (function (e) {
          var t
          return (
            ((t = class extends s.PureComponent {
        ...
        ht = (() => {
          const e = new Map()
          return e.set(tt, 'logarithm'), e.set(at, 'percentage'), e.set(it, 'auto'), e.set(Je, 'session'), e.set(rt, 'fullscreen'), e
        })()
      function dt(e) {
        0
      }
      ...
      class gt extends s.PureComponent {
        constructor(e, t) {
          ...
          super(e, t),
            ...
            (this._updateButtonsVisibilityImp = (e) => {
              ...
              if (s.symbolResolvingActive().value()) return void this._setStateWithResize({ intervalAllowsSessionButton: a }, e)
            ...
            (this._resizeHandler = () => {
              ...
              if ((Object.assign(e, { dateRangeMode: h, noRanges: c }), 'expanded' !== h)) {
                ...
                for (const a of s)
                  (n += a.width),
                    a.name in lt ? ((i += a.width), Object.assign(e, { [a.name]: !1 })) : Object.assign(e, { [a.name]: t <= n })
            ...
            t &&
              s.createElement(
                ...
                s.createElement(
                  'div',
                  {
                    className: r(Ke.dateRangeWrapper, 'expanded' !== e.dateRangeMode && Ke.collapsed, e.noRanges && Ke.noranges),
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                l &&
                  ...
                  s.createElement(rt, { className: Ke.item, mobileChangeLayoutEnabled: this.props.mobileChangeLayoutEnabled }),
                !1
              )
            )
          )
        ...
        _applyResizing() {
          ...
          this._rangeExpanded &&
            (this._rangeExpanded.classList.toggle(Ke.collapsed, 'expanded' !== e), this._rangeExpanded.classList.toggle(Ke.noranges, t)),
          ...
          Object.keys(n).forEach((e) => {
            ...
            if ('separator' !== t) {
              const e = this._seriesComponents[t],
                a = !0 === n[t]
              e && ('timeZones' === t || 'session' === t ? (s = s || !a) : (i = i || !a), e.classList.toggle(Ke.collapsed, a))
            }
          })
      ...
      class vt extends s.PureComponent {
        ...
        render() {
          ...
          return s.createElement(_.RegistryProvider, { validation: bt, value: this._registry }, s.createElement(gt, { key: e.id(), ...n }))
        }
        _defineRegistry(e) {
          const {
