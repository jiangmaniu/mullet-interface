          ...
          ;(e.disableBodyScroll = function (e, o) {
            if (r) {
              ...
              if (
                ...
                let f = { targetElement: e, options: o || {} }
                ;(l = [].concat(t(l), [f])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(n.target) &&
                        ((o && 0 === o.scrollTop && 0 < l) || ((r = o) && r.scrollHeight - r.scrollTop <= r.clientHeight && l < 0)
                          ? d(n)
                          : n.stopPropagation()))
                  }),
              ...
              let p = { targetElement: e, options: o || {} }
              l = [].concat(t(l), [p])
            }
            let m
          }),
            ...
            (e.enableBodyScroll = function (e) {
              if (r) {
                ...
                ;(e.ontouchstart = null),
                  ...
                  i && 0 === l.length && (document.removeEventListener('touchmove', d, n ? { passive: !1 } : void 0), (i = !1))
              } else
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(p, { className: l(m.drawer, d[`position${t}`], f), ref: y, 'data-name': e['data-name'] }, u)
            )
          )
        )
      }
      ...
      ;(t.Children = {
        ...
        (t.cloneElement = function (e, t, o) {
          ...
          let r = h({}, e.props),
            ...
            a = e._owner
          if (null != t) {
            if ((void 0 !== t.ref && ((i = t.ref), (a = k.current)), void 0 !== t.key && (l = '' + t.key), e.type && e.type.defaultProps))
    ...
    70434: (e, t, n) => {
      ...
      function N(e) {
        ...
        return o.createElement(
          ...
          r && ('mob' !== n || !r.hideInMobileMode) && o.createElement('div', { className: x.group }, o.createElement(T, { ...r }))
        )
      }
      let R = n(25105)
          ...
          o.createElement(s.MatchMedia, { rule: 'screen and (max-width: 419px)' }, (e) =>
            e
              ? o.createElement(
                  ...
                  t.map((e, t) =>
                    o.createElement('div', { key: `${t}`, className: R.drawerItem }, o.createElement(N, { cardType: 'mob', ...e }))
                  )
                )
              : o.createElement(
                  v,
                  ...
                  o.createElement(
                    ...
                    t.map((e, t) => {
                      ...
                      return o.createElement(
                        'div',
                        { key: `${t}`, className: D, style: { borderColor: null === (n = e.style) || void 0 === n ? void 0 : n.color } },
      ...
      function D(e) {
        ...
        return (
          null === F && ((F = document.createElement('div')), document.body.appendChild(F)), r.render(o.createElement(M, { ...t }), F), I
        )
      }
      function I() {
      ...
      function $(e, t, n) {
        ...
        return g < n ? ((h = e.marginTop + s.top), (m = Math.max(g, 0))) : (h = s.height + s.top - y - n), { x: v, y: h, overrideHeight: m }
      }
    }
  }
])
