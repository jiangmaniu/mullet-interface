...
;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3986],
  {
    ...
    73986: (e, i, t) => {
      t.d(i, { SeriesPropertyDefinitionsViewModel: () => te, basePriceSources: () => ee, seriesPrecisionValues: () => ie })
      let n = t(50151),
        o = t(44352),
        r = t(36298),
        l = t(14483),
                ...
                return (
                  ...
                  void f.push(
                    (0, s.createNumberPropertyDefinition)(
                      ...
                      { id: `${v}${l.name}`, title: P, type: 1, min: t, max: new a.WatchedValue(l.max), defval: l.defval }
                    )
                  )
                )
              }
      ...
      function ie() {
        ...
        for (let i = 0; i < Z.length; i++)
          e.push({ title: `${Z[i].minMove}/${Z[i].priceScale}`, value: `${Z[i].priceScale},${Z[i].minMove},${Z[i].frac}` })
        return e
      }
      class te {
          ...
          return new Promise((e) => {
            ...
            null !== t
              ? this._model
                  ...
                  .catch((i) => {
                    b.logWarn(`Find meta info for create series definitions with error - ${(0, v.errorToString)(i)}`), e(null)
                  })
              : e(null)
          }).then((i) => {
            if (this._isDestroyed) throw new Error('SeriesPropertyDefinitionsViewModel already destroyed')
            ...
            return (
              (this._definitions = {
                definitions: [
                  (0, s.createPropertyDefinitionsGeneralGroup)(n, 'generalSymbolStylesGroup', (0, c.getTranslatedChartStyleName)(l)),
