      ...
      function v(t) {
        ...
        if (
          ('border-box' === r.boxSizing &&
            (Math.round(s + i) !== e && (s -= d(r, 'left', 'right') + i), Math.round(c + u) !== n && (c -= d(r, 'top', 'bottom') + u)),
          !(function (t) {
            return t === l(t).document.documentElement
          })(t))
        ) {
          let a = Math.round(s + i) - e,
            f = Math.round(c + u) - n
      ...
      ;(e.Children = {
        ...
        (e.cloneElement = function (t, e, r) {
          ...
          let o = v({}, t.props),
            ...
            s = t._owner
          if (null != e) {
            if ((void 0 !== e.ref && ((u = e.ref), (s = O.current)), void 0 !== e.key && (i = '' + e.key), t.type && t.type.defaultProps))
