      ...
      class m {
        ...
        async _startNextRequest() {
          ...
          const e = await (0, p.getChartStorage)(),
            ...
            n = t[1],
            s = { requestType: 'mainSeriesLineTools', seriesSourceId: this._ownerSourceId, symbol: i, brokerName: o, sharingMode: 0 }
          try {
      ...
      class V {
        ...
        resetInvalidated(e, t, i) {
          ...
          ;(this._invalidatedLineToolsAndStudyStubs = a.stillInvalidated),
            a.validated.forEach(o.bind(this, this._originalLineToolSharingMode, this._setOriginalLineToolSharingMode.bind(this), s))
          const d = N(this._invalidatedLineToolGroups, e, new Set(null != l ? l : n.keys()))
          a.validated.forEach(
            o.bind(this, this._originalLineToolGroupsSharingMode, this._setOriginalLineToolGroupsSharingMode.bind(this), n)
          ),
                ...
                if (s.sources.size || s.groups.size) {
                  ...
                  return (
                    ...
                    (0, c.ensureNotNull)(this._saveChartService)
                      ...
                      .catch(async (t) => {
                        t instanceof v.SavingLineToolsError && t.shouldBeCooled && (this._lastBanTime = performance.now())
                        {
        ...
        _restoreLineTool(e, t, i, o) {
          var n
          if ((null !== (n = t.state.points) && void 0 !== n ? n : []).some((e) => !(0, T.isNumber)(e.time_t))) return null
            ...
            if (null === e) {
              ...
              if (r) {
                if (e.groupId) {
                  ...
                  if (
                    (null !== t &&
                      (t.excludeLineTool(r), 0 === t.lineTools().length && this._chartModel.lineToolsGroupModel().removeGroup(t)),
        ...
        _invalidateLineToolOrStudyStub(e, t, i) {
          ...
          const n = null === (o = this._invalidatedLineToolsAndStudyStubs.get(e)) || void 0 === o ? void 0 : o.invalidatedViaSyncOnly,
            ...
            this._invalidatedLineToolsAndStudyStubs.forEach((s, r) => {
              ...
              if (!A(l))
                if (null === l) {
                  ...
                  if (l === this._chartModel.lineBeingCreated() || l === this._chartModel.lineBeingEdited() || !l.isSavedInChart()) return
                      ...
                      i.set(
                        ...
                        (function (e, t) {
                          const i = t.lineToolsGroupModel().groupForLineTool(e),
                            o = { id: e.id(), ownerSource: (0, c.ensureNotNull)(e.ownerSource()).id(), state: e.state(!1) }
                          return (
        ...
        _loadAndMergeLineToolsOnStudies(e, t) {
          const i = { requestType: 'studiesLineTools', seriesSourceId: this._chartModel.mainSeries().id(), sharingMode: e },
            o = this._chartModel.mainSeries()
          this._makeLoadRequestAndMerge(i, (i) => {
            const n = t ? u(Array.from(this._allLineToolsAndStudyStubs.values()).map((e) => Array.from(e.keys()))).filter((e) => !i(e)) : []
            this._unloadLineTools(n, (e) => e.ownerSource() !== o, e)
          })
        }
        _loadAndMergeLineToolsWithoutSymbol(e, t) {
          const i = { requestType: 'lineToolsWithoutSymbol', seriesSourceId: this._chartModel.mainSeries().id(), sharingMode: e },
            o = this._chartModel.mainSeries(),
