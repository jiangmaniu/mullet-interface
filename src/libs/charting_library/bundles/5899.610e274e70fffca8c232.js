  ...
  [5899],
  {
    ...
    29332: (e, t, n) => {
      ...
      function _(e) {
        ...
        return (
          ...
          r.createElement(
            ...
            l && r.createElement(v.Drawer, { onClose: c }, r.createElement(y, { items: n.subItems, parentAction: t, closeNested: c }))
          )
        )
        function c(e) {
      ...
      function y(e) {
        const { items: t, parentAction: n, closeNested: o } = e,
          s = !Boolean(n) && t.every((e) => !Boolean('separator' !== e.type && (e.getState().icon || e.getState().checkable)))
        return r.createElement(
      ...
      class x extends r.PureComponent {
        ...
        render() {
          const { isOpened: e, onClose: t, items: n, doNotCloseOn: o, menuStatName: a, parentStatName: d, takeFocus: m, ...f } = this.props
          return e
            ? r.createElement(
                h.DrawerManager,
                null,
                r.createElement(c.KeyboardDocumentListener, { keyCode: 27, eventType: 'keyup', handler: this._handleClose }),
    ...
    96040: (e, t, n) => {
      ...
      let r = n(44352),
        ...
        l = n(27306)
      function c(e) {
        const { className: t, isActive: c, onClick: u, onMouseDown: h, title: p, hidden: d, 'data-name': m = 'remove-button', ...f } = e
      ...
      ;(t.Children = {
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          let o = f({}, e.props),
            ...
            i = e._owner
          if (null != t) {
            if ((void 0 !== t.ref && ((a = t.ref), (i = w.current)), void 0 !== t.key && (s = '' + t.key), e.type && e.type.defaultProps))
    ...
    58451: (e, t, n) => {
            ...
            r.createElement(
              ...
              void 0 !== s &&
                r.createElement(
                  'td',
                  null,
                  r.createElement(d.FavoriteButton, { className: a.favourite, isFilled: s, onClick: this.props.onFavouriteClick })
                ),
              ...
              r.createElement(
                ...
                r.createElement(
                  c,
                  { className: a.content },
                  r.createElement('span', { className: i(a.label, this.props.checked && a.checked), 'data-label': !0 }, this.props.label),
                  this._toolbox(a),
                  e &&
                    r.createElement('span', { className: a.arrowIcon, dangerouslySetInnerHTML: { __html: b }, 'data-submenu-arrow': !0 }),
                  !e && t && !u.CheckMobile.any() && r.createElement(m.Hint, { className: i(o && a.invisibleHotkey), text: t }),
        ...
        _icon(e) {
          if (this.props.checkable) {
            if (this.props.checkboxInput)
              return r.createElement(c.CheckboxInput, { className: i(e.icon, e.checkboxInput), checked: this.props.checked })
      ...
      function I(e) {
        ...
        return r.createElement(E, {
          size: t,
          label: r.createElement('div', { className: l()(S.loaderWrap, S[t]) }, r.createElement(g.Loader, { className: S.loader })),
          noInteractive: !0,
      ...
      class N extends r.PureComponent {
        ...
        componentDidUpdate(e, t) {
          let n, r, o
          t.loading !== this.state.loading && (null === (r = (n = this.props).onRequestUpdate) || void 0 === r || r.call(n)),
            0 === t.subItems.length && this.state.subItems.length > 0 && (this._unsubscribe = this._registerSubmenu()),
            t.subItems.length > 0 && 0 === this.state.subItems.length && (null === (o = this._unsubscribe) || void 0 === o || o.call(this)),
