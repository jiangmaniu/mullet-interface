  ...
  [8020],
  {
    ...
    36383: (t, e, r) => {
      ...
      let n = r(50959),
        o = r(27267)
      function i(t) {
        const { click: e, mouseDown: r, touchEnd: i, touchStart: u, handler: s, reference: c, ownerDocument: a = document } = t,
          l = (0, n.useRef)(null),
      ...
      ;(e.Children = {
        ...
        (e.cloneElement = function (t, e, n) {
          ...
          let o = m({}, t.props),
            ...
            s = t._owner
          if (null != e) {
            if ((void 0 !== e.ref && ((u = e.ref), (s = S.current)), void 0 !== e.key && (i = '' + e.key), t.type && t.type.defaultProps))
      ...
      class c {
        ...
        _render(t) {
          ...
          this._container !== e && (this._unmountComponent(), (this._container = e), this._container.appendChild(this._tooltipContainer)),
            o.render(
              n.createElement(a, { handler: t.onClickOutside, child: n.createElement(this._tooltipFactory, t.factoryProps) }),
