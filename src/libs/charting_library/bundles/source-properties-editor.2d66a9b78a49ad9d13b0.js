  ...
  [6780],
  {
    ...
    78890: (e, t, i) => {
      ...
      var s = i(50959),
        ...
        u = i(44996),
        d = i(87075)
      const m = { reset: o.t(null, void 0, i(33533)), saveAsDefault: o.t(null, void 0, i(99687)), defaults: o.t(null, void 0, i(48572)) }
      var h
      !(function (e) {
      ...
      class p extends s.PureComponent {
        render() {
          ...
          return s.createElement(
            ...
            s.createElement(c.PopupMenuItem, { className: d.defaultsButtonItem, isActive: !1, label: m.reset, onClick: i }),
            s.createElement(c.PopupMenuItem, { className: d.defaultsButtonItem, isActive: !1, label: m.saveAsDefault, onClick: t })
          )
        }
    ...
    48531: (e, t, i) => {
      ...
      function d(e) {
        return s.createElement(o.MatchMedia, { rule: 'screen and (max-width: 768px)' }, (t) =>
          s.createElement(
            l.ControlDisclosure,
            { className: !t && r.themesButtonText, hideArrowButton: t, buttonChildren: s.createElement(u, { isTabletWidth: t }) },
            e.children
          )
        )
      }
    ...
    37289: (e, t, i) => {
      ...
      const a = {
        ...
        l = { TextText: 'big', AnchoredTextText: 'big', NoteText: 'big', AnchoredNoteText: 'big', CalloutText: 'big', BalloonText: 'big' }
      var o = i(71891),
        r = i(62709)
      function c(e) {
      ...
      class k extends s.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._getTranslatedStringForSource = (e) => new T.TranslatedString(e.name(), e.title(g.TitleDisplayTarget.StatusLine))),
            (this._setTitle = (e) => {
              const { source: t, model: i } = this.props,
                s = P.format({ sourceTitle: t.properties().title.value() || this._getTranslatedStringForSource(t), newSourceTitle: e })
        ...
        render() {
          ...
          const { onCancel: t, source: i } = this.props,
            ...
            l = (null === (e = i.properties().title) || void 0 === e ? void 0 : e.value()) || i.title(g.TitleDisplayTarget.StatusLine),
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            return s.createElement(
              s.Fragment,
              null,
              s.createElement(w.DialogTabs, { className: A.tabs, id: l, activeTab: e, onChange: this._handleSelectPage, tabs: o }),
              s.createElement(
                p.TouchScrollContainer,
                { className: A.scrollable, onScroll: this._handleScroll },
                s.createElement(h.PropertiesEditorTab, { page: a, pageRef: this._activePageRef, tableKey: this.state.tableKey })
              )
            )
          }
        }
        ...
        return s.createElement(r.AdaptiveConfirmDialog, {
          ...
          render: function () {
            ...
            return s.createElement(
              ...
              s.createElement(o.TouchScrollContainer, null, s.createElement(u.PropertiesEditorTab, { page: e, tableKey: T }))
            )
          },
          submitOnEnterKey: !1,
          showCloseIcon: !y
    ...
    93081: (e, t, i) => {
      ...
      const f = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(
          ...
          m && 'string' == typeof h ? n.createElement('span', { className: l()(b['ellipsis-children'], 'apply-overflow-tooltip') }, h) : h
        )
      })
            ...
            return (
              ...
              (0, n.useCallback)(() => {
                const s = (0, _.ensureNotNull)(t.current).getBoundingClientRect(),
                  n = i.current[e]
                return { x: s.left, y: s.top + s.height + n + 4, indentFromWindow: { top: 4, bottom: 4, left: 4, right: 4 } }
              }, [t, e])
            )
          })(t, v)
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              {
                ...ce,
                className: l()(Y['underline-tabs'], { [Y['make-grid-column']]: O || W, [Y['stretch-tabs']]: O, [Y['equal-tab-size']]: W })
              },
              Q.map((e) =>
                n.createElement(C, {
                  ...ve(e),
