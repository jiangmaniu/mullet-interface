...
;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [962],
  {
    50690: (e, n, t) => {
      ...
      let c = !('undefined' === typeof window || void 0 === window.document || void 0 === window.document.createElement),
      ...
      let F = Symbol.for('react.offscreen')
      ...
      let Ke = l.unstable_scheduleCallback,
      ...
      function Wn(e) {
        ...
        for (
          null !== Pn && Hn(Pn, e), null !== Tn && Hn(Tn, e), null !== Ln && Hn(Ln, e), Mn.forEach(n), Fn.forEach(n), t = 0;
          t < Dn.length;
          t++
        )
      ...
      let Qn = k.ReactCurrentBatchConfig,
        jn = !0
      function $n(e, n, t, r) {
        let l = kn,
          a = Qn.transition
      ...
      function at(e) {
        function n(n, t, r, l, a) {
          for (let u in ((this._reactName = n),
          (this._targetInst = r),
          (this.type = t),
          (this.nativeEvent = l),
          (this.target = a),
      ...
      let Ot = c && 'TextEvent' in window && !Rt,
      ...
      let hr = c && 'documentMode' in document && 11 >= document.documentMode,
        gr = null,
        vr = null,
        yr = null,
        br = !1
      ...
      let Br = '_reactListening' + Math.random().toString(36).slice(2)
      function Hr(e) {
        if (!e[Br]) {
          ;(e[Br] = !0),
      ...
      let rl = 'function' === typeof setTimeout ? setTimeout : void 0,
      ...
      function Rl(e, n, t) {
        ...
        for (let l in (r = r.getChildContext())) if (!(l in n)) throw Error(a(108, W(e) || 'Unknown', l))
        return I({}, t, r)
      }
      function Ol(e) {
        return (
      ...
      let ha = k.ReactCurrentBatchConfig
      function ga(e, n) {
        if (e && e.defaultProps) {
          for (let t in ((n = I({}, n)), (e = e.defaultProps))) void 0 === n[t] && (n[t] = e[t])
          return n
        }
        return n
      }
      ...
      function Oa(e, n) {
        ...
        if (null !== r && t === (r = r.updateQueue)) {
          ...
          if (null !== (t = t.firstBaseUpdate)) {
            do {
              let u = { eventTime: t.eventTime, lane: t.lane, tag: t.tag, payload: t.payload, callback: t.callback, next: null }
      ...
      function Ia(e, n, t, r) {
        ...
        if (null !== a) {
          ...
          if (
            (null === c && (i = f), (l.baseState = i), (l.firstBaseUpdate = s), (l.lastBaseUpdate = c), null !== (n = l.shared.interleaved))
          ) {
            l = n
            do {
              ;(u |= l.lane), (l = l.next)
      ...
      let fu = k.ReactCurrentDispatcher,
      ...
      function _u() {
        ...
        let n = null === gu ? mu.memoizedState : gu.next
        if (null !== n) (gu = n), (hu = e)
        else {
        ...
        if (null !== l) {
          ...
          do {
            ...
            if ((pu & f) === f)
              ...
              let d = { lane: f, action: c.action, hasEagerState: c.hasEagerState, eagerState: c.eagerState, next: null }
      ...
      let po = 'function' === typeof WeakMap ? WeakMap : Map
      function mo(e, n, t) {
      ...
      function No(e, n, t, r, l) {
        ...
        if ((Ea(n, l), null === n.stateNode)) Wo(e, n), Wa(n, t, r), ja(n, t, r, l), (r = !0)
          ...
          ;(u = n.stateNode),
            ...
            (f = n.pendingProps),
            (d = u.context),
            'object' === typeof (i = t.contextType) && null !== i ? (i = Ca(i)) : (i = Ll(n, (i = Ml(t) ? Tl : Nl.current)))
          let p = t.getDerivedStateFromProps
      ...
      function Po(e, n, t, r, l, a) {
        ...
        let o = u && 'function' !== typeof t.getDerivedStateFromError ? null : r.render()
        return (
          (n.flags |= 1),
      ...
      function Io(e, n, t) {
        ...
        if (o) {
          ...
          let s = { mode: 'hidden', children: l.children }
          return (
            0 == (1 & i) && n.child !== u
            ...
            (o = n.child),
            (i =
              null === (i = e.child.memoizedState) ? Oo(t) : { baseLanes: i.baseLanes | t, cachePool: null, transitions: i.transitions }),
            (o.memoizedState = i),
          ...
          case 13:
            ...
            return 0 != (128 & n.flags)
              ...
              : ((r = null !== r) !== (null !== e && null !== e.memoizedState) &&
                  r &&
                  ((n.child.flags |= 8192), 0 != (1 & n.mode) && (null === e || 0 != (1 & ou.current) ? 0 === Di && (Di = 3) : hs())),
            ...
            if (((r = 0 != (128 & n.flags)), null === (i = u.rendering)))
              ...
              if (!r)
                if (null !== (e = iu(i))) {
                  ...
                  2 * Ge() - u.renderingStartTime > Hi && 1073741824 !== t && ((n.flags |= 128), (r = !0), jo(u, !1), (n.lanes = 4194304))
              u.isBackwards
      ...
      function pi(e, n, t) {
        ...
        switch (t.tag) {
          ...
          case 18:
            null !== ci &&
              (fi
                ? ((e = ci), (t = t.stateNode), 8 === e.nodeType ? il(e.parentNode, t) : 1 === e.nodeType && il(e, t), Wn(e))
                : il(ci, t.stateNode))
            break
          case 4:
                  ...
                  case 1:
                    ...
                    if (4 & n.flags && !Xo)
                      if (null === t) r.componentDidMount()
                        ...
                        let l = n.elementType === n.type ? t.memoizedProps : ga(n.type, t.memoizedProps)
                  ...
                  (function (e, n) {
                    if (((el = jn), pr((e = dr())))) {
                      if ('selectionStart' in e) var t = { start: e.selectionStart, end: e.selectionEnd }
                        ...
                        e: {
                          let r = (t = ((t = e.ownerDocument) && t.defaultView) || window).getSelection && t.getSelection()
                          if (r && 0 !== r.rangeCount) {
                            t = r.anchorNode
      ...
      function Cs(e, n, t) {
        ...
        null !== r && r.delete(n),
          ...
          Pi === e && (Li & t) === t && (4 === Di || (3 === Di && (130023424 & Li) === Li && 500 > Ge() - Bi) ? ds(e, 0) : (Ui |= t)),
          rs(e, n)
      }
      function _s(e, n) {
      ...
      function Bs(e, n, t) {
        let r = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : null
      ...
      xi = function (e, n, t) {
        ...
        switch (((n.lanes = 0), n.tag)) {
          ...
          case 4:
            return (
              ru(n, n.stateNode.containerInfo), (r = n.pendingProps), null === e ? (n.child = Xa(n, null, r, t)) : wo(e, n, r, t), n.child
            )
          case 11:
      ...
      ;(Xs.prototype.render = Ys.prototype.render =
        ...
        (Ne = ss),
        (Pe = cs)
      let nc = { usingClientEntryPoint: !1, Events: [bl, kl, wl, _e, ze, ss] },
      ...
      if ('undefined' !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
        let lc = __REACT_DEVTOOLS_GLOBAL_HOOK__
      ...
      ;(n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = nc),
        (n.createPortal = function (e, n) {
          let t = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null
        ...
        (n.hydrateRoot = function (e, n, t) {
          ...
          let r = (null != t && t.hydratedSources) || null,
            l = !1,
            u = '',
            o = qs
          if (
    ...
    85568: (e, n) => {
      ...
      function l(e) {
        ...
        if (t !== n) {
          e[0] = t
          e: for (let r = 0, l = e.length, u = l >>> 1; r < u; ) {
            let o = 2 * (r + 1) - 1,
              i = e[o],
              s = o + 1,
              c = e[s]
      ...
      ;(n.unstable_IdlePriority = 5),
        ...
        (n.unstable_scheduleCallback = function (e, l, a) {
          ...
          return (
            ...
            a > u
              ? ((e.sortIndex = a), t(c, e), null === r(s) && e === r(c) && (g ? (y(_), (_ = -1)) : (g = !0), D(w, a - u)))
