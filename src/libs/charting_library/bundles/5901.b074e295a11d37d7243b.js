;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5901],
  {
          ...
          ;(e.disableBodyScroll = function (e, o) {
            if (r) {
              ...
              if (
                ...
                let d = { targetElement: e, options: o || {} }
                ;(s = [].concat(t(s), [d])),
              ...
              ;(m = o),
                setTimeout(function () {
                  if (void 0 === c) {
                    let e = !!m && !0 === m.reserveScrollBarGap,
              ...
              let h = { targetElement: e, options: o || {} }
              s = [].concat(t(s), [h])
            }
            let m
          }),
            ...
            (e.enableBodyScroll = function (e) {
              if (r) {
                ...
                ;(e.ontouchstart = null),
                  ...
                  a && 0 === s.length && (document.removeEventListener('touchmove', p, n ? { passive: !1 } : void 0), (a = !1))
              } else
    ...
    57733: (e, t, n) => {
      ...
      let o = n(50959)
      const r = function () {},
        s = (0, o.createContext)({ getName: () => '', getValues: () => [], getOnChange: () => r, subscribe: r, unsubscribe: r })
          ...
          button: (function () {
            ...
            return i
              ...
              : o.createElement(
                  o.Fragment,
                  null,
                  null != n ? n : o.createElement(E, { increaseValue: p, decreaseValue: d, defaultButtonsVisible: c, title: l })
                )
          })(),
          disabled: e.disabled,
    ...
    58593: (e, t, n) => {
      ...
      let o = n(50959),
        ...
        m = n(63581)
      function v(e) {
        const { button: t, children: n, className: r, onPopupClose: v, 'data-name': g, onColorChange: f, disabled: b, ...C } = e,
          [y, E] = (0, o.useState)(!1),
          [S, w] = (0, o.useState)(!1),
          [_, x] = (0, c.useFocus)(),
          N = (0, o.useRef)(null),
        ...
        class extends o.PureComponent {
          constructor(e) {
            super(e),
              ...
              (this._handleFocus = (e) => {
                d.PLATFORM_ACCESSIBILITY_ENABLED && e.target.matches(':focus-visible') && this.setState({ isFocusVisible: !0 })
              }),
              (this._handleBlur = () => {
      ...
      function N(e) {
        ...
        return o.createElement(
          ...
          o.createElement(w, { name: 'color_picker_thickness_select', onChange: r, values: n, selectedValues: 'mixed' === t ? [] : [t] })
        )
      }
      let I = n(28685)
      function T(e) {
                  ...
                  a && 'mixed' !== a
                    ? (function () {
                        ...
                        return o.createElement(
                          ...
                          o.createElement('div', { style: { backgroundColor: e }, className: s()(I.swatch, t && I.white) })
                        )
                      })()
                    : o.createElement(
                        'div',
    ...
    48897: (e, t, n) => {
      ...
      function f(e) {
        ...
        return o.createElement(
          ...
          o.createElement('div', { className: r(g.text, 'apply-overflow-tooltip') }, void 0 !== a && a, o.createElement('span', null, t)),
      ...
      function x(e) {
        if ('definition' in e) {
          ...
          return o.createElement(
            ...
            o.createElement(C.CellWrap, null, o.createElement(_, { symbol: (0, i.ensureDefined)(c), onSymbolChanged: u }))
          )
        }
        {
          const {
          ...
          return o.createElement(_, { symbol: (0, i.ensureDefined)(n), onSymbolChanged: d, disabled: c, className: s()(u && w.hasTooltip) })
        }
      }
    },
    1861: (e, t, n) => {
    ...
    31356: (e, t, n) => {
      ...
      function a(e) {
        ...
        return o.createElement(
          ...
          Boolean(c) && o.createElement(r.PropertyTable.Cell, { placement: 'last', 'data-section-name': t }, c, u && !1)
        )
      }
    },
    86067: (e, t, n) => {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement('input', { ref: this._inputRef, type: 'text', className: z.input, value: n, onChange: this._handleInput })
              ),
              o.createElement(
                'div',
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement('div', { className: r(c.pointer, i && c.dragged), style: { left: 100 * t + '%' }, ref: this._refPointer })
              )
            ),
            !n &&
              o.createElement(
                ...
                o.createElement('input', { type: 'text', className: c.opacityInput, value: a, onChange: this._handleInput }),
    ...
    59054: (e, t, n) => {
      ...
      function m(e) {
        ...
        return o.createElement('span', { className: s()(d.button, n && d.disabled, t) }, o.createElement(h, { isDropped: r }))
      }
      let v = n(66986)
    ...
    90405: (e, t, n) => {
      ...
      const C = o.forwardRef((e, t) => {
        ...
        const {
          ...
          ce = (0, o.useMemo)(() => ({ role: 'listbox', 'aria-labelledby': T, 'aria-activedescendant': f(n, oe) }), [T, oe]),
    ...
    39847: (e, t, n) => {
      ...
      function C(e) {
        ...
        return o.createElement(
          m,
          {
            className: r(p, g()['icon-wrapper'], g()[`intent-${n}`], _ && c && g()['with-tooltip'], _ && c && 'apply-common-tooltip'),
            title: _ ? c : void 0,
            'aria-label': i,
            reference: N,
            ...(0, s.filterDataProps)(e),
    ...
    12949: (e, t, n) => {
      ...
      class G extends r.PureComponent {
        render() {
          return r.createElement(B.PropertyContext.Consumer, null, (e) => (e ? this._getColorInputWithContext(e) : null))
        }
      ...
      const Q = (0, h.bind)(function (e) {
        const { value: t, onChange: n, input: o, tzName: s, hasTooltip: a } = e,
          ...
          m = (0, r.useMemo)(() => (0, $.twoDigitsFormat)(h.getHours()) + ':' + (0, $.twoDigitsFormat)(h.getMinutes()), [h])
        return r.createElement(
          'div',
    ...
    39828: (e, t, n) => {
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                l.PropertyTable.Cell,
                { placement: 'first', grouped: d, 'data-study-input-name': (null == o ? void 0 : o.id) && `${o.id}-another-symbol-label` },
                r.createElement(m, {
              ...
              r.createElement(
                l.PropertyTable.Cell,
                { placement: 'last', grouped: d, 'data-study-input-name': (null == o ? void 0 : o.id) && `${o.id}-another-symbol-input` },
                t ||
      ...
      function D(e) {
        ...
        return 'symbol' === t.type && t.optional
          ...
          : 'bool' === t.type
          ? r.createElement(S, { label: a.t(t.name, { context: 'input' }, n(88601)), input: t, tooltip: o, solutionId: s })
          : 'text_area' === t.type
          ? r.createElement(P, { label: a.t(t.name, { context: 'input' }, n(88601)), input: t, tooltip: o, solutionId: s })
          ...
          ? (0, F.isInputInlines)(t)
            ...
            : r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(L.GroupTitleSection, { title: a.t(t.id, { context: 'input' }, n(88601)), name: t.id })
                ),
                t.children.map((e) =>
                  (0, F.isGroup)(e)
      ...
      class f extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onValueChange = (e) => {
              ...
              if (
                (void 0 !== this.props.onEmptyString && '' === t && this.props.onEmptyString(), 'integer' === this.props.mode && !v.test(t))
              )
                return
        ...
        _checkValueBoundaries(e) {
          ...
          return (
            ...
            c.passMin ||
              (u =
                null !== (a = null === (r = this.props.boundariesErrorMessages) || void 0 === r ? void 0 : r.lessThanMin) && void 0 !== a
                  ? a
      ...
      class g extends o.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._onPopupClose = () => {
              this._trackEventLabel && ((0, p.trackEvent)('GUI', 'Study settings', this._trackEventLabel), (this._trackEventLabel = null))
            })
        }
        componentWillUnmount() {
          this._onPopupClose()
