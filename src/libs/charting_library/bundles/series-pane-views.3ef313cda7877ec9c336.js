    ...
    40481: (t, e, i) => {
        ...
        _drawImpl(t) {
          ...
          ;(m.font = (0, o.makeFont)(12, u.CHART_FONT_FAMILY)),
            l
              ...
              : ((x = m.measureText(null != i ? i : '').width), (S = m.measureText(null != r ? r : '').width), (f = Math.max(x, S)))
          const w = r ? 2 : 1,
      ...
      class f {
        ...
        _updateImpl() {
          ...
          ;(this._data = { point: g, direction: u, eod: t, dateString: T, timeString: m }), this._renderer.setData(this._data)
        }
        _getTargetBar(t) {
