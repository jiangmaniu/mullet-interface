  ...
  [2878],
  {
    ...
    16396: (e, t, o) => {
      ...
      function h(e) {
        ...
        return n.createElement(
          ...
          n.createElement('span', { className: i(W.labelRow, p) }, n.createElement('span', { className: i(W.label, g) }, F)),
          (void 0 !== f || T) && n.createElement('span', { className: W.shortcut }, (J = f) && J.split('+').join(' + ')),
          void 0 !== M &&
            n.createElement('span', { onClick: R ? d : void 0, className: i(W.toolbox, { [W.showOnHover]: L, [W.showOnFocus]: S }) }, M)
        )
        let J
      }
    },
    ...
    14186: (e, t, o) => {
      ...
      class S extends n.PureComponent {
        ...
        render() {
          const { children: e, isVisibleScrollbar: t, isVisibleFade: o, isVisibleButtons: i, onMouseOver: l, onMouseOut: a } = this.props,
          ...
          return n.createElement(F.Measure, { onResize: this._handleResizeWrap }, (h) =>
            n.createElement(
              ...
              n.createElement(
                'div',
                { className: s()(k.scrollWrap, { [k.noScrollBar]: !t }), onScroll: this._handleScroll, ref: (e) => (this._scroll = e) },
              ...
              i &&
                n.createElement(
                  ...
                  n.createElement('div', { className: k.iconWrap }, n.createElement(E.Icon, { icon: L, className: k.icon }))
                ),
              i &&
                n.createElement(
                  'div',
      ...
      function D(e) {
        ...
        return n.createElement(M.ToolButton, { ...e, ref: t, tag: I.PLATFORM_ACCESSIBILITY_ENABLED ? 'button' : 'div', tabIndex: o })
      }
      function N(e) {
      ...
      const ee = [
        ...
        se = new Set(ae)
      const re = [
          { title: f.t(null, { context: 'emoji_group' }, o(15426)), emojis: [], content: n.createElement(z.IconItem, { icon: $ }) },
          { title: f.t(null, { context: 'emoji_group' }, o(33628)), emojis: ee, content: n.createElement(z.IconItem, { icon: Q }) },
          { title: f.t(null, { context: 'emoji_group' }, o(77011)), emojis: ne, content: n.createElement(z.IconItem, { icon: Y }) },
          { title: f.t(null, { context: 'emoji_group' }, o(11739)), emojis: ie, content: n.createElement(z.IconItem, { icon: X }) },
          { title: f.t(null, { context: 'emoji_group' }, o(14281)), emojis: te, content: n.createElement(z.IconItem, { icon: J }) },
          { title: f.t(null, { context: 'emoji_group' }, o(72302)), emojis: le, content: n.createElement(z.IconItem, { icon: q }) },
          { title: f.t(null, { context: 'emoji_group' }, o(57792)), emojis: oe, content: n.createElement(z.IconItem, { icon: K }) }
        ],
        ce = { [O.Icons]: G.drawingToolsIcons.heart, [O.Emojis]: G.drawingToolsIcons.smile, [O.Stickers]: G.drawingToolsIcons.sticker },
        ue = [
      ...
      const Te = o(22878),
        Ce = (0, n.forwardRef)((e, t) => {
          ...
          function Y() {
            O.current &&
              (clearTimeout(O.current), (O.current = 0), L ? z(!1) : b || L || r.mobiletouch || (!h && !C) ? !W.current && f && f() : z(!0))
          }
        })
      let _e = o(38297),
        Ee = o(85034),
      ...
      const Re = new Set(Be)
      const We = [
          { title: f.t(null, { context: 'emoji_group' }, o(15426)), emojis: [], content: n.createElement(z.IconItem, { icon: De }) },
      ...
      class ut extends n.PureComponent {
        constructor(e) {
          ...
          this.state = { current: -1 === t ? this._firstNonGrayedTool() : t, favState: this._composeFavState(), isActive: -1 !== t }
        }
        componentDidMount() {
      ...
      class gt extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleRemoveAll = () => {
              ft('remove all'), this.props.chartWidgetCollection.activeChartWidget.value().removeAllStudiesDrawingTools()
            }),
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(st.AccessibleMenuItem, { 'data-name': 'remove-all', label: c, onClick: this._handleRemoveAll, theme: e })
          )
        }
        _handleArrowClick() {
          Tt('menu')
      ...
      const xt = {
        drawings: { active: G.drawingToolsIcons.hideAllDrawingToolsActive, inactive: G.drawingToolsIcons.hideAllDrawingTools },
        indicators: { active: G.drawingToolsIcons.hideAllIndicatorsActive, inactive: G.drawingToolsIcons.hideAllIndicators },
        positions: { active: G.drawingToolsIcons.hideAllPositionsToolsActive, inactive: G.drawingToolsIcons.hideAllPositionsTools },
        all: { active: G.drawingToolsIcons.hideAllDrawingsActive, inactive: G.drawingToolsIcons.hideAllDrawings }
      }
      function Ft(e) {
        const { isSmallTablet: t } = e,
          [{ isActive: o, hideMode: i }, a] = (0, n.useState)(() => ({ isActive: !1, hideMode: (0, Ct.getSavedHideMode)() }))
        ;(0, n.useEffect)(
          () => (
      ...
      function Wt(e) {
        ...
        function l(e) {
          void 0 !== e &&
            ((0, dt.trackEvent)('GUI', 'Magnet mode', e === Bt.MagnetMode.WeakMagnet ? 'Weak' : 'Strong'), (0, Dt.setMagnetMode)(e))
        }
      }
      let Ot
      !(function (e) {
                      ...
                      n.createElement(
                          ...
                          n.createElement(
                            ...
                            this._filteredLineTools.map((o, i) =>
                              n.createElement(ut, {
                                ...
                                favoriting:
                                  this._features.favoriting && !('linetool-group-cursors' === o.id && (0, b.isOnMobileAppPage)('any')),
                        ...
                        !o &&
                          ...
                          n.createElement(
                            'div',
                            { className: no.group, style: s },
                            n.createElement(gt, { chartWidgetCollection: t, isSmallTablet: e, toolName: 'removeAllDrawingTools' })
                          ),
                        ...
                        !o &&
                          ...
                          n.createElement(
                            ...
                            !1,
                            this._features.tools && this._features.favoriting && n.createElement(Mt, { id: Ot.FavoriteDrawings }),
                            h() &&
                              n.createElement(N, { id: Ot.ObjectTree, action: this._handleObjectsTreeClick, toolName: 'showObjectsTree' })
                          )
                      )
                    )
                  )
