    ...
    64378: (e, t, n) => {
      ...
      function h(e, t, n, s = i.EndFirst) {
        const l = (0, a.useCallback)(
          (n, a) => {
            ...
            return (function ({ items: e, containerWidth: t, elementsWidths: n, menuItemWidth: a, keepVisible: s, direction: l }) {
              const r = [...e],
                o = [],
                c = []
              let u = 0
      ...
      function S(e) {
        ...
        return (
          ...
          'automatic' === t
            ...
            : (function (e) {
                const { isRtl: t, items: n, preventDefaultIfHandled: i = !0, isHighlighted: s, onHighlight: l, onActivate: r } = e,
                  o = n.find(s),
                  c = (0, a.useCallback)(() => {
                    void 0 !== o && r(o)
                  }, [o, r]),
      ...
      function E(e) {
        const {
          ...
          O = (0, a.useCallback)(
            (e, t) => {
              l || e.disabled || (I(e), 'number' === typeof t ? (clearTimeout(H.current), (H.current = setTimeout(() => W(e), t))) : W(e))
            },
            [l, E, I, W]
          ),
          T = (0, a.useCallback)(
      ...
      const M = (0, a.forwardRef)((e, t) => {
        const n = (0, a.useContext)(H),
          ...
          { active: s, fake: l, className: r, enableActiveStateStyles: o = i.enableActiveStateStyles, hideFocusOutline: c = !1, ...u } = e
      ...
      ;(0, a.forwardRef)((e, t) => {
        ...
        return a.createElement(
          k,
          {
            ...
            rel: l.rel,
            target: l.target,
            className: F({ size: i, active: u, fake: d, enableActiveStateStyles: b, anchor: !0, hideFocusOutline: f, className: m })
          },
          l.label
        )
