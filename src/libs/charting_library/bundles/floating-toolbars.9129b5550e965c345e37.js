;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2306],
  {
        ...
        return c.createElement(
          'button',
          {
            ...
            'data-overflow-tooltip-text':
              null != o ? o : t.primaryText ? [t.primaryText, t.secondaryText].join(' ') : (0, y.getTextForTooltip)(t.children)
          },
          c.createElement(v, { ...i })
        )
      }
          ...
          Array.isArray(t) || (0, i.isValidElement)(t)
            ? i.Children.toArray(t)
                .reduce((t, e) => {
                  let o = ''
                  return (
                    (o = (0, i.isValidElement)(e) && n(e) ? s(e.props.children) : (0, i.isValidElement)(e) && !n(e) ? '' : r(e)),
                    t.concat(o)
                  )
                }, '')
                .trim()
    ...
    61259: (t, e, o) => {
      ...
      function b(t) {
        const { multipleProperty: e, title: o, undoText: h, propertyApplier: p, isToolbarFixed: u, className: m, isSmallScreen: _ } = t,
        ...
        return i.createElement(
          ...
          f.map(({ value: t, icon: e }) =>
            i.createElement(c.PopupMenuItem, { key: t, theme: y, label: `${t}px`, icon: e, isActive: t === b, onClick: x, onClickArg: t })
          )
        )
        function x(t) {
          t &&
      ...
      function x(t) {
        ...
        return i.createElement(
          ...
          i.createElement('button', {
            ...
            className: n(C.swatch, c && C.hover, r && C.selected, !e && C.empty, String(e).toLowerCase() === f.white && C.white),
            onClick: function () {
              a(e)
            },
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('div', { className: W.pointer, style: { left: 100 * o + '%', top: 100 * (1 - n) + '%' } })
            )
          )
        }
      }
            ...
            (this._handleHSV = (t) => {
              const e =
                (function (t) {
                  ...
                  return (
                    '#' +
                    [255 * n, 255 * r, 255 * s].map((t) => ('0' + Math.round(t).toString(16)).replace(/.+?([a-f0-9]{2})$/i, '$1')).join('')
                  )
                })(t) || F
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement('input', { ref: this._inputRef, type: 'text', className: A.input, value: o, onChange: this._handleInput })
              ),
              i.createElement(
                'div',
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement('div', { className: n(l.pointer, a && l.dragged), style: { left: 100 * e + '%' }, ref: this._refPointer })
              )
            ),
            !o &&
              i.createElement(
                ...
                i.createElement('input', { type: 'text', className: l.opacityInput, value: s, onChange: this._handleInput }),
    ...
    78135: (t, e, o) => {
      ...
      function c(t, e) {
        return (o) => {
          ...
          b === i.AutoStrict &&
            (u < m.y + m.height + y + p ? ((b = i.Top), (w = r.FromBottomToTop)) : ((b = i.Bottom), (w = r.FromTopToBottom)))
      ...
      const a = s,
        l = i.forwardRef((t, e) => {
          ...
          return 'button' === o
            ...
            : i.createElement(
                'div',
                { ...S, ref: e, 'data-role': 'button', className: E, onClick: d ? void 0 : _, title: y, 'data-name': x, 'data-tooltip': T },
                v && g && i.createElement('div', { className: n('js-button-text', f.text) }, g),
                P,
                !v && g && i.createElement('div', { className: n('js-button-text', f.text) }, g),
    ...
    20626: (t, e, o) => {
      ...
      class v extends i.PureComponent {
              ...
              if (t.currentTarget.contains(t.target))
                ...
                switch (i) {
                  case 27: {
                    ...
                    this._handleToggleDropdown(!1), o && i && (null === (e = this._wrapperRef) || void 0 === e || e.focus())
                    break
                  }
                }
              }
            ...
            ? i.createElement(
                ...
                o &&
                  i.createElement(
                    'div',
                    { className: _.arrow },
                    i.createElement('div', { className: _.arrowWrap }, i.createElement(a.ToolWidgetCaret, { dropped: b }))
                  ),
                this.state.isOpened &&
                  (g ? i.createElement(p.MatchMedia, { rule: g }, (t) => this._renderContent(t)) : this._renderContent(c))
              )
            : i.createElement(
                'div',
                {
        ...
        _renderContent(t) {
          const { menuDataName: e, minWidth: o, menuClassName: n, maxHeight: r, drawerPosition: a = 'Bottom', children: l } = this.props,
      ...
      class P extends s.FloatingToolbar {
        ...
        _onFavoriteRemoved(t) {
          delete this._linetoolsWidgets[t],
            this.isVisible() && this._renderToolbarContent(),
            0 === a.LinetoolsFavoritesStore.favorites().filter(B).length && (this._canBeShownValue.setValue(!1), this.hide())
        }
        _onFavoriteMoved() {
          this._renderToolbarContent()
        }
        ...
        _createLinetoolWidget(t) {
          const e = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${
            ...
            }" title="${p.lineToolsInfo[t].localizedName}" data-name="FavoriteToolbar${t}">${p.lineToolsInfo[t].icon}</span>`,
    ...
    10540: (t, e, o) => {
            ...
            (this._handleDragMove = (t) => {
              ...
              if (null !== this._helper.containment) {
                ...
                a &&
                  ...
                  ((this._helper.nextTop = Math.min(this._helper.nextTop, i)), (this._helper.nextTop = Math.max(this._helper.nextTop, e))),
                  l &&
      ...
      class _ {
        ...
        _pointerDistanceMet(t) {
          return (
            !this._initial ||
            !this._distance ||
            Math.max(Math.abs(this._initial.clientX - t.clientX), Math.abs(this._initial.clientY - t.clientY)) >= this._distance
          )
        }
        _getEventTarget() {
          var t
        ...
        _createEvent(t, e) {
          return (
            ...
            new CustomEvent(t, { bubbles: !0, cancelable: !0, detail: { backend: this, initial: this._initial, current: e } })
          )
        }
      }
      var g = o(9859),
      ...
      class f {
        constructor(t) {
          ;(this._items = []),
            ...
            (this._handleDragStop = () => {
              ...
              this._cleanup(), this._initBackends(), null !== o && (null === (e = (t = this._options).stop) || void 0 === e || e.call(t, o))
            }),
            (this._options = t),
            this._initBackends()
        }
        ...
        _getAllItems() {
          var t
          return (
            (null === (t = this._items) || void 0 === t ? void 0 : t.length) || (this._items = Array.from(this._options.source.children)),
            this._items
          )
        }
      ...
      class S {
        ...
        addWidget(t, e = {}) {
          ...
          this._content.insertBefore(n, r), this._onWindowResize(), null === (o = this._sortable) || void 0 === o || o.updateList()
        }
        ...
        removeWidget(t) {
          ...
          o && (this._content.removeChild(o), this._onWindowResize(), null === (e = this._sortable) || void 0 === e || e.updateList())
        }
        widgetsCount() {
        ...
        checkPosition() {
          ...
          this._correctPosition(e),
            (t.left === e.left && t.top === e.top) || ((this._widget.style.left = e.left + 'px'), (this._widget.style.top = e.top + 'px'))
        }
        ...
        _correctPosition(t) {
          ...
          i < 0 ? (t.left = Math.max(0, window.innerWidth - e.width)) : o && o.left > t.left && (t.left = Math.min(t.left + i, o.left)),
            n < 0 ? (t.top = Math.max(0, window.innerHeight - e.height)) : o && o.top > t.top && (t.top = Math.min(t.top + n, o.top))
        }
    ...
    85497: (t, e, o) => {
      ...
      class _ extends m.Property {
        ...
        setValue(t) {
          ;(this._isProcess = !0),
            this._baseProperty.setValue(t, void 0, { applyValue: (t, e) => this._propertyApplier.setProperty(t, e, this._undoText) }),
            (this._isProcess = !1),
        ...
        unsubscribe(t, e) {
          ...
          const i = (0, u.ensureDefined)(
            null === (o = this._listenersMappers.find((o) => o.obj === t && o.method === e)) || void 0 === o ? void 0 : o.callback
          )
      ...
      function x(t) {
        ...
        return c && c.length
          ? i.createElement(
              f.MatchMediaMap,
              { rules: { isSmallWidth: w.DialogBreakpoints.TabletSmall, isSmallHeight: 'screen and (max-height: 430px)' } },
                        ...
                        n.map((o, n) => {
                          ...
                          return r
                            ? o.showForSmallScreen
                              ...
                              : null
                            : i.createElement(o.component, { ...o.props, key: `${o.props.title}_${n}`, className: y()(C, a) })
                        })
                    )
                )
            )
        ...
        function h() {
          return null === e
            ? null
            : i.createElement(e.component, { ...e.props, isToolbarFixed: s, isDrawingFinished: r, className: y()(C, a) })
        }
      }
      var T = o(51768),
        S = o(56388),
      ...
      function X(t) {
        const { title: e, activeChartWidget: o, isSmallScreen: n, className: r } = t,
          ...
          p = (0, i.useCallback)(() => d.contextMenuActionsForSources(a, (0, u.ensureNotNull)(s.paneForSource(a[0]))), [d, a]),
          m = (0, i.useCallback)(() => {
            if (n) return
            const t = $(o, a)
            c(q(t))
      ...
      const pt = new s.TranslatedString('change line tool(s) font size', r.t(null, void 0, o(37453))),
        ...
        mt =
          ...
          new s.TranslatedString('line tool(s) line style', r.t(null, { context: 'line tool property name' }, o(64974)))),
      ...
      class bt {
        ...
        _onSourceChanged(t) {
          ...
          if (
            ...
            e.isAvailableInFloatingWidget() && this.activeChartWidget().model().model().dataSourceForId(e.id())
              ? (!e.userEditEnabled() ||
                  (!(0, ct.isLineDrawnWithPressedButton)(e.toolname) && this.activeChartWidget().model().lineBeingCreated()) ||
        ...
        _propertyApplierImpl() {
          return (
            this._propertyApplier ||
              (this._propertyApplier = new dt.PropertyApplierWithoutSavingChart(() => this.activeChartWidget().model())),
            this._propertyApplier
          )
        }
        _clearProperties() {
        ...
        _createRemoveButton() {
          const t = { component: R, props: { title: gt, activeChartWidget: this.activeChartWidget() }, showForSmallScreen: !0 }
          this._addCommonButton(t)
        }
        _createDotsButton() {
          this._addCommonButton({ component: X, props: { title: vt, activeChartWidget: this.activeChartWidget() }, showForSmallScreen: !0 })
        }
        _createAlertButton() {}
        ...
        _createLineStyleButton(t) {
          ...
          if (1 === e.length) {
            ...
            ;(o = new d.CollectiblePropertyUndoWrapper(new p.LineToolCollectedProperty(t), mt, this._propertyApplierImpl())),
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ...
              : new g.CollectibleColorPropertyUndoWrapper(new p.MultipleLineColorsProperty(t), this._propertyApplierImpl(), i)
          }
          if (t && t.visible())
    ...
    36074: (t, e, o) => {
      ...
      class D extends n {
        ...
        _riskPropertiesExceptionCases() {
          return [
            { name: 'textcolor', title: g, inputType: 'colorPicker', iconSvgCode: c, dataName: 'text-color', undoText: p },
            { name: 'profitBackground', title: T, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: d },
            { name: 'stopBackground', title: S, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: d }
          ]
        }
        _rangeExceptionCases() {
          return [
            { name: 'linecolor', inputType: 'colorPicker', iconSvgCode: a, title: m, dataName: 'line-tool-color', undoText: h },
            {
        ...
        _notePropertiesExceptionCases() {
          return [
            { name: 'markerColor', title: E, inputType: 'colorPicker', iconSvgCode: a, dataName: 'line-tool-color', undoText: h },
            { name: 'textColor', title: g, inputType: 'colorPicker', iconSvgCode: c, dataName: 'text-color', undoText: p },
            { name: 'fontSize', title: w, inputType: 'combobox', factory: D.prototype._createFontSizeButton }
          ]
        }
        _createToolExceptionCases() {
          return {
            ...
            LineToolBarsPattern: [
              { name: 'color', title: m, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: h }
            ],
            LineToolProjection: [
              { name: 'color1', title: P, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: d },
              { name: 'color2', title: B, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: d },
              { name: 'linesWidths', inputType: 'combobox', factory: D.prototype._createWidthsButton }
            ],
            LineToolSignpost: [
              {
