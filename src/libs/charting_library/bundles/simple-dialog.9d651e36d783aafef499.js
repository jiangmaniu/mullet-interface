          ...
          ;(e.disableBodyScroll = function (e, o) {
            if (l) {
              ...
              if (
                ...
                let m = { targetElement: e, options: o || {} }
                ;(a = [].concat(t(a), [m])),
              ...
              ;(v = o),
                setTimeout(function () {
                  if (void 0 === c) {
                    let e = !!v && !0 === v.reserveScrollBarGap,
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  (function (t) {
                    ...
                    if ('content' in e)
                      return o.createElement(f.TouchScrollContainer, { className: a(y.content, t && y.small, p) }, e.content)
                    return null
                  })(i),
                  l &&
                    l.length > 0 &&
            ...
            actions: [
              {
                ...
                intent: u || 'primary',
                handler: ({ dialogClose: e, innerManager: t }) => f({ newValue: g, focusInput: _, dialogClose: e, innerManager: t })
              },
              {
                name: 'cancel',
