;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6631],
  {
    ...
    15294: (e, t, a) => {
      ...
      class c extends n.PureComponent {
        render() {
          ...
          let c = null
          return (
            this.props.label && (c = n.createElement('span', { className: l, title: this.props.title }, this.props.label)),
    ...
    57733: (e, t, a) => {
      ...
      let n = a(50959)
      const i = function () {},
        s = (0, n.createContext)({ getName: () => '', getValues: () => [], getOnChange: () => i, subscribe: i, unsubscribe: i })
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            s &&
              ...
              n.createElement(
                'button',
                { className: S.close, onClick: l, onKeyDown: r, 'data-name': 'close', 'aria-label': p, type: 'button', ref: b },
            ...
            (this._handleKeyDown = (e) => {
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, l.hashFromEvent)(e))) {
                  ...
                  if (null !== a) {
                    if (
                      (e.preventDefault(), 'true' === (t = a).getAttribute('data-haspopup') && 'true' !== t.getAttribute('data-expanded'))
                    )
                      return void this._handleClose()
                    if ((0, c.isTextEditingField)(a)) return void n.focus()
                    if (n.contains(a)) return this.props.onKeyboardClose && this.props.onKeyboardClose(), void this._handleClose()
                  }
                }
                let t, a
                ;(function (e) {
    ...
    13932: (e, t, a) => {
      ...
      function k(e) {
        const { title: t, saveSymbolHintText: a, saveIntervalHintText: i, indicatorsText: o, source: u, onClose: m, onSubmit: h } = e,
          [p, b] = (0, s.useState)(''),
          [S, k] = (0, s.useState)(!1),
          [T, E] = (0, s.useState)(!1),
          [D, I] = (0, s.useState)(!1),
      ...
      class D {
        constructor(e) {
          ;(this._container = document.createElement('div')),
            ...
            (this.unmount = () => {
              T.unsubscribe(E.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null), o.unmountComponentAtNode(this._container)
            }),
            (this._title = e.title),
      ...
      class j {
        ...
        _prepareData(e, t, a) {
          ...
          return { name: e, content: JSON.stringify(n), meta_info: (0, O.createStudyTemplateMetaInfo)(this._controller, n.interval) }
        }
        _doSave(e, t, a) {
