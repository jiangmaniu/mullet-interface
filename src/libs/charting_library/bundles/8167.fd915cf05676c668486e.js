                ...
                e.forEach((e) => {
                  ...
                  switch (a) {
                    case '': {
                      ...
                      ;(r -= e.price), (t -= e.index), (o = i.map((e) => ({ ...e, index: e.index + t, price: e.price + r })))
                      break
                    }
                    case '-':
                    case '+': {
                      let { index: e = 0, price: t = 0 } = c
                      '-' === a && ((e *= -1), (t *= -1)), (o = i.map((i) => ({ ...i, index: i.index + e, price: i.price + t })))
                      break
                    }
                    case '*': {
                  ...
                  t.undoHistory().pushUndoCommand(new l({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: o }))
                })
              })
            } finally {
              o.setValue('', !0)
      ...
      function ae(e, t, i) {
        ...
        const o = (0, s.createRangePropertyDefinition)(
          ...
          d = (0, s.createRangePropertyDefinition)(
            ...
            { id: 'IntervalsVisibilitiesHours', title: U, min: new l.WatchedValue(oe[0]), max: new l.WatchedValue(oe[1]) }
          ),
          c = (0, s.createRangePropertyDefinition)(
            ...
            { id: 'IntervalsVisibilitiesDays', title: A, min: new l.WatchedValue(re[0]), max: new l.WatchedValue(re[1]) }
          )
        n.push(o, d, c)
            ...
            definitions: [
              (0, r.createStudyInputsPropertyDefinition)(
                {},
                {
                  ...
                  source: { isInputsStudy: !0, symbolsResolved: () => new o.Delegate(), resolvedSymbolInfoBySymbol: (e) => null }
                }
              )
            ]
          }
