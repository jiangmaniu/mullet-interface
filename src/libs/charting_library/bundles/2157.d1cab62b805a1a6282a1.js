  ...
  [2157],
  {
            ...
            (e.enableBodyScroll = function (e) {
              if (s) {
                ...
                ;(e.ontouchstart = null),
                  ...
                  a && 0 === r.length && (document.removeEventListener('touchmove', d, n ? { passive: !1 } : void 0), (a = !1))
              } else
    ...
    5811: (e, t, n) => {
      ...
      function c(e) {
        ...
        return o.createElement('span', { className: b, ...p }, o.createElement(r.Icon, { icon: v, className: l().icon }))
      }
    },
    26996: (e, t, n) => {
      'use strict'
    ...
    10772: (e, t, n) => {
      ...
      function v(e) {
        ...
        return o.createElement(m.ContextMenuItem, {
          size: t,
          jsxLabel: o.createElement('div', { className: d()(p.loaderWrap, p[t]) }, o.createElement(h.Loader, { className: p.loader })),
          noInteractive: !0,
            ...
            o.createElement(
              ...
              w &&
                ...
                o.createElement(
                  'td',
                  null,
                  o.createElement(c.FavoriteButton, { className: l.favourite, isFilled: i, onClick: this.props.onFavouriteClick })
                ),
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(
                    ...
                    !v && g ? g.map(({ text: e, ...t }, n) => o.createElement('span', { key: n, style: t }, e)) : null != v ? v : p
                  ),
                  this._toolbox(l),
                  e &&
                    o.createElement('span', { className: l.arrowIcon, dangerouslySetInnerHTML: { __html: b }, 'data-submenu-arrow': !0 }),
                  !e && t && !a.CheckMobile.any() && o.createElement(u.Hint, { className: s(r && l.invisibleHotkey), text: t }),
        ...
        _icon(e) {
          if (this.props.checkable) {
            if (this.props.checkboxInput)
              return o.createElement(r.CheckboxInput, { className: s(e.icon, e.checkboxInput), checked: this.props.checked })
    ...
    91561: (e, t, n) => {
      ...
      function x(e) {
        const { items: t, parentAction: n, closeNested: s } = e,
          r = !Boolean(n) && t.every((e) => !Boolean('separator' !== e.type && (e.getState().icon || e.getState().checkable)))
        return o.createElement(
      ...
      class _ extends o.PureComponent {
        ...
        render() {
          const { isOpened: e, onClose: t, items: n, doNotCloseOn: s, menuStatName: a, parentStatName: m, takeFocus: p, ...v } = this.props
          return e
            ? o.createElement(
                d.DrawerManager,
                null,
        ...
        return s
          ...
          : o.createElement(
              ...
              o.createElement(
                'span',
                { className: r()(m.label) },
                !N && C ? C.map(({ text: e, ...t }, n) => o.createElement('span', { key: n, style: t }, e)) : null != N ? N : y
              ),
              !!S &&
                o.createElement(a.Icon, {
                  onClick: function () {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(p, { className: r(v.drawer, d[`position${t}`], m), ref: g, 'data-name': e['data-name'] }, u)
            )
          )
        )
      }
            ...
            if (a.CheckMobile.iOS())
              return (
                ...
                () => {
                  l--,
                    null !== c.current &&
                      (i ? 0 === l && (document.body.style.overscrollBehavior = '') : (0, s.enableBodyScroll)(c.current))
                }
              )
          }, []),
