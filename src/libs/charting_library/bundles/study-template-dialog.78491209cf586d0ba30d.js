  ...
  [6631],
  {
    ...
    5811: (e, t, n) => {
      ...
      function c(e) {
        ...
        return s.createElement('span', { className: v, ...m }, s.createElement(i.Icon, { icon: b, className: l().icon }))
      }
    },
    15294: (e, t, n) => {
      'use strict'
      ...
      class c extends s.PureComponent {
        render() {
          ...
          let c = null
          return (
            this.props.label && (c = s.createElement('span', { className: r, title: this.props.title }, this.props.label)),
      ...
      function r(e) {
        ...
        return (
          (t = class extends s.PureComponent {
            ...
            render() {
              return s.createElement(e, { ...this.props, name: this._getName(), onChange: this._onChange, checked: this._isChecked() })
            }
    ...
    79418: (e, t, n) => {
      ...
      class k extends s.PureComponent {
        ...
        componentDidMount() {
          this.props.ignoreClosePopupsAndDialog || v.subscribe(b.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          this.props.ignoreClosePopupsAndDialog || v.unsubscribe(b.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
    ...
    3606: (e, t, n) => {
      ...
      function D(e) {
        const { title: t, saveSymbolHintText: n, saveIntervalHintText: o, indicatorsText: c, source: u, onClose: d, onSubmit: h } = e,
          [p, m] = (0, i.useState)(''),
          [g, _] = (0, i.useState)(!1),
          [C, w] = (0, i.useState)(!1),
          [E, D] = (0, i.useState)(!1),
      ...
      class A {
        ...
        _mount() {
          ...
          this._rootInstance ? this._rootInstance.render(e) : (this._rootInstance = (0, O.createReactRoot)(e, this._container))
        }
      }
      var P = n(39076),
        I = n(3615),
