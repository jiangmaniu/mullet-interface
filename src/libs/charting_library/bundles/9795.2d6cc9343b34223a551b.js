  ...
  [9795, 3016, 3179],
  {
    ...
    36383: (e, t, n) => {
      ...
      let o = n(50959),
        i = n(27267)
      function r(e) {
        const { click: t, mouseDown: n, touchEnd: r, touchStart: s, handler: a, reference: l, ownerDocument: c = document } = e,
          d = (0, o.useRef)(null),
    ...
    15650: (e, t, n) => {
      ...
      function l(e) {
        ...
        return p
          ? o.createElement(a.CommonSection, { id: t, offset: d, checked: n, title: l, solutionId: c, disabled: e.disabled || u })
          : null
      }
      let c = n(97754),
        d = n.n(c),
        ...
        constructor(e) {
          super(e),
            ...
            (this._items = J.map((t) => ({
              ...
              content: o.createElement(G.DropItem, { icon: t.icon, iconClassName: d()(e.isRight && $.right), label: t.label })
            })))
        }
        render() {
      ...
      function j(e) {
        ...
        return o.createElement(
          ...
          o.Children.map(t, (e) =>
            o.isValidElement(e)
              ? o.createElement('span', { key: null === e.key ? void 0 : e.key, className: c(K.row, r(e) && K.empty) }, e)
              : e
          )
        )
        function r(e) {
      ...
      function te(e) {
        const {
            definition: {
              id: t,
              properties: { checked: n, disabled: i, visible: r, leftEnd: l, rightEnd: d, value: p, extendLeft: f, extendRight: g },
              title: v,
              valueMin: y,
              valueMax: b,
              valueStep: _,
        ...
        return N
          ? o.createElement(
                    ...
                    (function () {
                      ...
                      return (
                        ...
                        o.createElement(
                          'span',
                          { className: ee.control },
                          o.createElement(h, { id: (0, u.createDomId)(t, 'line-style-select'), property: n, disabled: R })
                        )
                      )
                    })()
                  ),
              ...
              f && o.createElement(a.CommonSection, { id: `${t}ExtendLeft`, offset: x, checked: f, title: w, disabled: e.disabled || T }),
              g && o.createElement(a.CommonSection, { id: `${t}ExtendRight`, offset: x, checked: g, title: C, disabled: e.disabled || T })
            )
          : null
      }
      let ne = n(93613),
      ...
      function ve(e) {
        ...
        return v
          ...
          : null
        function b(e, t) {
          return o.createElement('span', { className: ge.colorPicker }, o.createElement(L, { color: e, disabled: y, noAlpha: t }))
        }
      }
      let ye = n(66849),
        be = n(76739)
      ...
      function Ce(e) {
        const { property: t } = e,
          [n, i] = (0, s.useDefinitionProperty)({ property: t })
        return o.createElement(we.FontSizeSelect, { ...e, fontSize: n, fontSizeChange: i, 'data-name': 'font-size-select' })
      }
      let De = n(9745),
        Se = n(68089)
      function xe(e) {
      ...
      function We(e) {
        ...
        return o.createElement(
          ...
          ee(V, g, v, !!g && !$),
          ee(M, y, b, !!y && !J, _, k),
          E && o.createElement(a.CommonSection, { id: `${t}Wrap`, offset: R, checked: E, title: B, disabled: e.disabled || W })
        )
        let X
        function K(e, t, n) {
          return e ? o.createElement(Pe, { className: Re.fontStyleButton, icon: t, property: e, disabled: Y, 'data-name': n }) : null
        }
        function Z() {
          return o.createElement(
            o.Fragment,
            ...
            i && D && o.createElement(Ce, { id: (0, u.createDomId)(t, 'font-size-select'), property: i, fontSizes: D, disabled: Y })
          )
        }
        function Q() {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement('div', { className: c(qe.pointer, l && qe.dragged), style: { [h]: 100 * u + '%' }, ref: this._refPointer })
              ),
              o.createElement(
                'div',
                { className: qe.rangePointerWrap },
      ...
      function ot(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            t.map((e) =>
              o.createElement('div', { className: nt.item, key: e.id, 'data-section-name': e.id }, o.createElement(rt, { definition: e }))
            )
          )
        )
      }
            ...
            ;(0, o.useEffect)(() => {
              ...
              return (
                Object.entries(t).forEach(([n, o]) => {
                  void 0 !== o &&
                    o.subscribe(t, () => Ye.logger.logNormal(`Property "${n}" in definition "${e.id}" was updated to value "${o.value()}"`))
                }),
                () => {
    ...
    95276: (e, t, n) => {
      ...
      const d = o.forwardRef((e, t) => {
        ...
        return o.createElement(
          ...
          m,
          o.createElement('span', { className: c.invisibleFocusHandler, tabIndex: 0, 'aria-hidden': !0, onFocus: () => V() })
        )
      })
      ...
      class v extends o.PureComponent {
          ...
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const { width: D, height: S } = y,
                ...
                P =
                  null !== (i = null === (o = null == x ? void 0 : x.indentFromWindow) || void 0 === o ? void 0 : o.left) && void 0 !== i
                    ? i
                    : 0,
                T =
                  _ -
                  (null !== (r = x.overrideWidth) && void 0 !== r ? r : D) -
                  (null !== (c = null === (l = null == x ? void 0 : x.indentFromWindow) || void 0 === l ? void 0 : l.right) && void 0 !== c
                    ? c
                    : 0),
                N = (0, a.clamp)(x.x, P, Math.max(P, T)),
                V =
                  (null !== (u = null === (d = null == x ? void 0 : x.indentFromWindow) || void 0 === d ? void 0 : d.top) && void 0 !== u
                    ? u
                    : 0) + E,
                M =
                  b -
                  (null !== (p = x.overrideHeight) && void 0 !== p ? p : S) -
                  (null !== (m = null === (h = null == x ? void 0 : x.indentFromWindow) || void 0 === h ? void 0 : h.bottom) && void 0 !== m
                    ? m
                    : 0)
        ...
        render() {
          const {
            ...
            V = { '--ui-kit-menu-max-width': `${T && T.x}px`, maxWidth: 'calc(100vw - var(--ui-kit-menu-max-width) - 6px)' }
          return o.createElement(
    ...
    12811: (e, t, n) => {
      ...
      function c(e, t) {
        return (n, c, d, u) => {
          ...
          _ === o.AutoStrict &&
            (u < m.y + m.height + y + c ? ((_ = o.Top), (E = r.FromBottomToTop)) : ((_ = o.Bottom), (E = r.FromTopToBottom)))
    ...
    43715: (e, t, n) => {
      ...
      function l(e, t) {
        ...
        return (
          ...
          (void 0 === n.properties.leftEnd && void 0 === n.properties.rightEnd) || void 0 !== n.endsValues || (n.endsValues = a),
    ...
    46141: (e, t, n) => {
      ...
      function w(e, t) {
        ...
        return (
          ...
          (n.alignmentVerticalItems || n.alignmentHorizontalItems) && void 0 === n.alignmentTitle && (n.alignmentTitle = _),
          void 0 !== n.properties.orientation &&
            (void 0 === n.orientationItems && (n.orientationItems = v), void 0 === n.orientationTitle && (n.orientationTitle = E)),
              ...
              if (void 0 !== r)
                if (void 0 !== s)
                  if (n.has(r)) {
                    ...
                    let l
                    i.has(t) ? (l = (0, o.ensureDefined)(i.get(t))) : ((l = new Map()), i.set(t, l)), a(e, 'inline', s, l, t.children)
                  } else {
