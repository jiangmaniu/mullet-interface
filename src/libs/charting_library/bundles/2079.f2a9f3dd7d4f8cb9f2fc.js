  ...
  [2079],
  {
    ...
    64388: (e, t, n) => {
      ...
      const c = (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement('button', { ...d, className: l({ ...e, children: u }), ref: t, type: o }, r.createElement(a, { icon: n }, u))
      })
          ...
          if (
            ...
            this.stopScroll(),
              a('vertical', this._container) &&
                (this._stopVerticalScroll = c('vertical', e, this._container, n, r, this._modifyOptions('vertical', t))),
              a('horizontal', this._container) &&
                (this._stopHorizontalScroll = c('horizontal', e, this._container, n, r, this._modifyOptions('horizontal', t)))
          }
      ...
      function d(e = {}) {
        const { activeItem: t, getKey: n, ...i } = e,
          ...
          a = (function (e) {
            ...
            return (0, r.useEffect)(() => ((t.current = new u(e)), () => (0, o.ensureNotNull)(t.current).destroy()), []), t
          })(s.current),
          c = (0, r.useCallback)(() => {
    ...
    79418: (e, t, n) => {
      ...
      class N extends r.PureComponent {
        ...
        componentDidMount() {
          this.props.ignoreClosePopupsAndDialog || g.subscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          this.props.ignoreClosePopupsAndDialog || g.unsubscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
          ...
          () =>
            (function (e, t, { x: n = s.x, y: r = s.y } = s) {
              const o = (0, i.ensureNotNull)(e).getBoundingClientRect(),
                l = { x: o.left + n, y: o.top + o.height + r, indentFromWindow: { top: 4, bottom: 4, left: 4, right: 4 } }
