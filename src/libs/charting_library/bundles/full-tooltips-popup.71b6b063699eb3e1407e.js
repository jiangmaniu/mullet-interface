          ...
          ;(e.disableBodyScroll = function (e, n) {
            if (r) {
              ...
              if (
                ...
                let m = { targetElement: e, options: n || {} }
                ;(a = [].concat(t(a), [m])),
              ...
              let p = { targetElement: e, options: n || {} }
              a = [].concat(t(a), [p])
            }
            let v
          }),
          ...
          return (
            void 0 !== e.additionalWidgets &&
              (w = e.additionalWidgets.map(
                (e) => (g.has(e) || g.set(e, (0, c.randomHash)()), e.renderer((0, u.ensureDefined)(g.get(e)), f.additionalWidget))
              )),
            n.createElement(
              'div',
