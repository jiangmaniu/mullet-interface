    ...
    73339: (t, e, i) => {
      ...
      async function u(t, e, n, u, c) {
        ...
        async function S(e, i, o, s, u) {
          const c = await t.requestSelectPoint({ pointType: i, pane: a, lineColor: void 0, selectPointMode: p.SelectPointMode.Study }, o)
          void 0 === a && (a = c.pane)
              ...
              if (void 0 !== o)
                if (void 0 !== s)
                  if (i.has(o)) {
                    ...
                    let u
                    n.has(e) ? (u = (0, r.ensureDefined)(n.get(e))) : ((u = new Map()), n.set(e, u)), p(t, 'inline', s, u, e.children)
                  } else {
