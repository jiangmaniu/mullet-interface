...
;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8537],
  {
    ...
    2908: (e, t, i) => {
      ...
      function T(e, t, i, n, o) {
        ...
        return (
          ...
          void 0 !== t.lineColor && (T.color = (0, r.getColorDefinitionProperty)(e, t.lineColor, null, d.format({ toolName: i }))),
          void 0 !== t.extendLeft &&
    ...
    50653: (e, t, i) => {
      ...
      function b(e, t, i, n) {
        const o = {},
          b = { id: `${(0, l.removeSpaces)(i.originalText())}Text`, title: (n.customTitles && n.customTitles.text) || '' }
        if (
          (void 0 !== t.showText && (o.checked = (0, r.convertToDefinitionProperty)(e, t.showText, s.format({ toolName: i }))),
          void 0 !== t.textColor &&
            (o.color = (0, r.getColorDefinitionProperty)(e, t.textColor, t.transparency || null, a.format({ toolName: i }))),
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, r.createLineStyleDefinition)(this._propertyApplier, { showLine: e.showWave, lineWidth: e.linewidth }, i, 'Line', {
                line: h
              }),
        ...
        _stylePropertyDefinitions() {
          ...
          if ((e.push(te), 'fibLevelsBasedOnLogScale' in t && null !== this._disabledBasedOnLog)) {
            const i = (0, s.createCheckablePropertyDefinition)(
              {
                disabled: (0, s.convertFromWVToDefinitionProperty)(this._propertyApplier, this._disabledBasedOnLog, m.format({ title: a })),
                checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.fibLevelsBasedOnLogScale, m.format({ title: a }))
              },
        ...
        _stylePropertyDefinitions() {
          ...
          for (let e = 0; e < F; e++) {
            const i = t.arcs.childs()[e].childs(),
              n = (0, s.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.visible, m.format({ title: a, index: e })),
                  color: (0, s.getColorDefinitionProperty)(this._propertyApplier, i.color, null, b.format({ title: a, index: e })),
              ...
              (0, s.createColorPropertyDefinition)(
                {
                  ...
                  color: (0, s.getColorDefinitionProperty)(this._undoModel, e.backgroundColor, e.transparency, d.format({ title: i }))
                },
                { id: (0, a.removeSpaces)(`${t}BackgroundColor`), title: p }
              )
            ]
      ...
      class b extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            m = (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: t.linecolor, lineWidth: t.linewidth }, s, 'Line', {
              line: f
            })
      ...
      class h extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = new o.TranslatedString(t, this._source.translatedType()),
            n = (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.color, lineWidth: e.linewidth }, i, 'Line', {
              line: p
            }),
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, r.createCheckablePropertyDefinition)(
                { checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.extendLeft, c.format({ title: n })) },
                { id: `${i}ExtendLeft`, title: y }
              ),
              (0, r.createCheckablePropertyDefinition)(
                { checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.extendRight, d.format({ title: n })) },
                { id: `${i}ExtendRight`, title: f }
              ),
              (0, r.createColorPropertyDefinition)(
                {
                  checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.fillBackground, p.format({ title: n })),
                  color: (0, r.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, e.transparency, u.format({ title: n }))
                },
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.color, lineWidth: e.linewidth }, i, 'Line', {
                line: h
              }),
              (0, a.createColorPropertyDefinition)(
                {
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.color, lineWidth: e.linewidth }, t, 'Line', {
                line: c
              })
            ]
          }
      ...
      class m extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          t.hasChild('extendLines') &&
            e.push(
              (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, i.extendLines, p.format({ title: m })) },
          ...
          for (let t = 0; t <= L; t++) {
            const n = i[`level${t}`].childs(),
              o = (0, a.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, n.visible, u.format({ title: m, index: t + 1 })),
                  color: (0, a.getColorDefinitionProperty)(this._propertyApplier, n.color, null, h.format({ title: m, index: t + 1 })),
                  width: (0, a.convertToDefinitionProperty)(this._propertyApplier, n.linewidth, y.format({ title: m, index: t + 1 })),
                  style: (0, a.convertToDefinitionProperty)(this._propertyApplier, n.linestyle, f.format({ title: m, index: t + 1 })),
                  level: (0, a.convertToDefinitionProperty)(this._propertyApplier, n.coeff, v.format({ title: m, index: t + 1 }))
                },
                { id: `${s}LineLevel${t + 1}` }
              )
            e.push(o)
          ...
          const k = (0, a.createTransparencyPropertyDefinition)(
            {
              checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, i.fillBackground, T.format({ title: m })),
              transparency: (0, a.convertToDefinitionProperty)(this._propertyApplier, i.transparency, D.format({ title: m }))
            },
    ...
    62890: (e, t, i) => {
      ...
      class h extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.linecolor, lineWidth: e.linewidth }, i, 'Line', {
                line: p
              }),
              (0, s.createColorPropertyDefinition)(
                {
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            l = (0, r.createCheckablePropertyDefinition)(
              { checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.extendRight, c.format({ title: i })) },
