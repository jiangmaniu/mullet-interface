  ...
  [92],
  {
    ...
    64388: (e, t, n) => {
      ...
      const c = (0, r.forwardRef)((e, t) => {
        const { icon: n, type: o = 'button', preservePaddings: i, flipIconOnRtl: a, size: c, 'aria-label': l, ...f } = e
        return r.createElement('button', { ...f, className: s({ ...e, children: l }), ref: t, type: o }, r.createElement(u, { icon: n }, l))
      })
          ...
          r.createElement(
            ...
            n &&
              r.createElement(
                ...
                u && r.createElement(s.Icon, { className: a(C().icon, g && C()['light-icon']), icon: null != l ? l : _[t] }),
                r.createElement(
                  'div',
                  { className: a(C()['text-wrap'], g && C()['light-text-wrap']) },
                  i &&
                    r.createElement('span', { className: a(g && C()['light-title'], C().header, C()[`header-${g ? 'new-line' : p}`]) }, i),
      ...
      ;(t.Children = {
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          let o = m({}, e.props),
            ...
            s = e._owner
          if (null != t) {
            if ((void 0 !== t.ref && ((a = t.ref), (s = x.current)), void 0 !== t.key && (i = '' + t.key), e.type && e.type.defaultProps))
