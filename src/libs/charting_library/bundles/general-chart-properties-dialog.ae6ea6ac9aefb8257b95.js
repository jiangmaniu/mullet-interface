      ...
      function u(e) {
        ...
        return l.createElement(
          u,
          {
            ...
            ref: d,
            title: C ? n : '',
            className: o()(m.tab, C && m.isTablet, _ && m.isMobile, a && m.active, T && m.withoutArrow, b, C && 'apply-common-tooltip'),
            onClick: h
          },
          ...
          !C &&
            l.createElement(
              'span',
              { className: o()(m.title, !i && m.withoutIcon, 'medium' === p ? m.medium : m.large, g && m.showLastDivider) },
    ...
    56080: (e, t, n) => {
      ...
      function M(e) {
        ...
        return l.createElement(
          ...
          l.createElement(g.AccessibleMenuItem, {
            ...
            label: t,
            onClick: c,
            toolbox: l.createElement(S.MenuRemoveButton, { className: w.remove, hidden: !E.mobiletouch && !o, onClick: r })
          })
        )
      }
      var P = n(95276),
      ...
      class F extends l.PureComponent {
                ...
                window.runOrSignIn(
                  () =>
                    (async function (e, t, i) {
                      const [l, a] = await Promise.all([Promise.all([n.e(6302), n.e(7648)]).then(n.bind(n, 57351)), (0, T.getThemeNames)()])
        ...
        _getThemeItems(e) {
          ...
          return l.createElement(
            l.Fragment,
            null,
            e && t && l.createElement(g.AccessibleMenuItem, { className: w.defaultsButtonItem, isActive: !1, label: L, onClick: i }),
            l.createElement(g.AccessibleMenuItem, {
      ...
      const q = (0, l.forwardRef)((e, t) => {
        const [n, i] = (0, X.useRovingTabindexElement)(t),
          { className: a } = e
        return l.createElement(K.DialogSidebarItem, { ...e, className: G()(U.accessible, a), tag: 'button', reference: n, tabIndex: i })
      })
      function Q(e) {
        ...
        constructor(e) {
          ...
          super(e),
            (this._renderChildren = ({ requestResize: e, isSmallWidth: t }) => (
              (this._requestResize = e), l.createElement('div', { className: ie.content }, this._renderTabs(t), this._renderTabContent(t))
            )),
            (this._renderApplyToAllButton = () =>
              l.createElement(d.MatchMedia, { rule: V.DialogBreakpoints.TabletNormal }, (e) => this._renderApplyToAll(e))),
          ...
          return l.createElement(
            ...
            (r) =>
              l.createElement(s.AdaptiveConfirmDialog, {
                ...
                additionalHeaderElement: null !== o && r ? l.createElement(te, { onClick: this._handleBackClick }) : void 0,
        ...
        _renderApplyToAll(e) {
          ...
          return (
            ...
            l.createElement(
              ...
              l.createElement(a.Button, { appearance: 'stroke', onClick: this._handleApplyToAll }, i.t(null, void 0, n(77571)))
            )
          )
        }
        _getCurrentPage(e) {
      ...
      class he extends se.DialogRenderer {
        constructor(e) {
          super(),
            (this._handleClose = () => {
              var e
              null === (e = this._rootInstance) || void 0 === e || e.unmount(), this._setVisibility(!1), this._onClose && this._onClose()
            }),
            (this._handleSubmit = () => {}),
            (this._handleCancel = () => {
