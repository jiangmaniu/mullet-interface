;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1044, 8115, 306],
  {
    59255: (t, e, n) => {
      ...
      let u = ['top', 'right', 'bottom', 'left', 'width', 'height', 'size', 'weight'],
      ...
      function y(t) {
        ...
        if (
          ('border-box' === r.boxSizing &&
            (Math.round(u + i) !== e && (u -= d(r, 'left', 'right') + i), Math.round(c + s) !== n && (c -= d(r, 'top', 'bottom') + s)),
          !(function (t) {
            return t === l(t).document.documentElement
          })(t))
        ) {
          let a = Math.round(u + i) - e,
            f = Math.round(c + s) - n
      ...
      ;(e.Children = {
        ...
        (e.cloneElement = function (t, e, r) {
          ...
          let o = y({}, t.props),
            ...
            u = t._owner
          if (null != e) {
            if ((void 0 !== e.ref && ((s = e.ref), (u = O.current)), void 0 !== e.key && (i = '' + e.key), t.type && t.type.defaultProps))
