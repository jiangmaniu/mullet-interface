  ...
  [2704],
  {
    ...
    64388: (e, t, i) => {
      ...
      const c = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement('button', { ...h, className: a({ ...e, children: d }), ref: t, type: o }, n.createElement(l, { icon: i }, d))
      })
    ...
    79418: (e, t, i) => {
      ...
      class k extends n.PureComponent {
            ...
            (this._handleKeyDown = (e) => {
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, a.hashFromEvent)(e))) {
                  ...
                  if (null !== i) {
                    if (
                      (e.preventDefault(), 'true' === (t = i).getAttribute('data-haspopup') && 'true' !== t.getAttribute('data-expanded'))
                    )
        ...
        componentDidMount() {
          this.props.ignoreClosePopupsAndDialog || f.subscribe(g.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          this.props.ignoreClosePopupsAndDialog || f.unsubscribe(g.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            null !== this._orientationMediaQuery && this._orientationMediaQuery.removeEventListener('change', this._handleOpen),
    ...
    69654: (e, t, i) => {
      ...
      function h(e) {
        ...
        return n.createElement(
          ...
          p && (!o || '' !== _.value) && n.createElement('div', { className: s()(d.cancel, o && d.mobile), onClick: p }, v)
        )
      }
      function u(e) {
        const {
    ...
    41153: (e, t, i) => {
      ...
      const M = n.memo(
        function (e) {
          ...
          return n.createElement(
            ...
            m &&
              (void 0 !== i
                ? n.createElement(D.CircleLogo, { logoUrl: i, size: p ? 'xsmall' : 'xxxsmall', className: v()(k.icon, x) })
                ...
                n.createElement(
                  ...
                  e.name
                    ? n.createElement(
                        ...
                        { summary: e.name, className: T.section, open: f[e.id], onStateChange: (t) => y({ ...f, [e.id]: t }) },
                        e.actions.map(E)
                      )
                    : e.actions.map(E)
                )
      ...
      const H = { horizontalAttachEdge: g.HorizontalAttachEdge.Right, horizontalDropDirection: g.HorizontalDropDirection.FromRightToLeft }
      function U(e) {
        const { element: t, ...i } = e,
          [o, s] = (0, n.useState)(y()),
          [r, a] = (0, n.useState)(''),
            ...
            s(
              r
                ? (function (e, t, i) {
                    ...
                    return (0, d.rankedSearch)({ data: n, rules: i, queryString: t, primaryKey: 'label', secondaryKey: 'description' })
                  })(i.sections, r, v)
                : y()
            )
          }, [r, i.sections, v])
          ...
          ;(this._rootElem = document.createElement('div')),
            ...
            (this.close = () => {
              ...
              if (((this._isOpened = !1), this._disableShowMenu)) {
                ...
                W(t[0], this._isOpened, t[1], t[2], t[3]), null === (e = this._handlerOutsideClickDestroy) || void 0 === e || e.call(this)
              }
    ...
    82206: (e, t, i) => {
      ...
      function v(e) {
        return { x: (0, m.clamp)(e.x, 20, document.documentElement.clientWidth - 20), y: (0, m.clamp)(e.y, 20, window.innerHeight - 20) }
      }
      function _(e) {
      ...
      class M {
        ...
        dispatch(e) {
          ...
          null !== this._openSessionId
            ? (window.dispatchEvent(new CustomEvent(e, { bubbles: !0, detail: { dialogSessionId: this._openSessionId } })),
      ...
      const T = class {
        ...
        _getClientDimensions() {
          return { clientHeight: document.documentElement.clientHeight, clientWidth: document.documentElement.clientWidth }
        }
        _getTopOffset() {
          return 0
        }
      ...
      class B extends n.PureComponent {
        ...
        render() {
          return n.createElement(
            ...
            { value: this },
            n.createElement(p.OutsideEvent, { mouseDown: !0, touchStart: !0, handler: this.props.onClickOutside }, (e) =>
              n.createElement(
                'div',
                {
                  ref: e,
        ...
        componentDidUpdate(e) {
          ...
          if (
            (this._drag &&
              this._drag.updateOptions({ boundByScreen: Boolean(this.props.boundByScreen), onDragStart: this.props.onDragStart }),
          ...
          .map((e) => {
            ...
            return (
              i.forEach((e) => {
                ...
                if ((0, o.isString)(t) && m.test(t)) return (u = 3), void (h = null === (r = t.match(m)) || void 0 === r ? void 0 : r.index)
                if ((0, o.isString)(s) && m.test(s)) return (u = 2), void (h = null === (a = s.match(m)) || void 0 === a ? void 0 : a.index)
                if ((0, o.isString)(s) && p.test(s)) return (u = 2), void (h = null === (l = s.match(p)) || void 0 === l ? void 0 : l.index)
                if (Array.isArray(d))
                  for (const e of d) if (m.test(e)) return (u = 1), void (h = null === (c = e.match(m)) || void 0 === c ? void 0 : c.index)
              }),
            ...
            ? a
                ...
                .map((e, t) =>
                  n.createElement(
                    n.Fragment,
                    { key: t },
                    c[t] ? n.createElement('span', { className: o(r.highlighted, l) }, e) : n.createElement('span', null, e)
                  )
                )
            : a
        )
    ...
    11684: (e, t, i) => {
      ...
      function l(e) {
        ...
        return o.createElement('div', {
          className: r()(a.separator, 'small' === t && a.small, 'normal' === t && a.normal, 'large' === t && a.large, i),
          role: 'separator',
          'aria-hidden': n
        })
      }
      ...
      class l extends n.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            this.props.shouldTrapFocus && !e.hasAttribute('data-focus-trap') && e.setAttribute('data-focus-trap', 'true'),
    ...
    78135: (e, t, i) => {
      ...
      function c(e, t) {
        return (i) => {
          ...
          w === n.AutoStrict &&
            (p < m.y + m.height + _ + u ? ((w = n.Top), (y = s.FromBottomToTop)) : ((w = n.Bottom), (y = s.FromTopToBottom)))
    ...
    75556: (e, t, i) => {
      ...
      function a(e, t, a) {
        ...
        if (h.size > 1) {
          const e = (0, s.createAction)('Mixed', o.t(null, void 0, i(54215)), void 0, void 0, null === t.selectedCurrency, () => c(null))
          g.actions.push(e)
        }
    ...
    59363: (e, t, i) => {
      ...
      function a(e, t, a) {
        ...
        if (h.size > 1) {
          const e = (0, s.createAction)('Mixed', o.t(null, void 0, i(54215)), void 0, void 0, null === t.selectedUnit, () => c(null))
          g.actions.push(e)
        }
