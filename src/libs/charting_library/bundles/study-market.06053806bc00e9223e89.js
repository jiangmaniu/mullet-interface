  ...
  [6456, 9790],
  {
        ...
        return c.createElement(
          'button',
          {
            ...
            'data-overflow-tooltip-text':
              null != n ? n : e.primaryText ? [e.primaryText, e.secondaryText].join(' ') : (0, b.getTextForTooltip)(e.children)
          },
          c.createElement(v, { ...i })
        )
      }
    ...
    64388: (e, t, n) => {
      ...
      const c = (0, i.forwardRef)((e, t) => {
        ...
        return i.createElement('button', { ...u, className: s({ ...e, children: d }), ref: t, type: r }, i.createElement(l, { icon: n }, d))
      })
    ...
    86332: (e, t, n) => {
      ...
      const i = n(50959).createContext({ isGrouped: !1, cellState: { isTop: !0, isRight: !0, isBottom: !0, isLeft: !0 } })
    },
    95604: (e, t, n) => {
      'use strict'
      function i(e) {
          ...
          Array.isArray(e) || (0, i.isValidElement)(e)
            ? i.Children.toArray(e)
                .reduce((e, t) => {
                  let n = ''
                  return (
                    (n = (0, i.isValidElement)(t) && r(t) ? a(t.props.children) : (0, i.isValidElement)(t) && !r(t) ? '' : o(t)),
                    e.concat(n)
                  )
                }, '')
                .trim()
    ...
    69654: (e, t, n) => {
      ...
      function u(e) {
        ...
        return i.createElement(
          ...
          m && (!r || '' !== b.value) && i.createElement('div', { className: o()(d.cancel, r && d.mobile), onClick: m }, v)
        )
      }
      function h(e) {
        const {
      ...
      function h(e) {
        ...
        return r.createElement(
          h,
          {
            ...
            ref: m,
            title: C ? n : '',
            className: a()(d.tab, C && d.isTablet, w && d.isMobile, o && d.active, b && d.withoutArrow, p, C && 'apply-common-tooltip'),
            onClick: u
          },
          ...
          !C &&
            r.createElement(
              'span',
              { className: a()(d.title, !i && d.withoutIcon, 'medium' === g ? d.medium : d.large, f && d.showLastDivider) },
    ...
    75585: (e, t, n) => {
      ...
      !(function (e) {
        ...
        (function (e) {
          ;(e.Indicators = 'indicators'), (e.Strategies = 'strategies'), (e.Patterns = 'patterns'), (e.Profiles = 'profiles')
        })(d || (d = {})),
        (function (e) {
      ...
      function y(e) {
        ...
        const {
          ...
          m =
            ...
            (null === (t = window.ChartApiInstance) || void 0 === t ? void 0 : t.studiesAccessController.isToolGrayed(o))
        return {
          id: i,
      ...
      function L(e) {
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            D && i.createElement(F.FavoriteButton, { className: x()(A.favorite, E && A.isActive), isFilled: E, onClick: M }),
            i.createElement(
              P,
            ...
            Boolean(N && !_) && i.createElement(BadgeStatus, { type: 'ep', className: A.badge, tooltip: r.t(null, void 0, n(10640)) }),
            !1
          ),
          R && i.createElement('a', { href: R.authorLink, className: A.author, target: '_blank', onClick: k }, R.authorName),
          ...
          i.createElement(E.AdaptivePopupDialog, {
            ...
            render: () =>
              i.createElement(
                i.Fragment,
                null,
                i.createElement(R.DialogSearch, { reference: w, placeholder: r.t(null, void 0, n(8573)), onChange: P, onFocus: B }),
                i.createElement(
      ...
      class pe extends class {
        ...
        _applyStudy(e, t) {
          ...
          e.isGrayed
            ...
            : (S.CheckMobile.any() || null === (n = this._searchInputRef.current) || void 0 === n || n.select(),
              ...
              })(this._chartWidgetCollection, e, this._parentSources, 0, this._symbol, () => this._showHint(e.title)).then((t) => {
                var n, i, r
        ...
        async _init() {
          ...
          ;(this._indicatorData = await (async function (e, t) {
            let n = { ...t }
            return [...he(n, 'tv-basicstudies'), ...he(n, 'Script$STD'), ...he(n, 'tv-volumebyprice')].filter((e) => !e.isStrategy).sort(v)
          ...
          .map((e) => {
            ...
            return (
              n.forEach((e) => {
                ...
                if (Array.isArray(d))
                  for (const e of d) if (p.test(e)) return (h = 1), void (u = null === (c = e.match(p)) || void 0 === c ? void 0 : c.index)
              }),
            ...
            ? s
                ...
                .map((e, t) =>
                  i.createElement(
                    i.Fragment,
                    { key: t },
                    c[t] ? i.createElement('span', { className: r(a.highlighted, l) }, e) : i.createElement('span', null, e)
                  )
                )
            : s
        )
    ...
    23390: (e, t, n) => {
      ...
      function h() {
        ...
        if ((l.push(...i), 0 === l.length && n && 'undefined' != typeof window)) {
          const n = JSON.parse(
            null !== (t = null === (e = window.urlParams) || void 0 === e ? void 0 : e.favorites) && void 0 !== t ? t : '{}'
          ).indicators
