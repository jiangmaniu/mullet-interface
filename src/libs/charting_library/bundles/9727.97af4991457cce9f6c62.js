  ...
  [9727],
  {
    66783: (e) => {
      ...
      e.exports = function (e, r) {
        ...
        for (let l = 0; l < o.length; l++) if (!t.call(r, o[l]) || !n(e[o[l]], r[o[l]])) return !1
        return !0
      }
    },
    58222: (e) => {
    ...
    48199: (e, t, n) => {
      ...
      const v = r.forwardRef((e, t) => {
        ...
        return r.createElement(o.NavButton, { ...a, 'aria-label': n, ref: t, icon: g(e.size, e.iconStrokeWidth), flipIconOnRtl: !0 })
      })
    },
    27011: (e, t, n) => {
      'use strict'
          ...
          !(0, s.isIconOnly)(p, i) &&
            r.createElement(
              ...
              d || c
                ...
                : r.createElement(r.Fragment, null, p, r.createElement('span', { className: m()['visually-hidden'], 'aria-hidden': !0 }, p))
            ),
          (n || l) &&
            ((e) => r.createElement(a.Icon, { className: o(m().icon, e.showCaret && m().caret), icon: e.showCaret ? u : e.endIcon }))(e)
        )
      }
      function g(e) {
    ...
    64388: (e, t, n) => {
      ...
      const c = (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement('button', { ...d, className: s({ ...e, children: u }), ref: t, type: o }, r.createElement(i, { icon: n }, u))
      })
    ...
    35057: (e, t, n) => {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            a &&
              ...
              r.createElement(
                'button',
                { className: S.close, onClick: s, onKeyDown: i, 'data-name': 'close', 'aria-label': h, type: 'button', ref: g },
      ...
      class N extends r.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._renderChildren = (e, t) => (
              (this._controller = e),
              this.props.render({ requestResize: this._requestResize, centerAndFit: this._centerAndFit, isSmallWidth: t })
            )),
            ...
            (this._handleKeyDown = (e) => {
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, s.hashFromEvent)(e))) {
                  ...
                  if (null !== n) {
                    if (
                      (e.preventDefault(), 'true' === (t = n).getAttribute('data-haspopup') && 'true' !== t.getAttribute('data-expanded'))
                    )
                      return void this._handleClose()
                    if ((0, c.isTextEditingField)(n)) return void r.focus()
                    if (r.contains(n)) return this.props.onKeyboardClose && this.props.onKeyboardClose(), void this._handleClose()
                  }
                }
                let t, n
                ;(function (e) {
        ...
        componentDidMount() {
          let e, t
          this.props.ignoreClosePopupsAndDialog || v.subscribe(g.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          let e, t
          this.props.ignoreClosePopupsAndDialog || v.unsubscribe(g.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
    ...
    69654: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r.createElement(
          ...
          r.createElement('div', { className: a()(c.inputContainer, p, u && c.withCancel) }, o || r.createElement(d, { ...g })),
          t,
    ...
    40987: (e, t, n) => {
        ...
        return (
          (0, k.useIsomorphicLayoutEffect)(() => {
            const e = void 0 === o ? [] : void 0 === l ? [o] : [o, l],
              t = (p.current = ((n = e), Promise.all(n.map((e) => (0, w.getImage)(`symbol_logo_${e}`, e, I).then((e) => e.cloneNode())))))
            let n
            t.then((e) => {
              let n, r, o, a, l, s, h, g, v
              if (t === p.current)
                switch (e.length) {
                  case 0:
      ...
      let R = n(54257)
      function _(e) {
        const { logoId: t, baseCurrencyLogoId: n, currencyLogoId: o, placeholder: l, className: s, size: i = 'xsmall' } = e,
          c = (0, r.useMemo)(() => {
        ...
        return r.createElement(L, { key: i, className: a()(R.logo, s), url1: c[0], url2: c[1], placeholderLetter: l, size: i })
      }
      function T(e) {
      ...
      function z(e) {
        ...
        const {
          ...
          { isSmallWidth: le, isMobile: se } = (0, l.ensureNotNull)((0, r.useContext)(d.SymbolSearchItemsDialogContext)),
          ie = Boolean(F),
          ce = !I && !T && (se || !ie),
              ...
              r.createElement(
                ...
                B &&
                  r.createElement(
                    ...
                    r.createElement(s.Icon, { className: a()(A.expandHandle, z && A.expanded, C && A.selected), icon: O })
                  ),
                he &&
                  !N &&
                  r.createElement(
                    ...
                    r.createElement(_, { key: Y, logoId: X, currencyLogoId: J, baseCurrencyLogoId: ee, placeholder: te ? te[0] : void 0 })
                  )
              )
            ),
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  'economic' === V && ge && ve
                    ? r.createElement(
                        'div',
                        { className: a()(A.exchangeName, L && A.active, 'apply-common-tooltip', A.narrow, oe && A.wide), title: ge },
                        ve
                      )
                    : r.createElement('div', { className: a()(A.exchangeName, L && A.active, re && 'apply-common-tooltip'), title: re }, x)
                )
              ),
              pe &&
                r.createElement(
        ...
        function fe() {
          if (I) return null
          const e = a()(A.symbolDescription, L && A.active, !g.mobiletouch && 'apply-overflow-tooltip apply-overflow-tooltip--allow-text')
          return b
            ? r.createElement(
                'div',
                { className: e },
    ...
    32456: (e, t, n) => {
      ...
      function y(e) {
        ...
        return r.createElement('div', { className: a()(f.container, n) }, r.createElement('div', { className: f.childrenWrapper }, t))
      }
      let b = n(50151),
        S = n(78036),
        x = n(24637),
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(x.HighlightedText, { className: a()(g && E.highlighted), queryString: o, text: L, rules: v })
              ),
              y &&
                r.createElement(
                  'div',
                  ...
                  return 0 === n.length
                    ...
                    : r.createElement(
                        ...
                        r.createElement(
                          ...
                          n.map((e) => r.createElement(L, { key: e.value(), searchSource: e, queryString: m, onClick: E.bind(null, e) }))
                        )
                      )
                })
              )
      ...
      function X(e) {
        ...
        const { state: n, update: o } = e,
          { searchRef: a, forceUpdate: l, upperCaseEnabled: i } = (0, b.ensureNotNull)((0, r.useContext)(h.SymbolSearchItemsDialogContext)),
        ...
        return k.isSeparateSymbolSearchTabs
          ...
          : r.createElement(
              ...
              r.createElement(
                'div',
                { className: ge.item },
                r.createElement('div', { className: ge.text }, o ? l.t(null, void 0, n(48490)) : l.t(null, void 0, n(89053)))
              ),
              r.createElement(
                'div',
                { className: ge.item },
        ...
        return r.createElement(
          ...
          'symbolSearch' === v &&
            r.createElement(
              ...
              !k.isSeparateSymbolSearchTabs && f && b.length > 0 && s && r.createElement('div', { className: xe.brokerButtonWrap }, N),
      ...
      function Ne(e) {
        ...
        return r.createElement(
          ...
          !(B && 'symbolSearch' === t) &&
            r.createElement(
              ve,
              { reference: x, className: a()(xe.search, D && xe.upperCase), placeholder: N || l.t(null, void 0, n(52298)) },
        ...
        async function Ce(e, t, n, r) {
          ...
          try {
            ...
            const m = u.enabled('show_spread_operators')
              ...
              [h, g] = await Promise.all([Le(G.current.signal, e, t, n, m, p, r), i && !r ? getRecent() : Promise.resolve([])]),
              v = g.filter((e) => {
                let t, n
                return m
      ...
      function We(e) {
        ...
        const {
          ...
          he = (0, r.useCallback)(
            (e) => {
              trackEvent('New SS', J, 'Change sources'), null == X || X(J, e), pe((t) => ({ ...t, currentSelectedSearchSource: e }))
            },
            [J, pe]
          ),
          ...
          { broker: xe = null, brokerId: we, unhideSymbolSearchGroups: ke = '', displayBrokerSymbol: Ce = !1 } = { brokerId: void 0 }
        ;(0, r.useLayoutEffect)(() => {
          let e
          !(null == ge ? void 0 : ge.current) ||
            (!Z && Boolean(null === (e = ge.current) || void 0 === e ? void 0 : e.value)) ||
            (Z || 'compare' === q || (ge.current.value = H.current), !_ || (Z && 'symbolSearch' !== q) || ge.current.focus())
        }, [q]),
          (0, r.useEffect)(() => {
        ...
        ;(0, r.useEffect)(() => {
          ...
          J &&
            ('country' === o.id
              ? (r.country = null !== (e = null == ue ? void 0 : ue.getRequestCountryValue()) && void 0 !== e ? e : null)
              : (r.exchange = null !== (t = null == ue ? void 0 : ue.getRequestExchangeValue()) && void 0 !== t ? t : null)),
            U(r)
        }, [J, He, Ge, ue, se])
        const $e = null != E ? E : je,
          Ye = $e !== je && !Z,
          ...
          tt = et
            ...
            : { title: b, dataName: 'symbol-search-items-dialog', render: () => r.createElement(Ne, null), additionalElementPos: 'after' },
          nt = null != C ? C : 'div'
        return r.createElement(
          nt,
          null,
        ...
        function it(e) {
          switch ((0, W.hashFromEvent)(e)) {
            ...
            case 37: {
              ...
              if ((!r && n && be.has(n) && Boolean(o) && !Boolean(D) && (e.preventDefault(), ot(n)), o)) return void (null == D || D(e, !0))
              break
            }
            case 39: {
              if (-1 === ae) return
                    ...
                    e.map((e) =>
                      -1 !== e.indexOf(':') || t
                        ...
                        : ((t = !0),
                          (async function (e) {
                            let t
                            null === (t = await (null == xe ? void 0 : xe.accountMetainfo())) || void 0 === t || t.prefix
                            const n = void 0,
                              r = await Q({
                                strictMatch: !0,
                                serverHighlight: !1,
                            ...
                            if (0 !== r.symbols.length) {
                              ...
                              if (o && a) return { symbol: _e.QualifiedSources.fromSymbolSearchResult(e, n), resolved: !0, result: e }
                            }
    ...
    15983: (e, t, n) => {
      ...
      function l(e) {
          ...
          if ('whitespace' !== a.type) {
            ...
            switch (a.type) {
              ...
              case 'closeBrace':
                ...
                o.pop() || t.errors.push({ status: 'error', reason: 'unbalanced_brace', offset: a.offset, token: a }), (n = 'var')
                break
              case 'unparsed':
        ...
        for (t.braceBalance = o.length, 'var' !== n && t.warnings.push({ status: 'incomplete', token: e[e.length - 1] }); o.length; ) {
          const e = o.pop()
      ...
      class a {
        ...
        includes(e) {
          return (function (e, t) {
            ...
            return (
              r.toLowerCase().includes(n) || o.toLowerCase().includes(n) || (void 0 !== a && a.some((e) => e.toLowerCase().includes(n)))
            )
          })(this._exchange, e)
        }
          ...
          .map((e) => {
            ...
            return (
              n.forEach((e) => {
                ...
                if (Array.isArray(u))
                  for (const e of u) if (h.test(e)) return (m = 1), void (d = null === (c = e.match(h)) || void 0 === c ? void 0 : c.index)
              }),
            ...
            ? s
                ...
                .map((e, t) =>
                  r.createElement(
                    r.Fragment,
                    { key: t },
                    c[t] ? r.createElement('span', { className: o(l.highlighted, i) }, e) : r.createElement('span', null, e)
                  )
                )
            : s
        )
      ...
      const s = l,
        i = r.forwardRef((e, t) => {
          ...
          return 'button' === n
            ...
            : r.createElement(
                'div',
                { ...C, ref: t, 'data-role': 'button', className: E, onClick: d ? void 0 : h, title: f, 'data-name': w, 'data-tooltip': k },
                v && g && r.createElement('div', { className: o('js-button-text', y.text) }, g),
                L,
                !v && g && r.createElement('div', { className: o('js-button-text', y.text) }, g),
