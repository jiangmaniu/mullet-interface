      ...
      function d(t) {
        const {
          ...
          g = (0, i.useMemo)(function () {
            ...
            return { isInputsStudy: !0, symbolsResolved: () => t, resolvedSymbolInfoBySymbol: () => null, tempProperties: f }
          }, []),
          w = (0, i.useRef)(null),
          [D, E] = (0, i.useState)(M())
        return (
    ...
    73339: (t, e, n) => {
      ...
      async function u(t, e, o, u, a) {
        ...
        async function h(e, n, s, l, u) {
          const a = await t.requestSelectPoint({ pointType: n, pane: c, lineColor: void 0, selectPointMode: r.SelectPointMode.Study }, s)
          void 0 === c && (c = a.pane)
