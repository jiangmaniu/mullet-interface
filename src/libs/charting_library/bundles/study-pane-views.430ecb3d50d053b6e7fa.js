      ...
      class w {
        ...
        _prepareStyles() {
          ...
          const i = (0, r.ensureDefined)(this._provider.graphicsInfo().hhists),
            ...
            o =
              (null === (e = null === (t = this._provider.properties().child('inputs')) || void 0 === t ? void 0 : t.child('volume')) ||
              void 0 === e
                ? void 0
        ...
        _updateDataForRenderers(t, e, i) {
          ...
          const d =
              (null === (a = null === (s = this._provider.properties().child('inputs')) || void 0 === s ? void 0 : s.child('volume')) ||
              void 0 === a
                ? void 0
          ...
          t.forEach((t) => {
            ...
            f.sort((t, e) => t.y - e.y),
            this._rendererData.histograms.push({ xRange: h, yRange: u(f[0].y, f[f.length - 1].y + f[f.length - 1].height), bars: f })
        }
      }
      function R(t, e) {
        let i
        ...
        return [(0, y.generateColor)(t, 100 - i, !0), (0, y.generateColor)(t, 100 - i / 2, !0), (0, y.generateColor)(t, 100 - i / 4, !0)]
      }
    },
    95258: (t, e, i) => {
