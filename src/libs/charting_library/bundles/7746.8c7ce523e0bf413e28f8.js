  ...
  [7746],
  {
      ...
      function V(e, t) {
        return (
          ...
          (0, i.pattern)(e)
            ...
            : (0, i.channel)(e)
            ? ((0, i.notUndef)(t) && console.warn('take(channel) takes one argument but two were provided. Second argument is ignored.'),
              X(L, { channel: e }))
            : void 0
        )
      }
                ...
                subscribe(e) {
                  ...
                  return (
                    ...
                    function () {
                      n &&
                        null !== t &&
                        ((n = !1), o.next ? (o.next.prev = o.prev) : (r = o.prev), o.prev ? (o.prev.next = o.next) : (t = o.next))
                    }
                  )
                }
              }
      ...
      const W = function (e) {
          ...
          function f(e) {
            var r = e.getState,
              n = e.dispatch
            return (
              (t = G.bind(null, (0, o.default)({}, d, { context: s, channel: u, dispatch: n, getState: r, sagaMonitor: l }))),
              function (e) {
                return function (t) {
        ...
        const c = y(i ? e : t),
          ...
          { dragPreviewWidth: m, dragPreviewHeight: S } = (function (e, t, r, n) {
            let o = e ? t.width : r,
              i = e ? t.height : n
            return (
              p() && e && ((i /= window.devicePixelRatio), (o /= window.devicePixelRatio)), { dragPreviewWidth: o, dragPreviewHeight: i }
            )
          })(i, t, l, d),
    ...
    94212: (e, t, r) => {
      ...
      function b(e) {
        return function (t = [], r = { publishSource: !0 }) {
          ...
          if (o) {
            ...
            !(function (e) {
              ;(0, l.invariant)('function' == typeof e, 'When clientOffset is provided, getSourceClientOffset must be a function.')
            })(i),
              (u = i(c))
          }
          e.dispatch(m(o, u))
          ...
          return {
            type: h,
            payload: { itemType: g, item: f, sourceId: c, clientOffset: o || null, sourceClientOffset: u || null, isSourcePublic: !!n }
          }
        }
      }
      function O(e, t, r) {
      ...
      class A {
        subscribeToStateChange(e, t = {}) {
          ...
          ;(0, l.invariant)('function' == typeof e, 'listener must be a function.'),
            (0, l.invariant)(void 0 === r || Array.isArray(r), 'handlerIds, when specified, must be an array of strings.')
          ...
          return this.store.subscribe(() => {
            ...
            try {
              const i =
                ...
                (o === n + 1 &&
                  !(function (e, t) {
                    return e !== x && (e === M || void 0 === t || ((r = e), t.filter((e) => r.indexOf(e) > -1)).length > 0)
                    var r
                  })(t.dirtyHandlerIds, r))
              i || e()
            } finally {
        ...
        canDragSource(e) {
          ...
          return (0, l.invariant)(t, `Expected to find a valid source. sourceId=${e}`), !this.isDragging() && t.canDrag(this, e)
        }
        canDropOnTarget(e) {
          if (!e) return !1
          const t = this.registry.getTarget(e)
          if (((0, l.invariant)(t, `Expected to find a valid target. targetId=${e}`), !this.isDragging() || this.didDrop())) return !1
        ...
        isDraggingSource(e) {
          ...
          if (((0, l.invariant)(t, `Expected to find a valid source. sourceId=${e}`), !this.isDragging() || !this.isSourcePublic()))
            return !1
      ...
      class V {
        ...
        unpinSource() {
          ;(0, l.invariant)(this.pinnedSource, 'No source is pinned at the time.'), (this.pinnedSourceId = null), (this.pinnedSource = null)
        }
        addHandler(e, t, r) {
          const n = Y(e)
          return this.types.set(n, t), e === G.SOURCE ? this.dragSources.set(n, r) : e === G.TARGET && this.dropTargets.set(n, r), n
        }
        constructor(e) {
          ;(this.types = new Map()),
      ...
      const oe = { itemType: null, item: null, sourceId: null, targetIds: [], dropResult: null, didDrop: !1, isSourcePublic: null }
      function ie(e = oe, t) {
        const { payload: r } = t
        switch (t.type) {
          case h:
        ...
        return {
          dirtyHandlerIds: Q(e.dirtyHandlerIds, {
            ...
            payload: ue({}, t.payload, {
              prevTargetIds:
                ((r = e), (n = 'dragOperation.targetIds'), (o = []), n.split('.').reduce((e, t) => (e && e[t] ? e[t] : o || null), r))
            })
          }),
