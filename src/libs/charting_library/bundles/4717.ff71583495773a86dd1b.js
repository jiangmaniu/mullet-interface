;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4717],
  {
    ...
    31261: (e, t, n) => {
      ...
      function v(e) {
        e = (0, u.useControl)(e)
        const { disabled: t, autoSelectOnFocus: n, tabIndex: o = 0, onFocus: s, onBlur: h, reference: p, containerReference: f = null } = e,
          m = (0, r.useRef)(null),
          g = (0, r.useRef)(null),
          [v, _] = (0, c.useFocus)(),
          w = t ? void 0 : v ? -1 : o,
    ...
    36383: (e, t, n) => {
      ...
      let r = n(50959),
        o = n(27267)
      function s(e) {
        const { click: t, mouseDown: n, touchEnd: s, touchStart: i, handler: a, reference: l, ownerDocument: u = document } = e,
          c = (0, r.useRef)(null),
          ...
          if (
            ...
            (this._handleChange = (e) => {
              ...
              if (t && '' === i) this.setState({ queryValue: i, isOpened: !1, active: void 0 }), s && s()
                ...
                this.setState({ queryValue: i, isOpened: t, active: n ? void 0 : this._getActiveKeyByValue(i) }), t && o && o()
              }
              n && r && r(i)
            }),
            (this._handleItemClick = (e) => {
              const t = e.currentTarget.id
              this.setState({ queryValue: m(this.props.source)[t] }), this.props.onChange && this.props.onChange(t), this._close()
            }),
              ...
              switch (e.which) {
                ...
                case r.Enter:
                  ...
                  t && (a && f ? this.setState(this._valueToQuery(f)) : (f = l)),
                    void 0 !== f && (this._close(), a || this._blur(), f !== n ? o && o(f) : this.setState(this._valueToQuery(f)))
              }
            }),
      ...
      ;(t.Children = {
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          let o = m({}, e.props),
            ...
            a = e._owner
          if (null != t) {
            if ((void 0 !== t.ref && ((i = t.ref), (a = x.current)), void 0 !== t.key && (s = '' + t.key), e.type && e.type.defaultProps))
