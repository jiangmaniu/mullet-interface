;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7260],
  {
    ...
    85616: (e) => {
      e.exports = { button: 'button-x1dCOTP3', disabled: 'disabled-x1dCOTP3', hover: 'hover-x1dCOTP3', accessible: 'accessible-x1dCOTP3' }
    },
    91348: (e) => {
    ...
    33279: (e, t, s) => {
      ...
      const S = (e) => n.t(null, { plural: '{str} minutes', count: e, replace: { str: `${e}` } }, s(60144)),
        ...
        C = {
          ...
          '1D': { resolution: '1D', text: ((T = 1), n.t(null, { plural: '{str} days', count: T, replace: { str: `${T}` } }, s(74262))) },
          '1W': { resolution: '1W', text: ((M = 1), n.t(null, { plural: '{str} weeks', count: M, replace: { str: `${M}` } }, s(14074))) },
          '1M': { resolution: '1M', text: x(1) },
          '3M': { resolution: '3M', text: x(3) },
          '6M': { resolution: '6M', text: x(6) },
          '12M': { resolution: '12M', text: ((E = 1), n.t(null, { plural: '{str} years', count: E, replace: { str: `${E}` } }, s(8222))) }
        }
      let E, M, T
      function z(e) {
        const t = (function (e) {
            ...
            if (r.isMinutes()) {
              ...
              return e % 60 != 0
                ? ((i = e),
                  n.t(null, { plural: '{str} minutes', count: i, replace: { str: `${i}` }, context: 'timeframe_title' }, s(44795)))
                : ((a = e / 60),
                  n.t(null, { plural: '{str} hours', count: a, replace: { str: `${a}` }, context: 'timeframe_title' }, s(89020)))
            }
            let a
            let i
            ...
            if (r.isWeeks())
              return ((e) =>
                n.t(null, { plural: '{str} weeks', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, s(67518)))(
                r.multiplier()
              )
            if (r.isMonths()) {
              const e = r.multiplier()
              return e % 12 != 0
                ...
                : ((e) => n.t(null, { plural: '{str} years', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, s(6598)))(
                    e / 12
                  )
            }
            let o
            ...
            if (r.isMinutes()) {
              ...
              return e % 60 != 0
                ? ((i = e),
                  n.t(
                    null,
                    { plural: '{str} minutes intervals', count: i, replace: { str: `${i}` }, context: 'timeframe_title' },
                    s(56347)
                  ))
                : ((a = e / 60),
                  n.t(null, { plural: '{str} hours intervals', count: a, replace: { str: `${a}` }, context: 'timeframe_title' }, s(54028)))
            }
            let a
            let i
            if (r.isDays())
              return ((e) =>
                n.t(null, { plural: '{str} days intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, s(81693)))(
                r.multiplier()
              )
            if (r.isWeeks())
              return ((e) =>
                n.t(null, { plural: '{str} weeks intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, s(58667)))(
                r.multiplier()
              )
            if (r.isMonths()) {
              const e = r.multiplier()
              return e % 12 != 0
                ? ((o = e),
                  n.t(null, { plural: '{str} months intervals', count: o, replace: { str: `${o}` }, context: 'timeframe_title' }, s(99773)))
                : ((e) =>
                    n.t(
                      null,
      ...
      function K(e) {
        ...
        return r.createElement(Z.ToolbarButton, { ...d, ref: t, text: s, isActive: n, tooltip: a, className: h, onClick: l })
      }
      let Q = s(22586)
      ...
      class xe extends r.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._timeFormatter = new pe.TimeFormatter((0, _e.getHourMinuteSecondFormat)(be.timeHoursFormatProperty.value()))),
      ...
      const st = (0, ae.hotKeySerialize)({ keys: [(0, ne.humanReadableModifiers)(ne.Modifiers.Alt, !1), 'Enter'], text: '{0} + {1}' }),
        rt = (function (e) {
          let t
          return (
            ((t = class extends r.PureComponent {
              ...
              null === this._raf &&
                (this._raf = requestAnimationFrame(() => {
                  ...
                  if ((Object.assign(e, { dateRangeMode: c }), 'expanded' !== c)) {
                    ...
                    for (const n of r)
                      (s += n.width),
                        n.name in at ? ((a += n.width), Object.assign(e, { [n.name]: !1 })) : Object.assign(e, { [n.name]: t <= s })
          ...
          return r.createElement(
            ...
            t &&
              r.createElement(
                ...
                r.createElement(
                  'div',
                  { className: o(qe.dateRangeWrapper, 'expanded' !== e.dateRangeMode && qe.collapsed), ref: this._handleRangeExpandedRef },
                  r.createElement(
                    'div',
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                l &&
                  ...
                  r.createElement(rt, { className: qe.item, mobileChangeLayoutEnabled: this.props.mobileChangeLayoutEnabled }),
                !1
              )
            )
          )
          ...
          Object.keys(t).forEach((e) => {
            ...
            if ('separator' !== a) {
              const e = this._seriesComponents[a],
                n = !0 === t[a]
              e && ('timeZones' === a || 'session' === a ? (s = s || !n) : (r = r || !n), e.classList.toggle(qe.collapsed, n))
            }
          })
      ...
      class mt extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(b.RegistryProvider, { validation: ut, value: this._registry }, r.createElement(ht, { key: e.id(), ...s }))
        }
        _defineRegistry(e) {
          const {
