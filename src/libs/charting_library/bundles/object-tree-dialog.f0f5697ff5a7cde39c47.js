;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4862],
  {
    ...
    31261: (e, t, n) => {
      ...
      function b(e) {
        e = (0, c.useControl)(e)
        const { disabled: t, autoSelectOnFocus: n, tabIndex: r = 0, onFocus: i, onBlur: h, reference: g, containerReference: m = null } = e,
          p = (0, o.useRef)(null),
          f = (0, o.useRef)(null),
          [b, y] = (0, u.useFocus)(),
          _ = t ? void 0 : b ? -1 : r,
    ...
    23263: (e, t, n) => {
      ...
      let f = n(90186),
        ...
        y = n.n(b)
      function _(e) {
        const { className: t, color: n, variant: o, size: r, stretch: i, animated: s, disableThemes: l, isInvertedColorTheme: a, ...c } = e
      ...
      const I = o.forwardRef((e, t) => {
        ...
        return o.createElement(
          ...
          n.map((e) => {
            ...
            return o.createElement(S, { ...n, className: C(s, { ...n, variant: i, isChecked: t }), size: r, variant: i })
          })
        )
      })
      ...
      const x = new l.TranslatedString('remove all line tools for {symbol}', s.t(null, void 0, n(23481))),
        z = (e) => s.t(null, { plural: '{drawingsCount} drawings', count: e }, n(88143)).format({ drawingsCount: e.toString() }),
      ...
      function R(e) {
        ...
        return (
          ...
          o.useMemo(
            () => ({ currentSymbol: i, symbolDrawingsMaps: l, removeSymbolDrawings: g, changeSymbol: m, hiddenSymbols: c }),
            [i, l, g, m, c]
          )
        )
      ...
      function O(e) {
        const { isMobile: t, chartWidget: r, onClose: l, onInitialized: a } = e,
          { currentSymbol: c, symbolDrawingsMaps: u, removeSymbolDrawings: h, changeSymbol: m, hiddenSymbols: p } = R(r),
          [f, v] = o.useState(0),
          [b, y, _] = o.useMemo(() => {
            let e
            if (null !== c && null !== u) {
              ...
              let n = 0,
                o = f
              if (null === o) for (o = 2; o > 0 && !(((null === (e = u[o].get(c)) || void 0 === e ? void 0 : e.size) || 0) > 0); ) o--
              return (
                u[o].forEach((e, o) => {
                  p.includes(o) ||
                    (t.push({
            ...
            b.length > 0 &&
              o.createElement(
                ...
                `${
                  ((S = u ? u[_].size : 0),
                  s
                    .t(null, { plural: '{symbolsCount} symbols', context: 'symbols_and_drawings_count', count: S }, n(52908))
                    .format({ symbolsCount: S.toString() }))
                } ${((e) =>
                  s
                    .t(null, { plural: 'with {drawingsCount} drawings', context: 'symbols_and_drawings_count', count: e }, n(42743))
    ...
    67165: (e, t, n) => {
      ...
      const Y = Z('SET_NODES'),
        ...
        ye = () => ({ type: oe }),
        _e = () => ({ type: re }),
        Se = (e, t, n, o, r) => ({ type: ie, dropTarget: e, dropType: t, isHoveredLeft: n, boundBox: o, isLastChild: r }),
        we = () => ({ type: ee }),
        Ce = (e) => ({ type: X, ids: e }),
      ...
      const je = (e) => e.nodes,
        ...
        qe = (0, ze.createSelector)([je, $e], (e, t) => t.reduce((t, n) => [...t, ...Je(e, (0, T.ensureDefined)(n))], []))
      function Je(e, t) {
        const n = []
      ...
      const Qe = (0, ze.createSelector)([je, $e, Oe], (e, t, n) => {
        ...
        Xe = (0, ze.createSelector)([je, Ue, Oe], (e, t, n) => {
          const o = new Set(n)
          return [{ id: 'drag-list', level: -1, children: t }].reduce((t, n) => [...t, ...et(e, (0, T.ensureDefined)(n), o)], [])
        })
      function et(e, t, n) {
        const o = []
      ...
      function* ot() {
        for (;;) {
          ...
          const a = ut(t, e === re ? 'next' : 'previous', n, l),
            { id: c } = a
          i.includes(c) && r ? (yield (0, S.put)(De(r, !1, 1)), yield (0, S.put)(Me(c))) : yield (0, S.put)(De(c, !0, 1)),
            yield (0, S.put)(ke(c))
        }
      }
      function* rt(e, t) {
      ...
      function* it(e, t = () => !0) {
        for (;;) {
          ...
          const l = new Set(i)
          ;(i = s.reduce((e, t) => (l.has(t.id) && e.push(t.id), e), [])), e ? e(i) : yield (0, S.put)(Ce(i)), yield (0, S.put)(Me(o))
        }
      }
      function* st(e = () => !0, t) {
        ...
        u.map((e) => e.id).includes(d.id)
          ...
          : h && e(u, d, o) && (yield (0, S.put)(((e, t, n) => ({ type: se, node: e, dropType: t, boundBox: n }))(d, o, i)))
      }
      function* lt(e) {
      ...
      const At = (0, H.connect)(zt, jt, null, { context: xt })(function (e) {
          ...
          return o.createElement(Nt, { ...e, connectDragSource: n, connectDropTarget: i, connectDragPreview: r, ref: t })
        }),
            ...
            ? o.createElement(
                ...
                o.createElement(
                  ...
                  t.map((e) => {
                    ...
                    return o.createElement(Rt, { id: e.id, key: e.id, nodeRenderer: r, isDragPreview: !0, isOffset: e.level > 1 })
                  })
                )
              )
            : null
      ...
      const nn = o.forwardRef((e, t) => {
        ...
        return o.createElement('div', { ...e, ref: t }, e.children, n.isOver && o.createElement(tn, { transform: n.transform }))
      })
      let on = n(38223),
        rn = n(76106)
      ...
      const an = o.forwardRef(function (e, t) {
          ...
          B = (0, o.useMemo)(() => {
            ...
            for (let i = 0; i < r.length; i++) {
              ...
              1 === s.level &&
                (void 0 !== n &&
                  n !== s.parentId &&
                  t.push({ type: 'separator', node: o.createElement('div', { key: n + '_separator', className: rn.separator }) }),
                (n = s.parentId)),
                t.push({
                  type: 'node',
        ...
        const P = (0, o.useCallback)((e) => {
          ...
          V = (0, o.useMemo)(() => (null === f ? { index: -1 } : { index: F.current.findIndex((e) => e.node.key === f.id) }), [f])
        d(A)
      ...
      const cn = (0, H.connect)(
          function (e) {
            return { renderList: Qe(e), orderedNodes: qe(e), isMultiSelecting: Ke(e), selectedIds: Ue(e), scrollToId: Be(e) }
          },
          function (e) {
            return (0, ht.bindActionCreators)(
              {
      ...
      function dn(e) {
        ...
        return (
          ...
          (0, o.useEffect)(
            () => (null !== f && a && (g && (g.current = performance.now()), f.dispatch(((e) => ({ type: $, nodes: e }))(a))), () => {}),
            [f, a]
          ),
          (0, o.useEffect)(() => {
      ...
      function $n(e) {
        ...
        ;(0, o.useEffect)(() => {
          const e = {}
          u.onLockChanged().subscribe(e, () => D(u.isLocked())), u.onVisibilityChanged().subscribe(e, () => x(u.isVisible()))
          ...
          o.createElement(
              ...
              onClick:
                1 === p
                  ...
                  : function (e) {
                      ...
                      if (W.current) e.preventDefault(), clearTimeout(W.current), (W.current = null), g.openProperties(u), P(!1)
                      else {
            ...
            !U &&
              o.createElement(
                ...
                q,
                !1,
                o.createElement('span', { className: E(Kn.title, g.isMain(u) && Kn.main, (!u.isVisible() || !z) && Kn.disabled), ...H }, V),
                o.createElement(
                  'span',
        ...
        function J(e) {
          e.defaultPrevented || f || !u.fullyConstructed() || (e.preventDefault(), e.persist(), g.openContextMenu(u, () => b(!0), e))
        }
        function Q() {
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleMediaChange = () => {
              this.state.showDrawer && !window.matchMedia(y.DialogBreakpoints.TabletSmall).matches && this.setState({ showDrawer: !1 })
            }),
            ...
            o.createElement(
              ...
              this.state.showDrawer &&
                o.createElement(
                  ...
                  o.createElement(_.ManageDrawings, { onClose: this._closeDrawer, chartWidget: this.props.activeChartWidget, isMobile: !0 })
                )
            )
          )
        }
      ...
      class io {
        ...
        set(e) {
          ...
          this._selectionApi.set(t.map((e) => ro(e).persistentId)), (this._selected = n), this._onChange.fire(this._selected)
        }
        ...
        buildTree() {
          ...
          for (const t of this._controller.model().panes()) {
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (r.pane() === t) {
                const o = [...n.lineTools()].sort((e, t) => (e.zorder() > t.zorder() ? -1 : 1)).map((e) => oo(e.id(), e.instanceId()))
      ...
      class Lo {
        constructor(e, t) {
          ;(this._syncStateChanged = new to.Delegate()),
            ...
            (0, co.isLineTool)(this._dataSource) &&
              (this._dataSource.linkKey().subscribe(this._updateSyncState), this._dataSource.sharingMode().subscribe(this._updateSyncState))
        ...
        title() {
          ...
          return (0, co.isLineTool)(e)
            ...
            ? e.symbolTitle(yo.TitleDisplayTarget.DataWindow, void 0, void 0, (0, _t.onWidget)() ? 'exchange' : 'listed_exchange')
        ...
        setName(e) {
          if ((0, co.isLineTool)(this._dataSource)) {
            const t = To.format({ sourceTitle: this._dataSource.properties().title.value() || Do(this._dataSource), newSourceTitle: e })
      ...
      class xo {
        ...
        _insertBeforeTarget() {
          return (0, T.ensureNotNull)(this._lineTools.reduce((e, t) => (null === e ? t : e.zorder() < t.zorder() ? e : t), null))
        }
        _insertAfterTarget() {
          return (0, T.ensureNotNull)(this._lineTools.reduce((e, t) => (null === e ? t : e.zorder() > t.zorder() ? e : t), null))
        }
      ...
      class zo {
        ...
        canBeGroupped(e) {
          ...
          const t = []
          if ((e.forEach((e) => e.addSourcesToArray(t)), t.some((e) => !(0, co.isLineTool)(e) || !e.boundToSymbol()))) return !1
          const n = this._undoModel.model(),
      ...
      class Jo {
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          return (
            r.push(
              ...
              new Ro.Separator(),
              new Ro.Action({ actionId: s.actionId, label: s.label, icon: s.icon, onExecute: () => this.openProperties(e) })
            ),
            r
          )
        }
        ...
        _normalizeTargetAndDropType(e, t) {
          ...
          return 'inside' === t && ((t = 'before'), (n = (0, T.ensureNotNull)(this.entity([...n.childrenIds()].shift() || '')))), [n, t]
        }
        _getSelectedEntities() {
          ...
          return t.length && Go.logWarn(`Detected dangling sources in selection. They will be ignored: ${JSON.stringify(t)}`), e
        }
        _getEntityById(e) {
          return this._facade.getObjectById(e)
        }
