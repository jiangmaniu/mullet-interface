  ...
  [4804],
  {
    ...
    64388: (e, t, n) => {
      ...
      const c = (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement('button', { ...d, className: a({ ...e, children: u }), ref: t, type: s }, r.createElement(l, { icon: n }, u))
      })
    ...
    31261: (e, t, n) => {
      ...
      function v(e) {
        e = (0, c.useControl)(e)
        const { disabled: t, autoSelectOnFocus: n, tabIndex: s = 0, onFocus: o, onBlur: p, reference: h, containerReference: m = null } = e,
          g = (0, r.useRef)(null),
          f = (0, r.useRef)(null),
          [v, w] = (0, u.useFocus)(),
          b = t ? void 0 : v ? -1 : s,
          ...
          Array.isArray(e) || (0, r.isValidElement)(e)
            ? r.Children.toArray(e)
                .reduce((e, t) => {
                  let n = ''
                  return (
                    (n = (0, r.isValidElement)(t) && s(t) ? i(t.props.children) : (0, r.isValidElement)(t) && !s(t) ? '' : o(t)),
                    e.concat(n)
                  )
                }, '')
                .trim()
          ...
          if (
            ...
            (this._handleChange = (e) => {
              ...
              if (t && '' === i) this.setState({ queryValue: i, isOpened: !1, active: void 0 }), o && o()
                ...
                this.setState({ queryValue: i, isOpened: t, active: n ? void 0 : this._getActiveKeyByValue(i) }), t && s && s()
              }
              n && r && r(i)
            }),
            (this._handleItemClick = (e) => {
              const t = e.currentTarget.id
              this.setState({ queryValue: g(this.props.source)[t] }), this.props.onChange && this.props.onChange(t), this._close()
            }),
              ...
              switch (e.which) {
                ...
                case r.Enter:
                  ...
                  t && (a && m ? this.setState(this._valueToQuery(m)) : (m = l)),
                    void 0 !== m && (this._close(), a || this._blur(), m !== n ? s && s(m) : this.setState(this._valueToQuery(m)))
              }
            }),
