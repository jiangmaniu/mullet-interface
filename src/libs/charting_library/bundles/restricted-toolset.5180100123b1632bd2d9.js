  ...
  [5516, 9685],
  {
    ...
    96040: (e, t, a) => {
      ...
      let n = a(44352),
        ...
        r = a(27306)
      function h(e) {
        const { className: t, isActive: h, onClick: c, onMouseDown: d, title: u, hidden: v, 'data-name': m = 'remove-button', ...p } = e
        return i.createElement(o.Icon, {
          ...p,
          'data-name': m,
    ...
    69297: (e, t, a) => {
      ...
      function h(e) {
        const t = (0, n.useContext)(o.CustomBehaviourContext),
          { className: a, intent: s = 'default', size: l = 'small', enableActiveStateStyles: h = t.enableActiveStateStyles } = e
        return i(a, r().switcher, r()[`size-${l}`], r()[`intent-${s}`], !h && r()['disable-active-state-styles'])
      }
      function c(e) {
        let t
        const { reference: a, size: i, intent: s, role: o, 'aria-checked': l, checked: c, defaultChecked: d, onKeyDown: u, ...v } = e,
          m = (0, n.useCallback)(
            (e) => {
    ...
    54491: (e, t, a) => {
      ...
      function I(e) {
        const { orientation: t, onKeyDown: a, ...n } = e,
          s = x.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'radiogroup', 'aria-orientation': t } : {}
        return i.createElement('div', {
          ...
          onKeyDown: (0, k.createSafeMulticastEventHandler)(function (e) {
            ...
            Array.from(i.querySelectorAll('[role="radio"]:not([disabled], [aria-disabled])')).filter(
              (0, x.createScopedVisibleElementFilter)(i)
      ...
      class L extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (0, y.validateRegistry)(t, { chartWidgetCollection: s.any.isRequired, favoriteChartStylesService: s.any.isRequired })
        ...
        _renderPopupMenuItem(e, t, a) {
          ...
          return i.createElement(A.AccessibleMenuItem, {
            ...
            toolbox: n && i.createElement(R.MenuFavoriteButton, { isActive: t, isFilled: s, onClick: () => this._handleClickFavorite(e) }),
            'data-value': r.STYLE_SHORT_NAMES[e]
          })
        }
          ...
          super(e, t),
            ...
            (this._handleClick = (e) => {
              ...
              ;(0, V.trackEvent)('GUI', 'Chart Header Toolbar', 'compare'),
                null === (t = this._compareDialogRenderer) || void 0 === t || t.show({ shouldReturnFocus: (0, Z.isKeyboardClick)(e) })
            }),
      ...
      let j = a(48889),
        ...
        X = a(97268),
        $ = a(57047)
      const J = (0, G.hotKeySerialize)({ keys: [(0, Y.humanReadableModifiers)(Y.Modifiers.Shift, !1), 'F'], text: '{0} + {1}' }),
      ...
      function le(e, t) {
        ...
        return (
              ...
              t
                ...
                .then((e) => {
                  ...
                  for (const a of e)
                    !a.is_hidden_study &&
                      s.has(a.id) &&
                      t.set(a.id, { name: a.description, localizedName: a.description_localized, studyMarketShittyObject: a })
                  return t
                })
                .then((e) => {
          ...
          Promise.all(a).then((e) => (oe.logNormal('Requesting favorites info finished'), e.reduce((e, t) => e.concat(t), [])))
        )
      }
      let re = a(92249),
        he = a(88348),
                ...
                i.createElement(_.MatchMedia, { rule: 'screen and (max-width: 430px)' }, (e) =>
                  i.createElement(
                    ...
                    i.createElement(
                      ...
                      i.createElement(ve.ToolWidgetMenuSummary, { className: e && ge.smallWidthTitle }, o.t(null, void 0, a(83127))),
                      ...
                      !s &&
                        i.createElement(
                          ...
                          this.state.infos.length > 0
                            ...
                            : null !== this._promise &&
                                i.createElement(ie.PopupMenuItem, { isDisabled: !0, label: o.t(null, void 0, a(23687)) })
                        )
                    )
                  )
                )
      ...
      class xe extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { className: Me.form },
            i.createElement(Te, { className: Me.input, maxLength: 7, onChange: this._handleChangeInput, value: e }),
            i.createElement(
              d.ToolbarMenuButton,
              {
                orientation: 'none',
                ...
                className: Me.menu,
                ref: this._menu,
                content: i.createElement('div', { className: Me.menuLabel }, Ee.INTERVALS.find((e) => e.name === n).label)
              },
              Ee.INTERVALS.map((e) =>
                i.createElement(A.AccessibleMenuItem, {
                  dontClosePopup: !0,
            ...
            i.createElement(ke, { className: Me.add, onClick: this._handleClickAdd }, o.t(null, void 0, a(54777)))
          )
        }
      }
      let Ie = a(90186),
      ...
      let Oe = a(36274)
      const Le = {
        [Oe.ResolutionKind.Ticks]: o.t(null, { context: 'interval_group_name' }, a(30426)),
        [Oe.ResolutionKind.Seconds]: o.t(null, { context: 'interval_group_name' }, a(74973)),
        [Oe.ResolutionKind.Minutes]: o.t(null, { context: 'interval_group_name' }, a(57470)),
        [Oe.SpecialResolutionKind.Hours]: o.t(null, { context: 'interval_group_name' }, a(62346)),
        [Oe.ResolutionKind.Days]: o.t(null, { context: 'interval_group_name' }, a(74787)),
        [Oe.ResolutionKind.Weeks]: o.t(null, { context: 'interval_group_name' }, a(86614)),
        [Oe.ResolutionKind.Months]: o.t(null, { context: 'interval_group_name' }, a(94328)),
        [Oe.ResolutionKind.Range]: o.t(null, { context: 'interval_group_name' }, a(48801)),
      ...
      class Ye extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleChangeInterval = (e) => {
              const { activeInterval: t, lastNotQuicked: a } = this.state,
                n = this._getQuicks()
              this.setState({ activeInterval: (0, fe.normalizeIntervalString)(e), lastNotQuicked: void 0 === t || n.includes(t) ? a : t })
            }),
            ...
            (this._handleClickFavorite = (e) => {
              ;(e = (0, ne.ensureDefined)(e)), this._isIntervalFavorite(e) ? this._handleRemoveFavorite(e) : this._handleAddFavorite(e)
            }),
            ...
            (this._handleRemoveInterval = (e, t) => {
              ...
              if (e) {
                if (x.PLATFORM_ACCESSIBILITY_ENABLED && t && (0, Z.isKeyboardClick)(t) && this._menuItemsContainerRef.current) {
          ...
          const { chartApiInstance: a, favoriteIntervalsService: o, intervalService: r, intervalsMenuViewStateService: h } = t
          ...
          const c = l.linking.interval.value(),
            ...
            m = h.get()
          ;(this._defaultIntervals = a.defaultResolutions().filter(fe.isIntervalEnabled).map(fe.normalizeIntervalString)),
            (this.state = {
              isOpenedFormMenu: !1,
              activeInterval: d,
              favorites: u,
              ...
              i.createElement(
                ...
                r.map((e, t) => {
                  ...
                  return i.createElement(C, {
                    ...
                    text: i.createElement(ye, { value: n.mayOmitMultiplier ? void 0 : n.multiplier, metric: n.shortKind }),
                    hint: n.hint,
                    'aria-checked': a === e,
                    isActive: a === e,
                    isDisabled: !c[e] && e !== s,
                      ...
                      content:
                        h || null === m
                          ...
                          : i.createElement(
                              ...
                              i.createElement(ye, { value: m.mayOmitMultiplier ? void 0 : m.multiplier, metric: m.shortKind })
                            ),
                      hotKey: h ? Qe : void 0,
                      className: Ze.menu,
                      ref: this._menu,
        ...
        _renderResolutionsGroup(e, t = !1, a) {
          ...
          if (t) n.push(...s)
            ...
            const o = i.createElement(
              Ve,
              { key: e.id, className: Ze.section, summary: e.name, open: !a[e.id], onStateChange: this._getHandleSectionStateChange(e.id) },
              s
            )
            n.push(o)
          }
      ...
      function $e(e) {
        ...
        return i.createElement('div', { className: n }, i.createElement('div', { className: Ze.smallTabletSectionTitle }, a), t)
      }
      Ye.contextType = qe
      let Je = a(23902),
        et = a(82436)
      ...
      function vt(e) {
        ...
        return i.createElement(
          ...
          n ? i.createElement(ce.Loader, { className: ut.loader, size: 'small', staticPosition: !0 }) : o.t(null, void 0, a(85520))
        )
      }
      let mt = a(36296),
        pt = a(63672),
      ...
      const bt = n.enabled('widget'),
        ...
        yt = [],
        Et = (0, G.hotKeySerialize)({ keys: [(0, Y.humanReadableModifiers)(Y.Modifiers.Mod, !1), 'S'], text: '{0} + {1}' })
      ...
      class Tt extends i.PureComponent {
        ...
        componentDidMount() {
          const { chartSaver: e, isFake: t, stateSyncEmitter: n } = this.props,
            { chartWidgetCollection: i, chartChangesWatcher: s, saveChartService: l, sharingChartService: r } = this.context
          t
        ...
        componentWillUnmount() {
          ...
          const { chartSaver: t, isFake: a, stateSyncEmitter: n } = this.props,
            { chartWidgetCollection: i, chartChangesWatcher: s, saveChartService: o, sharingChartService: l } = this.context
          a
      ...
      let xt = a(53166),
        It = a(34928),
        At = a(79982)
      const Rt = new It.DateTimeFormatter({ dateTimeSeparator: '_', timeFormat: '%h-%m-%s' }),
          ...
          f =
            ((0, i.useCallback)(async () => {
              ...
              try {
                ...
                return await (0, Lt.writePromiseUsingApi)(a, 'text/plain'), me.emit('onServerScreenshotEmbedCodeCopiedToClipboard'), !0
              } catch (t) {
                return S(e), !0
              } finally {
        ...
        ((Jt = function (e) {
          return (0, Gt.isOnMobileAppPage)('any')
            ...
            : i.createElement(
                d.ToolbarMenuButton,
                {
                  content: i.createElement(P.ToolWidgetButton, { tag: 'div', id: e.id, className: e.className, icon: Xt }),
                  drawerPosition: 'Bottom',
            ...
            super(e, t),
              ...
              (this._serverSnapshot = async () => {
                const e = this.context.chartWidgetCollection.activeChartWidget.value().model().mainSeries().actualSymbol(),
                  ...
                  a = n.enabled('charting_library_base') && void 0 !== this.context.snapshotUrl ? t : (0, xt.convertImageNameToUrl)(t)
      ...
      let pa = a(48261)
      const ga = (0, rt.mergeThemes)(ie.DEFAULT_POPUP_MENU_ITEM_THEME, { labelRow: pa.labelRow, toolbox: pa.toolbox, item: pa.titleItem }),
      ...
      function _a(e) {
        const { className: t, item: a, onApply: n, onRemove: s, onFavor: o, favorite: l, isFavoritingAllowed: r, isTabletSmall: h } = e,
          [c, d] = (0, Ae.useHover)(),
          u = a.meta_info,
        ...
        return i.createElement(
          'div',
          { ...d, className: v()(t, pa.wrap), 'data-name': a.name, 'data-id': a.id, 'data-is-default': Boolean(a.is_default) },
          i.createElement(A.AccessibleMenuItem, {
            theme: p,
            label: a.name,
            ...
            toolbox: i.createElement(
              ...
              null,
              !a.is_default &&
                i.createElement(Ne.MenuRemoveButton, { key: 'remove', hidden: !Re.touch && !c, onClick: C, className: pa.remove }),
              Boolean(o) && r && i.createElement(R.MenuFavoriteButton, { key: 'favorite', isFilled: Boolean(l), onClick: S })
            )
          }),
          m &&
            i.createElement(ie.PopupMenuItem, {
      ...
      function Ia(e) {
        ...
        return i.createElement(
          ...
          h && i.createElement(i.Fragment, null, i.createElement(S.PopupMenuSeparator, null), i.createElement(ue, null)),
          !h &&
            (r
        ...
        return i.createElement(
          ...
          n.length > 0 &&
            i.createElement(
              ...
              i.createElement(ve.ToolWidgetMenuSummary, { className: xa.menuItemHeaderTabletSmall }, o.t(null, void 0, a(38554))),
              n.map(s)
            ),
          t.length > 0 &&
            i.createElement(
        ...
        return i.createElement(
          ...
          n.length > 0 &&
            i.createElement(
              ...
              null,
              i.createElement(S.PopupMenuSeparator, null),
              i.createElement(ve.ToolWidgetMenuSummary, { className: xa.menuItemHeader }, o.t(null, void 0, a(38554))),
              n.map(s)
            ),
          n.length > 0 &&
            t.length > 0 &&
      ...
      function Pa(e) {
        const {
          ...
          b = (0, i.useRef)(null),
          C = (0, i.useRef)(null),
          S = v()(n, Oa.wrap, { [Oa.full]: 'full' === s, [Oa.medium]: 'medium' === s }),
        ...
        function E(e, t) {
          if (x.PLATFORM_ACCESSIBILITY_ENABLED && t && (0, Z.isKeyboardClick)(t) && C.current) {
            ...
            g(e, () => {
              ...
              if (-1 !== a && C.current) {
                ...
                i ? i.focus() : (0, se.focusFirstMenuItem)(C.current), null === (n = b.current) || void 0 === n || n.update()
              }
            })
          } else g(e)
        }
        ...
        return i.createElement(
          ...
          e.favorites.map((t, a, n) =>
            i.createElement(da, {
              ...
              className: v()({ [Oa.first]: 0 === a, [Oa.last]: a === n.length - 1 })
            })
          )
        )
      }
      ...
      let Ua = a(77665),
        ...
        za = a(57778)
      const Va = {
          undoHotKey: (0, G.hotKeySerialize)({ keys: [(0, Y.humanReadableModifiers)(Y.Modifiers.Mod, !1), 'Z'], text: '{0} + {1}' }),
          redoHotKey: (0, G.hotKeySerialize)({ keys: [(0, Y.humanReadableModifiers)(Y.Modifiers.Mod, !1), 'Y'], text: '{0} + {1}' })
        },
      ...
      function ja(e) {
        ...
        return i.createElement(
          ...
          a.items.map((e, t) =>
            i.createElement(ie.PopupMenuItem, { key: t, label: e.title, onClick: () => e.onSelect(), 'data-name': 'dropdown-item' })
          )
        )
      }
      let Ga = a(27363)
