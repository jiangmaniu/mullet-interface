  ...
  [5075],
  {
                ...
                ;(i = [].concat(t(i), [p])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !d(o.target) &&
                        ((n && 0 === n.scrollTop && 0 < i) || ((r = n) && r.scrollHeight - r.scrollTop <= r.clientHeight && i < 0)
                          ? u(o)
                          : o.stopPropagation()))
                  }),
            ...
            (e.enableBodyScroll = function (e) {
              if (r) {
                ...
                ;(e.ontouchstart = null),
                  ...
                  s && 0 === i.length && (document.removeEventListener('touchmove', u, o ? { passive: !1 } : void 0), (s = !1))
              } else
        ...
        return () => {
          ...
          if (void 0 === e) {
            const o = document.createElement('div'),
              n = o.style
            ;(n.visibility = 'hidden'), (n.width = '100px'), (n.msOverflowStyle = 'scrollbar'), document.body.appendChild(o)
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(m, { className: i(v.drawer, u[`position${t}`], h), ref: b, 'data-name': e['data-name'] }, d)
            )
          )
        )
      }
    ...
    16396: (e, t, o) => {
      ...
      function p(e) {
        ...
        return n.createElement(
          ...
          n.createElement('span', { className: r(R.labelRow, h) }, n.createElement('span', { className: r(R.label, m) }, T)),
          (void 0 !== f || g) && n.createElement('span', { className: R.shortcut }, (X = f) && X.split('+').join(' + ')),
          void 0 !== M &&
            n.createElement('span', { onClick: F ? u : void 0, className: r(v, R.toolbox, { [R.showOnHover]: k, [R.showOnFocus]: D }) }, M)
        )
        var X
      }
    },
            ...
            if (s.CheckMobile.iOS())
              return (
                ...
                () => {
                  l--,
                    null !== c.current &&
                      (a ? 0 === l && (document.body.style.overscrollBehavior = '') : (0, r.enableBodyScroll)(c.current))
                }
              )
          }, []),
    ...
    78135: (e, t, o) => {
      ...
      function c(e, t) {
        return (o) => {
          ...
          y === n.AutoStrict &&
            (h < m.y + m.height + b + p ? ((y = n.Top), (E = i.FromBottomToTop)) : ((y = n.Bottom), (E = i.FromTopToBottom)))
      ...
      const a = s,
        l = n.forwardRef((e, t) => {
          ...
          return 'button' === o
            ...
            : n.createElement(
                'div',
                { ...C, ref: t, 'data-role': 'button', className: k, onClick: u ? void 0 : v, title: b, 'data-name': _, 'data-tooltip': T },
                g && f && n.createElement('div', { className: r('js-button-text', w.text) }, f),
                D,
                !g && f && n.createElement('div', { className: r('js-button-text', w.text) }, f),
    ...
    20626: (e, t, o) => {
      ...
      class g extends n.PureComponent {
              ...
              if (e.currentTarget.contains(e.target))
                ...
                switch (n) {
                  case 27: {
                    ...
                    this._handleToggleDropdown(!1), o && n && (null === (t = this._wrapperRef) || void 0 === t || t.focus())
                    break
                  }
                }
              }
            ...
            ? n.createElement(
                ...
                o &&
                  n.createElement(
                    'div',
                    { className: v.arrow },
                    n.createElement('div', { className: v.arrowWrap }, n.createElement(a.ToolWidgetCaret, { dropped: y }))
                  ),
                this.state.isOpened &&
                  (f ? n.createElement(p.MatchMedia, { rule: f }, (e) => this._renderContent(e)) : this._renderContent(c))
              )
            : n.createElement(
                'div',
                {
        ...
        _renderContent(e) {
          const { menuDataName: t, minWidth: o, menuClassName: r, maxHeight: i, drawerPosition: a = 'Bottom', children: l } = this.props,
    ...
    20792: (e, t, o) => {
      ...
      const s = r.DEFAULT_TOOL_WIDGET_BUTTON_THEME,
        a = (0, n.forwardRef)(function (e, t) {
          ...
          return n.createElement(r.ToolWidgetButton, { 'aria-label': o, ...s, tag: 'button', ref: a, tabIndex: l, 'data-tooltip': o })
        })
    },
    98945: (e, t, o) => {
      'use strict'
      ...
      const s = (0, n.forwardRef)(function (e, t) {
        ...
        return n.createElement(i.ToolWidgetIconButton, { 'aria-label': o, ...s, tag: 'button', ref: a, tabIndex: l, 'data-tooltip': o })
      })
    },
    88811: (e, t, o) => {
      'use strict'
