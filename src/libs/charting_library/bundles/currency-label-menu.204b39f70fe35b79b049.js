  ...
  [2704],
  {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            i &&
              ...
              r.createElement(
                'button',
                { className: E.close, onClick: a, onKeyDown: l, 'data-name': 'close', 'aria-label': f, type: 'button', ref: m },
    ...
    69654: (e, t, n) => {
      ...
      let r = n(50959),
        ...
        c = n(40281)
      function u(e) {
        const { children: t, renderInput: o, onCancel: u, containerClassName: h, inputContainerClassName: p, iconClassName: f, ...m } = e
        return r.createElement(
          'div',
          { className: i()(c.container, h) },
          r.createElement('div', { className: i()(c.inputContainer, p, u && c.withCancel) }, o || r.createElement(d, { ...m })),
          t,
    ...
    28587: (e, t, n) => {
      ...
      const S = r.memo(
        function (e) {
          ...
          return r.createElement(
            ...
            m &&
              (void 0 !== n
                ? r.createElement(b.CircleLogo, { logoUrl: n, size: f ? 'xsmall' : 'xxxsmall', className: h()(w.icon, y) })
                ...
                r.createElement(
                  ...
                  e.name
                    ? r.createElement(
                        ...
                        { summary: e.name, className: A.section, open: _[e.id], onStateChange: (t) => w({ ..._, [e.id]: t }) },
                        e.actions.map(N)
                      )
                    : e.actions.map(N)
                )
      ...
      const M = { horizontalAttachEdge: u.HorizontalAttachEdge.Right, horizontalDropDirection: u.HorizontalDropDirection.FromRightToLeft }
      function O(e) {
        const { element: t, ...n } = e,
          [o, i] = (0, r.useState)(y()),
          [d, h] = (0, r.useState)(''),
            ...
            i(
              d
                ? (function (e, t, n) {
                    ...
                    return (0, a.rankedSearch)({ data: r, rules: n, queryString: t, primaryKey: 'label', secondaryKey: 'description' })
                  })(n.sections, d, m)
                : y()
            )
          }, [d, n.sections, m])
            ...
            ? a
                ...
                .map((e, t) =>
                  r.createElement(
                    r.Fragment,
                    { key: t },
                    c[t] ? r.createElement('span', { className: o(s.highlighted, l) }, e) : r.createElement('span', null, e)
                  )
                )
            : a
        )
      ...
      ;(t.Children = {
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          let o = m({}, e.props),
            ...
            a = e._owner
          if (null != t) {
            if ((void 0 !== t.ref && ((s = t.ref), (a = w.current)), void 0 !== t.key && (i = '' + t.key), e.type && e.type.defaultProps))
    ...
    12811: (e, t, n) => {
      ...
      function c(e, t) {
        return (n, c, u, d) => {
          ...
          E === r.AutoStrict &&
            (d < f.y + f.height + C + c ? ((E = r.Top), (b = i.FromBottomToTop)) : ((E = r.Bottom), (b = i.FromTopToBottom)))
    ...
    84298: (e, t, n) => {
      ...
      function a(e, t, a) {
        ...
        if (d.size > 1) {
          const e = (0, i.createAction)('Mixed', o.t(null, void 0, n(95093)), void 0, void 0, null === t.selectedCurrency, () => c(null))
          m.actions.push(e)
        }
    ...
    14818: (e, t, n) => {
      ...
      function a(e, t, a) {
        ...
        if (d.size > 1) {
          const e = (0, i.createAction)('Mixed', o.t(null, void 0, n(95093)), void 0, void 0, null === t.selectedUnit, () => c(null))
          m.actions.push(e)
        }
