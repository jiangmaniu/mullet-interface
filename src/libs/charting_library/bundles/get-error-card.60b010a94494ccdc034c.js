;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [139],
  {
            ...
            o.createElement(
              ...
              u || c
                ? o.createElement(
                    ...
                    o.createElement(
                      'span',
                      { className: i(!u && c && d().ellipsisContainer, u && d().textWrapContainer, u && c && d().textWrapWithEllipsis) },
                      p
                    ),
                    o.createElement('span', { className: d().visuallyHidden, 'aria-hidden': !0 }, p)
                  )
                : o.createElement(o.Fragment, null, p, o.createElement('span', { className: d().visuallyHidden, 'aria-hidden': !0 }, p))
            ),
    ...
    86332: (t, e, r) => {
      ...
      const o = r(50959).createContext({ isGrouped: !1, cellState: { isTop: !0, isRight: !0, isBottom: !0, isLeft: !0 } })
    },
    17946: (t, e, r) => {
      'use strict'
          ...
          Array.isArray(t) || (0, o.isValidElement)(t)
            ? o.Children.toArray(t)
                .reduce((t, e) => {
                  let r = ''
                  return (
                    (r = (0, o.isValidElement)(e) && i(e) ? l(e.props.children) : (0, o.isValidElement)(e) && !i(e) ? '' : a(e)),
                    t.concat(r)
                  )
                }, '')
                .trim()
    ...
    81200: (t, e, r) => {
      ...
      const y = {
        ghost: { 1: (0, h.enabled)('hide_image_invalid_symbol') ? void 0 : p, 2: (0, h.enabled)('hide_image_invalid_symbol') ? void 0 : m },
      ...
      const x = a.forwardRef((t, e) => {
        const { icon: r, message: o, size: i = 1, rawHtml: l = !1, doNotLimitWidth: n, solutionId: s, buttons: h } = t,
          ...
          v = h
            ? h.map((t) =>
                a.createElement(u.LightButton, { onClick: t.onClick, className: C.errorCardButton, size: m, key: t.name }, t.name)
              )
            : null
      ...
      function w(t) {
        ...
        return (
          ...
          a.createElement(x, { ref: p, message: r, icon: e, size: m, rawHtml: o, doNotLimitWidth: i, solutionId: u, buttons: h })
        )
        function g() {
          const t = p.current
          if (!t) return
