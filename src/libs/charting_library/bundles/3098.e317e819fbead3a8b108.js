  ...
  [3098],
  {
      ...
      function u(e) {
        ...
        return (
          (0, r.useIsomorphicLayoutEffect)(() => {
            ;(!v && !B.current && d(F.current, t) && d(w, T.current)) || (C(), (B.current = !1), (F.current = t), (T.current = w))
          }, [t, C, w, v]),
          {
      ...
      function b(e, t, n, l = i.EndFirst) {
        const o = (0, a.useCallback)(
          (n, a) => {
            ...
            return (function ({ items: e, containerWidth: t, elementsWidths: n, menuItemWidth: a, keepVisible: l, direction: o }) {
              const s = [...e],
                r = [],
                c = []
              let u = 0
              ...
              if (((u = l.map((e) => d[e]).reduce((e, t) => e + t, 0) + a), o === i.EndFirst))
                for (let e = 0; e < s.length; e++) l.includes(e) ? r.push(s[e]) : ((u += d[e]), u <= t ? r.push(s[e]) : c.push(s[e]))
              else
    ...
    16212: (e, t, n) => {
      ...
      function m(e) {
        ...
        const {
          ...
          S = (0, i.useRef)(null !== (n = null === (t = e.itemsRefs) || void 0 === t ? void 0 : t.current) && void 0 !== n ? n : new Map()),
          [A, N] = (0, i.useState)(),
          [F, B] = (0, o.useFocus)(),
          T = u.find(C),
          ...
          z = (0, i.useCallback)(
            (e, t) => {
              h || e.disabled || (N(e), 'number' == typeof t ? (clearTimeout(P.current), (P.current = setTimeout(() => Q(e), t))) : Q(e))
            },
            [h, N, Q]
          ),
          H = (0, i.useCallback)(
        ...
        const D = null !== (r = null == w ? void 0 : w.additionalScroll) && void 0 !== r ? r : 0,
          ...
          K = u.map((e) => {
            ...
            const i = O(e),
              ...
              s = !o && (F ? i : l)
            return { ...(0, a.getTabAttributes)(e.id, s, l, e.tabpanelId, o), highlighted: i, active: l, handleItemRef: V }
          })
        return {
          tabsBindings: K,
          tablistBinding: {
    ...
    16396: (e, t, n) => {
      ...
      function b(e) {
        ...
        return i.createElement(
          ...
          i.createElement('span', { className: a(P.labelRow, v) }, i.createElement('span', { className: a(P.label, m) }, I)),
          (void 0 !== f || p) && i.createElement('span', { className: P.shortcut }, (Y = f) && Y.split('+').join(' + ')),
          void 0 !== N &&
            i.createElement('span', { onClick: Q ? d : void 0, className: a(h, P.toolbox, { [P.showOnHover]: M, [P.showOnFocus]: R }) }, N)
        )
        var Y
      }
    },
    89846: (e, t, n) => {
      ...
      function M(e) {
        ...
        return s.createElement(k.Icon, { className: f(C['end-icon-wrap'], n && C.caret), icon: n ? w : t, 'aria-hidden': !0 })
      }
      ...
      const S = (0, s.createContext)({ size: 'small', variant: 'primary', isHighlighted: !1, isCollapsed: !1, disabled: !1 })
      function A(e) {
        var t, n, i
          ...
          popupChildren: s.createElement(
            ...
            o.map((e) =>
              s.createElement(N.PopupMenuItem, {
                ...
                onClickArg: e,
                isActive: h(e),
                label: s.createElement(z, { isHighlighted: h(e), size: b, variant: v, disabled: e.disabled }, e.children),
      ...
      function z(e) {
        const { isHighlighted: t, size: n, variant: i, children: a, disabled: l } = e,
          o = { size: null != n ? n : x, variant: null != i ? i : y, isHighlighted: t, isCollapsed: !0, disabled: null != l && l }
      ...
      function j(e) {
        ...
        return (
          ...
          s.createElement(
            'div',
            { ...oe, className: p()(U({ overflowBehaviour: T }), k), style: { ...E, '--ui-lib-round-tabs-gap': `${z}px` }, 'data-name': F },
            s.createElement(
              'div',
              ...
              Z.map((e) => s.createElement(A, { ...be(e), key: e.id, item: e, variant: C, size: w, reference: G(Q(e)), fake: !0 })),
              'collapse' === T &&
                s.createElement(P, {
                  disabled: h,
                  isOpened: ee,
    ...
    63932: (e, t, n) => {
      ...
      n(7727)
      function o(e) {
        const t = a(e.className, 'tv-spinner', 'tv-spinner--shown', `tv-spinner--size_${l.spinnerSizeMap[e.size || l.DEFAULT_SIZE]}`)
      ...
      const s = o,
        r = i.forwardRef((e, t) => {
          ...
          return 'button' === n
            ...
            : i.createElement(
                'div',
                { ...E, ref: t, 'data-role': 'button', className: M, onClick: d ? void 0 : h, title: g, 'data-name': y, 'data-tooltip': I },
                p && f && i.createElement('div', { className: a('js-button-text', k.text) }, f),
                R,
                !p && f && i.createElement('div', { className: a('js-button-text', k.text) }, f),
