          ...
          a.createElement(
            ...
            n &&
              a.createElement(
                ...
                o && a.createElement(c.Icon, { className: l(p().icon, x && p()['light-icon']), icon: null != m ? m : f[t] }),
                a.createElement(
                  'div',
                  {
                  ...
                  i &&
                    a.createElement('span', { className: l(x && p()['light-title'], p().header, p()[`header-${x ? 'new-line' : w}`]) }, i),
