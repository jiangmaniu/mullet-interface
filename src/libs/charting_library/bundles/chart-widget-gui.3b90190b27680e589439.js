  ...
  [5093],
  {
    ...
    85109: (e, t, s) => {
      ...
      class f {
        constructor(e, t, s) {
          ...
          ;(this._withActions = s.withActions),
            ...
            this._withActions &&
              ...
              (this._selectedSourceHandler = (0, m.wrapHandlerWithPreventEvent)(this._model.setSourceSelected.bind(this._model))),
        ...
        _renderTitle() {
          let e
          null === this._logoAndTitleParentEl &&
            ((this._logoAndTitleParentEl = document.createElement('div')), this._logoAndTitleParentEl.classList.add(y.logoAndTitlesWrapper))
          ...
          for (let s = 0; s < this._titlesSpawns.length; s++) {
            ...
            o.classList.add(y.title, l, 'apply-overflow-tooltip'),
              ...
              i.length > 0 ? (o.appendChild(document.createTextNode(i)), o.classList.add(y.withDot)) : o.classList.add(g.blockHidden),
              t.appendChild(o),
        ...
        _isWidthButtonsMode() {
          return (
            null !== this._el &&
            (this._el.classList.contains(y.withAction) || this._disabled.value() || this._selected.value() || this._stayInHoveredMode)
          )
        }
        ...
        _updateShowTitles() {
          null !== this._logoAndTitleParentEl &&
            ...
            null !== this._actionsParentEl && this._actionsParentEl.classList.toggle(g.blockHidden, this._isTitleHidden.value()))
        }
        _updateValues() {
          this._removeValuesSpawnsSubscriptions(),
            this._createValuesSpawns(),
        ...
        constructor(e, t) {
          ;(this._lastDrawnLogos = []),
            ...
            (this._updateSymbolLogo = async (e) => {
              let t, s, i, l, o, a, n, r, d
              if ((null === this._logoWrapper && this._renderSymbolLogo(), (0, M.default)(this._lastDrawnLogos, e))) return
              const u = await ((h = e),
              Promise.all(
                h.map((e) =>
        ...
        constructor(e, t, s) {
          super(e, t, s),
            ...
            s.withActions &&
              ...
              null !== this._logoAndTitleParentEl && this._logoAndTitleParentEl.addEventListener(D, this._wheelClickHandler))
          const i = e.symbolLogoViewModel().value()
      ...
      class J {
        constructor(e, t) {
          ...
          this._mouseEventHandler = new p.MouseEventHandler(this._parentEl, { contextMenuEvent: s, touchContextMenuEvent: s })
        }
        destroy() {
          if (
        ...
        _addOutsideEventForHideTooltip() {
          null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(),
            (this._outsideEventForCollapsedTooltip = (0, q.addOutsideEventListener)(
              ...
              () => {
                null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), (0, Y.hide)()
              },
              window.document,
              { touchEnd: !0 }
            ))
        ...
        _updateLegendVisibility() {
          this._parentEl.classList.toggle(g.blockHidden, this._isAllLegendHidden.value()),
            null !== this._dataSourcesEl && this._dataSourcesEl.classList.toggle(g.blockHidden, this._isStudiesLegendHidden.value())
        }
      ...
      class he {
        ...
        onShowSettings(e) {
          this._source.userEditEnabled() &&
            (this.setSourceSelected(), this._callbacks.showChartPropertiesForSource(this._source, e), z('Settings for source'))
        }
        onShowMoreActions(e) {
      ...
      class ve {
        ...
        _quoteSymbolChanged() {
          ...
          ;(this._quoteDataForLogos = {
            ...
            'currency-logoid':
              null !== (t = null == i ? void 0 : i['currency-logoid']) && void 0 !== t ? t : null == a ? void 0 : a['currency-logoid'],
        ...
        _updateLogoUrls() {
          if (this._quoteDataForLogos) {
            const e = (0, ce.removeUsdFromCryptoPairLogos)((0, ce.resolveLogoUrls)(this._quoteDataForLogos, _e.LogoSize.Medium))
      ...
      class Le extends he {
        constructor(e, t, s, i, l) {
          ...
          this._symbolLogoViewModel.setValue(be(t, o)),
            ...
            (this._isPriceSourceHidden = (0, K.createWVFromGetterAndSubscription)(() => !o.showPriceSource.value(), o.showPriceSource)),
      ...
      class Xe extends he {
        ...
        updateSource(e) {
          this._source !== e &&
            (this._values.setValue([]), super.updateSource(e), this._updateAbleShowSourceCode(), this._updateSymbolLogoModel())
        }
        onRemoveSource() {
          let e
      ...
      function Nt(e) {
        const t = e.start(),
          ...
          o = Pt(t),
          a = Pt(t + s)
        return s > Lt.minutesPerDay ? `${kt.weekDaysShortNames[i]} ${o} — ${kt.weekDaysShortNames[l]} ${a}` : `${o} — ${a}`
      }
      function Ot(e, t, s, i) {
      ...
      class Rt {
        ...
        _updateEntriesBySubSessions(e) {
          ...
          const s = this._createSubSessionSpecs(e),
            i =
              (l = (null === (t = this._todayInExchangeTime) || void 0 === t ? void 0 : t.getUTCDay()) || new Date().getDay()) <
          ...
          for (const e of Array.from(s.keys())) {
            Ft(a, (0, o.ensureDefined)(s.get(e)).getEntriesForWeekByCalendar((0, o.ensureNotNull)(this._todayInExchangeTime)), e)
          }
          !(function (e) {
            const t = Pt(0),
            ...
            for (const l of Object.keys(e)) {
              ...
              for (let e = 0; e < p; e++) {
                const s = n[e],
                  i = e > 0 ? n[e - 1] : null,
                  l = 0 === e
                if (0 === s.start.value || (0 === s.start.value && 1 === s.end.value) || (null !== i && s.start.value === i.end.value)) {
                  m++
                  continue
                }
              ...
              1 !== g.end.value &&
                n.push({
                  ...
                  end: { value: 1, title: Pt(Lt.minutesPerDay), isFirstOrLastPoint: !(h.length > 0) || 0 === h[0].start.value },
                  type: 3,
        ...
        _createSubSessionSpecs(e) {
          ...
          for (const a of l) {
            ...
            if (null !== l) {
              ...
              void 0 !== t &&
                o.set(l, new Wt.SessionSpec(e.timezone, t['session-display'] || t.session, e.session_holidays, t['session-correction']))
            }
          }
          return o
        }
      ...
      class ts {
        ...
        renderer(e, t) {
          let s, i
          return (
            null === (i = null === (s = this._source.marketStatusModel()) || void 0 === s ? void 0 : s.futuresContractExpirationTime()) ||
            void 0 === i
              ? void 0
              : i.expired().value()
          )
      ...
      const ms = new Map([
        ...
        Bs =
          (B.t(null, { context: 'Part of: "Real-time data for {symbolName} is provided by {exchange} exchange."' }, s(12978)),
          B.t(null, { context: 'Part of: "Real-time data for {symbolName} is provided by {exchange} exchange."' }, s(64565)),
          ...
          for (const r of i) {
            ...
            if (
              ...
              ['DelayToRealtime', 'DelayNoRealtime', 'DelayWithoutMarketAgreement', ...Ys].includes(i) &&
                ...
                'DelayWithoutMarketAgreement' === i && l[i].push(Ds.format({ listedExchange: this._model.listedExchange() })),
                this._options.subscriptionFullInfo &&
                  Ys.includes(i) &&
              ...
              l[i].push(this._options.subscriptionFullInfo ? o : a), this._options.subscriptionFullInfo && l[i].push(Hs)
            }
      ...
      function dl(e) {
        ...
        return 0 === t && 0 === i && 0 === l
          ...
          : t > 0
          ? Zi.format({
              days: ((o = t), B.t(null, { plural: '{number} days', count: o }, s(58609)).format({ number: o.toString() })),
              hours: rl(i)
            })
          : i > 0
      ...
      const ul = {
          ...
          out_of_session: (e) => ('pre_market' === e.status ? el : Ji).format({ remainingTime: dl(e.remainingSeconds) }),
      ...
      class cl extends os {
        constructor(e, t) {
          super({ tooltipMap: il, iconMap: tl, classNameMap: sl, titleMap: ll, titleColorMap: ol, actionMap: hl, size: t }),
            (this._model = null),
      ...
      class _l {
        constructor(e, t) {
          ...
          ;(this.errorWidgetIsShown = new a.WatchedValue(!1)),
            ...
            (this._source = e),
            (this._symbol = null !== (i = null === (s = e.symbol()) || void 0 === s ? void 0 : s.spawn()) && void 0 !== i ? i : null),
            (this._options = t),
        ...
        _recreateWidgets() {
          ...
          if (this._options.marketStatusEnabled) {
            ...
            if (null === this._marketStatusViewModel) {
              ...
              null !== t && ((this._sessionWidget = new ts(this._source)), (s.additionalWidgets = [this._sessionWidget])),
            ...
            if (null === this._dataUpdatedModeViewModel) {
              const i = {
                ...
                shouldBeHiddenRegardlessOfStatus:
                  null ===
                    (s = null === (t = this._source.marketStatusModel()) || void 0 === t ? void 0 : t.futuresContractExpirationTime()) ||
                  void 0 === s
                    ? void 0
                    : s.expired()
              }
      ...
      class gl {
        constructor(e, t) {
          ...
          if ((0, ml.isStudyLineTool)(e)) s.push(e.onStatusChanged())
            ...
            (this._isSymbolInvalid = (0, K.createWVFromGetterAndSubscriptions)(() => e.isSymbolInvalid() && e.isActualInterval(), s)),
              s.push(e.onStatusChanged(), e.onIsActualIntervalChange())
          else {
            ;(0, o.assert)(e === t.mainSeries())
            const i = t.mainSeries()
            ;(this._isSymbolInvalid = (0, K.createWVFromGetterAndSubscription)(() => i.isSymbolInvalid(), i.onStatusChanged())),
              s.push(i.onStatusChanged()),
              (this._symbolInfo = (0, K.createWVFromGetterAndSubscription)(i.symbolInfo.bind(i), i.dataEvents().symbolResolved()))
          }
          this._dataSourceErrorStatus = (0, K.createWVFromGetterAndSubscriptions)(() => this._source.statusProvider({}).errorStatus(), s)
        }
        destroy() {
          let e, t
          null === (e = this._symbol) || void 0 === e || e.destroy(),
      ...
      class Ml {
        ...
        updateLayout() {
          ...
          i > -1
            ? (e.splice(i, 1),
              yl ||
                ...
                (this._mainSeriesStatusWidget = new pl(this._statusSourceAdapter(s), this._model.model(), this._options.statusesWidgets)),
          ...
          if (0 === n)
            for (let t = e.length - 1; t >= 0; t--) {
              const s = e[t]
              l.push(new Xe(this._model, s, this._dataSourceViewModelsOptions, this._callbacks, this._options.contextMenu)),
            ...
            for (let s = e.length - 1; s >= 0; s--) {
              ...
              this._dataSourceViewModels[t]
                ...
                : (l.push(new Xe(this._model, i, this._dataSourceViewModelsOptions, this._callbacks, this._options.contextMenu)),
          ...
          0 !== l.length &&
            (this._renderer.addDataSources(l, a), this._dataSourceViewModels.push(...l), this._dataSourcesStatusesWidgets.push(...a)),
        ...
        addMargin(e) {
          ...
          this._margin = e
          ;(this._renderer.getElement().style.maxWidth = 0 === this._margin ? '' : `calc(100% - ${this._margin + fl}px)`),
        ...
        _statusSourceAdapter(e) {
          ...
          return (
            void 0 === t &&
              ((t =
                e !== this._model.mainSeries() ? new gl(e, this._model.model()) : new vl(this._model.mainSeries(), this._model.model())),
    ...
    69289: (e, t, s) => {
      ...
      class m {
        constructor(e, t, s) {
          ...
          for (const [e, t] of Object.entries(this._actions)) {
            const s = e
            ;(this._actionsSpawns[s] = { visible: t.visible.spawn(), title: void 0 === t.title ? null : t.title.spawn() }),
        ...
        _renderActions() {
          ...
          ;(this._listActionsElements.up = (0, c.createActionElement)(this._actions.up, _.button, _.buttonIcon, p.blockHidden, e)),
            (this._listActionsElements.down = (0, c.createActionElement)(this._actions.down, _.button, _.buttonIcon, p.blockHidden, e)),
            ...
            (this._listActionsElements.close = (0, c.createActionElement)(this._actions.close, _.button, _.buttonIcon, p.blockHidden, e)),
            ...
            (this._listActionsElements.more = (0, c.createActionElement)(this._actions.more, _.button, _.buttonIcon, p.blockHidden, e))
      ...
      class X {
        ...
        updateThemedColors(e) {
          null === e && (e = (0, A.getStdThemedValue)('chartProperties.paneProperties.background', this._backgroundThemeName.value())),
            this._themedColor.setValue(e || '')
        }
        ...
        _getCloseButtonVisibility() {
          ...
          let t = !1
          return e.containsMainSeries() || e.maximized().value() || N || (t = e.dataSources().some((e) => (0, r.isStudy)(e))), t
        }
        _onCloseButton() {
