  ...
  [6456],
  {
    ...
    35057: (e, t, n) => {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            o &&
              ...
              r.createElement(
                'button',
                { className: b.close, onClick: s, onKeyDown: l, 'data-name': 'close', 'aria-label': f, type: 'button', ref: m },
      ...
      class N extends r.PureComponent {
        ...
        componentDidMount() {
          let e, t
          this.props.ignoreClosePopupsAndDialog || v.subscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          let e, t
          this.props.ignoreClosePopupsAndDialog || v.unsubscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
    ...
    69654: (e, t, n) => {
      ...
      let r = n(50959),
        ...
        c = n(40281)
      function u(e) {
        const { children: t, renderInput: i, onCancel: u, containerClassName: h, inputContainerClassName: p, iconClassName: f, ...m } = e
        return r.createElement(
          'div',
          { className: o()(c.container, h) },
          r.createElement('div', { className: o()(c.inputContainer, p, u && c.withCancel) }, i || r.createElement(d, { ...m })),
          t,
    ...
    22265: (e, t, n) => {
      ...
      function h(e) {
        const { mode: t, title: n, icon: i, isActive: u, onClick: d, tag: h = 'div', reference: p, className: f, ...m } = e,
      ...
      function L(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            L && r.createElement(R.FavoriteButton, { className: v()(T.favorite, E && T.isActive), isFilled: E, onClick: O }),
            r.createElement(x, { disabled: l.isGrayed }, r.createElement(N.HighlightedText, { queryString: c, rules: u, text: l.title })),
            !1,
            ...
            B && r.createElement(BadgeIndicator, { type: 'ep', className: T.badge, tooltip: o.t(null, void 0, n(92490)) }),
            !1
          ),
          k && r.createElement('a', { href: k.authorLink, className: T.author, target: '_blank', onClick: z }, k.authorName),
          ...
          r.createElement(y.AdaptivePopupDialog, {
            ...
            render: function () {
              return r.createElement(
                r.Fragment,
                null,
                r.createElement(b.DialogSearch, { reference: S, placeholder: o.t(null, void 0, n(52298)), onChange: D, onFocus: R }),
                r.createElement(
      ...
      class ce extends class {
        ...
        async _init() {
          ...
          ;(this._indicatorData = await (async function (e, t) {
            let n = { ...t }
            return [...le(n, 'tv-basicstudies'), ...le(n, 'Script$STD'), ...le(n, 'tv-volumebyprice')].filter((e) => !e.isStrategy).sort(d)
          ...
          .map((e) => {
            ...
            return (
              n.forEach((e) => {
                ...
                if (Array.isArray(u))
                  for (const e of u) if (f.test(e)) return (h = 1), void (d = null === (c = e.match(f)) || void 0 === c ? void 0 : c.index)
              }),
      ...
      ;(t.Children = {
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          let i = m({}, e.props),
            ...
            s = e._owner
          if (null != t) {
            if ((void 0 !== t.ref && ((a = t.ref), (s = w.current)), void 0 !== t.key && (o = '' + t.key), e.type && e.type.defaultProps))
