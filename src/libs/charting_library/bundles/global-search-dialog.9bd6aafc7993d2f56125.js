;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9754, 1754, 9685, 361],
  {
    ...
    89324: (e, t, o) => {
      'use strict'
      o.r(t),
        o.d(t, { Components: () => c, showDefaultSearchDialog: () => h, showSymbolSearchItemsDialog: () => a.showSymbolSearchItemsDialog })
      var l = o(82992),
        n = (o(32563), o(79652)),
        i = o(94664),
        a = o(1861),
    ...
    71043: (e, t, o) => {
      ...
      function H(e) {
        ...
        return l.createElement(
          ...
          l.createElement(
            ...
            n.map((e) =>
              l.createElement(E, { key: e.id, action: e, isSelected: e.id === o, activeElRef: e.id === o ? i : void 0, onExecute: a })
            )
          )
        )
      }
                ...
                u
                  ...
                  : l.createElement(
                      ...
                      Boolean(m.length)
                        ...
                        : l.createElement(b, { text: s.t(null, void 0, o(27463)), showIcon: !1, className: P.emptyState })
                    )
              )
            ),
          className: P.dialog,
      ...
      const Se = O.enabled('show_average_close_price_line_and_label'),
        ...
        ke = new K.TranslatedString('change indicators and financials value labels visibility', s.t(null, void 0, o(71161))),
        Ee = new K.TranslatedString('change indicators and financials name labels visibility', s.t(null, void 0, o(12411))),
      ...
      async function Fe(e) {
        ...
        v.push(
          ...
          v.push(
            new W({
              ...
              category: 'functionActions',
              disabled: !(null === (r = null === (a = w.symbolInfo()) || void 0 === a ? void 0 : a.subsessions) || void 0 === r
                ? void 0
                : r.some((e) => !e.private && 'extended' === e.id)),
              onExecute: () => {
                var t
                const o = 'extended' === (null === (t = w.symbolInfo()) || void 0 === t ? void 0 : t.subsession_id) ? 'regular' : 'extended'
                e.model().setProperty(b.sessionId, o, Te)
              },
              checked: Boolean('extended' === (null === (c = w.symbolInfo()) || void 0 === c ? void 0 : c.subsession_id))
            })
          ),
          v.push(
            new W({
        ...
        const _ = (0, q.combineProperty)((e, t) => e || t, M.showStudyLastValue.weakReference(), M.showFundamentalLastValue.weakReference())
        v.push(
          new W({
          ...
          for (const o of t)
            v.push(
              new W({
                id: `ChartStyle_${o}`,
                category: 'functionActions',
                disabled: !(null === (d = I.linking.supportedChartStyles.value()) || void 0 === d ? void 0 : d.includes(o)),
                onExecute: () => {
          ...
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const { width: x, height: M } = f,
                C = 'function' == typeof p ? p({ contentWidth: x, contentHeight: M, availableWidth: y, availableHeight: b }) : p,
                A =
                  null !== (n = null === (l = null == C ? void 0 : C.indentFromWindow) || void 0 === l ? void 0 : l.left) && void 0 !== n
                    ? n
                    : 0,
                z =
                  y -
                  (null !== (i = C.overrideWidth) && void 0 !== i ? i : x) -
                  (null !== (h = null === (r = null == C ? void 0 : C.indentFromWindow) || void 0 === r ? void 0 : r.right) && void 0 !== h
                    ? h
                    : 0),
                k = (0, s.clamp)(C.x, A, Math.max(A, z)),
                E =
                  (null !== (d = null === (c = null == C ? void 0 : C.indentFromWindow) || void 0 === c ? void 0 : c.top) && void 0 !== d
                    ? d
                    : 0) + S,
                _ =
                  b -
                  (null !== (v = C.overrideHeight) && void 0 !== v ? v : M) -
                  (null !== (g = null === (u = null == C ? void 0 : C.indentFromWindow) || void 0 === u ? void 0 : u.bottom) && void 0 !== g
                    ? g
                    : 0)
      ...
      const s = [
        {
          ...
          items: [{ name: 'cursor' }, { name: 'dot' }, { name: 'arrow' }, { name: 'eraser' }, null].filter(a.isExistent),
          trackLabel: null
        },
        {
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [{ name: 'LineToolAnchoredVWAP' }, { name: 'LineToolFixedRangeVolumeProfile' }, null].filter(a.isExistent)
            },
            {
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [!(0, n.onWidget)() && i.enabled('image_drawingtool') ? { name: 'LineToolImage' } : null, null, null].filter(
                a.isExistent
              )
            }
          ],
      ...
      !(function (e) {
        function t() {
          ...
          if (0 === c.length && h && 'undefined' != typeof window) {
            const e = JSON.parse(
              null !== (l = null === (t = window.urlParams) || void 0 === t ? void 0 : t.favorites) && void 0 !== l ? l : '{}'
            ).drawingTools
            e && Array.isArray(e) && c.push(...e)
          }
          c.forEach((t, l) => {
            const n = t.tool || t
            o(n) ? (a.includes(n) ? (r = !0) : e.favorites.push(n)) : s && s.includes(n) && e.hiddenToolsPositions.set(n, l)
          }),
            r && n(),
        ...
        (function (e) {
          ...
          ;(e.favoriteAdded = new l.Delegate()),
            ...
            (e.addFavorite = function (o, l) {
              return !(n(o) || !t(o) || 'performance' === o) && (r.favorites.push(o), r.saveFavorites(l), e.favoriteAdded.fire(o), !0)
            }),
