            ...
            (e.enableBodyScroll = function (e) {
              if (r) {
                ...
                ;(e.ontouchstart = null),
                  ...
                  l && 0 === i.length && (document.removeEventListener('touchmove', d, o ? { passive: !1 } : void 0), (l = !1))
              } else
            ...
            n.createElement(
              ...
              d || c
                ? n.createElement(
                    ...
                    n.createElement(
                      'span',
                      { className: r(!d && c && u().ellipsisContainer, d && u().textWrapContainer, d && c && u().textWrapWithEllipsis) },
                      m
                    ),
                    n.createElement('span', { className: u().visuallyHidden, 'aria-hidden': !0 }, m)
                  )
                : n.createElement(n.Fragment, null, m, n.createElement('span', { className: u().visuallyHidden, 'aria-hidden': !0 }, m))
            ),
          ...
          Array.isArray(e) || (0, n.isValidElement)(e)
            ? n.Children.toArray(e)
                .reduce((e, t) => {
                  let o = ''
                  return (
                    (o = (0, n.isValidElement)(t) && r(t) ? l(t.props.children) : (0, n.isValidElement)(t) && !r(t) ? '' : i(t)),
                    e.concat(o)
                  )
                }, '')
                .trim()
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(h, { className: i(v.drawer, d[`position${t}`], m), ref: y, 'data-name': e['data-name'] }, u)
            )
          )
        )
      }
            ...
            if (l.CheckMobile.iOS())
              return (
                ...
                () => {
                  a--,
                    null !== c.current &&
                      (s ? 0 === a && (document.body.style.overscrollBehavior = '') : (0, r.enableBodyScroll)(c.current))
                }
              )
          }, []),
    ...
    184: (e, t, o) => {
      ...
      const f = (0, n.forwardRef)((e, t) => {
        ...
        const c = (0, n.useCallback)(
            (t) => {
              var o
              null === (o = e.onKeyDown) || void 0 === o || o.call(e, t), 27 === (0, h.hashFromEvent)(t) && (t.preventDefault(), r())
            },
            [r]
          ),
          u = (0, n.useCallback)(() => {
      ...
      function W(e) {
        var t, o
        const { cardType: r, anchor: i, title: l, tooltipIcon: a, tooltipInformationButtonProps: c, className: u, ...d } = e,
        ...
        return n.createElement(
          'div',
          { className: s()(_.wrap, u), style: { borderColor: null === (o = d.style) || void 0 === o ? void 0 : o.color } },
          n.createElement(
            'div',
            { className: p },
            l && n.createElement(E, { title: l, icon: a, informationButtonProps: c, iconStyle: m, cardType: r }),
            'common' === d.type && n.createElement(N, { ...d }),
            i && ('mob' !== r || !i.hideInMobileMode) && n.createElement('div', { className: _.group }, n.createElement(k, { ...i }))
          )
        )
      }
      var D = o(58101)
      ...
      function P(e) {
        ...
        return (
          null === F && ((F = document.createElement('div')), document.body.appendChild(F)), r.render(n.createElement(Q, { ...t }), F), I
        )
      }
      function I() {
      ...
      function M(e, t) {
        ...
        return w < n ? ((f = e.marginTop + u.top), (v = Math.max(w, 0))) : (f = u.height + u.top - y - n), { x: g, y: f, overrideHeight: v }
      }
    },
    2948: (e) => {
      e.exports =
