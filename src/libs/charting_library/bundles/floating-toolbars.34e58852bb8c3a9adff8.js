  ...
  [2306],
  {
    66783: (t) => {
      ...
      t.exports = function (t, i) {
        ...
        for (let s = 0; s < n.length; s++) if (!e.call(i, n[s]) || !o(t[n[s]], i[n[s]])) return !1
        return !0
      }
    },
    26006: (t) => {
    ...
    61259: (t, e, o) => {
      ...
      function b(t) {
        const { multipleProperty: e, title: o, undoText: d, propertyApplier: u, isToolbarFixed: p, className: g, isSmallScreen: m } = t,
        ...
        return i.createElement(
          ...
          y.map(({ value: t, icon: e }) =>
            i.createElement(c.PopupMenuItem, { key: t, theme: f, label: `${t}px`, icon: e, isActive: t === b, onClick: T, onClickArg: t })
          )
        )
        function T(t) {
          t &&
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement('input', { ref: this._inputRef, type: 'text', className: H.input, value: o, onChange: this._handleInput })
              ),
              i.createElement(
                'div',
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement('div', { className: n(c.pointer, a && c.dragged), style: { left: 100 * e + '%' }, ref: this._refPointer })
              )
            ),
            !o &&
              i.createElement(
      ...
      class _ extends n.FloatingToolbar {
        ...
        _createLinetoolWidget(t) {
          const e = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${
            ...
            }" title="${h.lineToolsInfo[t].localizedName}" data-name="FavoriteToolbar${t}">${h.lineToolsInfo[t].icon}</span>`,
        ...
        constructor(t) {
          ;(this._widget = document.createElement('div')),
            ...
            this._options.layout &&
              ...
              ((this._isVertical = 'vertical' === this._options.layout), this._updateLayoutType(), this._updateAxisOption()),
    ...
    89824: (t, e, o) => {
      ...
      function T(t) {
                        ...
                        n.map((o, n) => {
                          ...
                          return r
                            ? o.showForSmallScreen
                              ...
                              : null
                            : i.createElement(o.component, { ...o.props, key: `${o.props.title}_${n}`, className: f()(C, a) })
                        })
                    )
                )
            )
        ...
        function d() {
          return null === e
            ? null
            : i.createElement(e.component, { ...e.props, isToolbarFixed: s, isDrawingFinished: r, className: f()(C, a) })
        }
      }
      let x = o(51768),
        S = o(50813),
      ...
      class at extends b.FloatingToolbar {
        ...
        _createPopup(t) {
          const e = { createdFor: t.toolbarWidget, element: document.createElement('div'), stateWidgetId: t.statedWidget.id, widgets: [] }
        ...
        _onSubWidgetClicked(t, e) {
          this._closePopup(),
            t.statedWidget.currentStateId !== e &&
              (this.setGroupedWidgetState(t.statedWidget.id, e), this._onWidgetStateChangedDelegate.fire(t.statedWidget.id, e))
        }
        _onWindowClicked(t) {
          if (this.isVisible() && this._currentPopup && !at._isEventInElement(t, this._currentPopup.element)) {
            for (let e = 0; e < this._statedWidgets.length; ++e) if (at._isEventInElement(t, this._statedWidgets[e].toolbarWidget)) return
            this._closePopup()
          }
        }
      ...
      class wt {
          ...
          ;(this._isDrawingFinished = new l.WatchedValue(!0)),
            ...
            (this._handleSourceEdit = (t) => {
              d.isDirectionalMovementActive.value() ||
                (t
                  ? (this._fixedContainer && (this._fixedContainer.style.display = 'none'), this._floatingToolbar.hide(!0))
                  : (this._fixedToolbarRendered && this._fixedContainer && (this._fixedContainer.style.display = 'block'),
        ...
        onSourceChanged(t) {
          ...
          if (
            ...
            e.isAvailableInFloatingWidget() && this.activeChartWidget().model().model().dataSourceForId(e.id())
              ? (!e.userEditEnabled() ||
                  (!(0, dt.isLineDrawnWithPressedButton)(e.toolname) && this.activeChartWidget().model().lineBeingCreated()) ||
          ...
          this._updateVisibilityTimeout && clearTimeout(this._updateVisibilityTimeout),
            (this._updateVisibilityTimeout = setTimeout(() => {
              ;(0, ct.unsetNewToolProperties)(),
                Ct() && this._fixedContainer ? (this._fixedContainer.style.display = 'none') : this._floatingToolbar.hide(!0),
        ...
        _createRemoveButton() {
          const t = { component: M, props: { title: vt, activeChartWidget: this.activeChartWidget() }, showForSmallScreen: !0 }
          this._addCommonButton(t)
        }
        _createDotsButton() {
          this._addCommonButton({ component: Y, props: { title: ft, activeChartWidget: this.activeChartWidget() }, showForSmallScreen: !0 })
        }
        _createAlertButton() {}
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ...
              : new _.CollectibleColorPropertyUndoWrapper(new h.MultipleLineColorsProperty(t), this._propertyApplierImpl(), i)
          }
          if (t && t.visible())
    ...
    26916: (t, e, o) => {
      'use strict'
      let i = o(36298).TranslatedString,
      ...
      class L extends n {
        ...
        showPropertiesOf(t, e, o) {
          ...
          let i = this._toolExceptionCases[t] || this._getPossibleProperty(e)
        ...
        _riskPropertiesExceptionCases() {
          return [
            { name: 'textcolor', title: _, inputType: 'colorPicker', iconSvgCode: c, dataName: 'text-color', undoText: u },
            { name: 'profitBackground', title: x, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: h },
            { name: 'stopBackground', title: S, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: h }
          ]
        }
        _rangeExceptionCases() {
          return [
            { name: 'linecolor', inputType: 'colorPicker', iconSvgCode: a, title: g, dataName: 'line-tool-color', undoText: d },
            {
        ...
        _notePropertiesExceptionCases() {
          return [
            { name: 'markerColor', title: P, inputType: 'colorPicker', iconSvgCode: a, dataName: 'line-tool-color', undoText: d },
            { name: 'textColor', title: _, inputType: 'colorPicker', iconSvgCode: c, dataName: 'text-color', undoText: u },
            { name: 'fontSize', title: w, inputType: 'combobox', factory: L.prototype._createFontSizeButton }
          ]
        }
        _createToolExceptionCases() {
          return {
            ...
            LineToolBarsPattern: [
              { name: 'color', title: g, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: d }
            ],
            LineToolProjection: [
              { name: 'color1', title: E, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: h },
              { name: 'color2', title: W, inputType: 'colorPicker', iconSvgCode: l, dataName: 'background-color', undoText: h },
              { name: 'linesWidths', inputType: 'combobox', factory: L.prototype._createWidthsButton }
            ],
            LineToolSignpost: [
              {
