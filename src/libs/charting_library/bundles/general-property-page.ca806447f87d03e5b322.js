    ...
    73023: (e, t, i) => {
      ...
      function kt(e, t, o, s, c, d, u, h, p, v) {
        const g = [],
          ...
          V = (0, y.createWVFromGetterAndSubscription)(() => 1 !== e.model().panes().length, e.model().panesCollectionChanged()),
        ...
        return (
          m.length > 0 &&
            G.push((0, a.createPropertyDefinitionsGeneralGroup)(m, 'rightMarginsAppearanceGroup', r.t(null, void 0, i(40187)))),
          { definitions: G }
        )
      }
      let Lt = i(15879),
      ...
      n.enabled('symbol_info_long_description') &&
        Xt.push({ id: 'symbol-text-source-long-description', value: 'long-description', title: r.t(null, void 0, i(96073)) })
      class Yt {
        constructor(e, t, i) {
        ...
        _createLegendPropertyPage() {
          const e = this._chartWidgetProperties.childs().paneProperties.childs().legendProperties.childs(),
            ...
            o = (function (e, t, o, n, s) {
              ...
              d.push(h)
              const p = (0, y.combineProperty)((e) => 12 !== e, e.mainSeries().properties().childs().style.weakReference()),
              ...
              z.push(I, q),
                c.push((0, a.createPropertyDefinitionsGeneralGroup)(z, 'studiesLegendVisibilityGroup', r.t(null, void 0, i(61142)), J))
              const K = [],
              ...
              return K.push(Q), c.push((0, a.createPropertyDefinitionsGeneralGroup)(K, 'generalLegendGroup')), { definitions: c }
        ...
        _createScalesDefinitions() {
          ...
          return (function (e, t, i, o) {
            ...
            if (o.currencyConversionEnabled || o.unitConversionEnabled) {
              const t = o.currencyConversionEnabled && o.unitConversionEnabled ? Ve : o.currencyConversionEnabled ? _e : De,
            ...
            const g = (0, a.createOptionsPropertyDefinition)(
                ...
                { id: 'autoLogButtonsVisibility', title: Te, options: new l.WatchedValue((0, J.autoLogButtonsVisibilityOptions)()) }
              ),
            ...
            return u.length > 0 && s.push((0, a.createPropertyDefinitionsGeneralGroup)(u, 'scalesTimeScaleGroup', Oe)), { definitions: s }
