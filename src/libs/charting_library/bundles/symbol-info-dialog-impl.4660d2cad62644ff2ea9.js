  ...
  [9374],
  {
    ...
    36383: (e, t, r) => {
      ...
      let o = r(50959),
        n = r(27267)
      function i(e) {
        const { click: t, mouseDown: r, touchEnd: i, touchStart: a, handler: s, reference: l, ownerDocument: u = document } = e,
          c = (0, o.useRef)(null),
    ...
    95257: (e, t) => {
      'use strict'
      let r = Symbol.for('react.element'),
      ...
      ;(t.Children = {
        ...
        (t.cloneElement = function (e, t, o) {
          ...
          let n = _({}, e.props),
            ...
            s = e._owner
          if (null != t) {
            if ((void 0 !== t.ref && ((a = t.ref), (s = g.current)), void 0 !== t.key && (i = '' + t.key), e.type && e.type.defaultProps))
    ...
    18510: (e, t, r) => {
      ...
      function T(e) {
        ...
        return n.createElement('div', { className: b(k.header, e.className), 'data-dragg-area': !0, ref: e.reference }, e.children, t)
      }
      r(17817)
      let M = r(71425)
      function z(e) {
        ...
        render() {
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement('div', { className: x.content, 'data-symbol-info-dialog-content': !0 }, this._renderFields())
            )
          )
        }
        _renderFields() {
      ...
      function R(e) {
        return O(e) && void 0 !== e.pricescale
          ? new m.PriceFormatter(e.pricescale / (0, i.ensureDefined)(e.minmove2)).format((0, i.ensureDefined)(e.minmove2) / e.pricescale)
          : null
      }
      function F(e) {
        ...
        if (n && o && t)
          return i
            ? l.t(null, { context: 'double fractional tick size', replace: { minmove2: String(i), pricescale: String(o / i) } }, r(72653))
            : `${t}/${o}`
      ...
      function K(e) {
        let t, r, o
        return null !==
          (o = null !== (r = null === (t = e.source2) || void 0 === t ? void 0 : t.description) && void 0 !== r ? r : e.source) &&
          void 0 !== o
          ? o
          : null
      }
      ...
      function G(e, t) {
        ...
        const n = t && t.symbolInfo,
          a = [
            { title: l.t(null, void 0, r(35383)), propName: (0, p.enabled)('charting_library_base') ? 'name' : 'pro_name' },
            { title: l.t(null, void 0, r(28174)), propName: 'description' },
            { title: l.t(null, void 0, r(90656)), propName: 'type', getter: B },
            { title: l.t(null, void 0, r(49263)), propName: 'expiration', visibility: $, formatter: _.bind(null, t.dateFormatter) },
        ...
        const d = n ? te(n, a) : 0,
          h = {
            isOpened: !0,
            onClose: () => {
              Q({ isOpened: !1, onClose: () => {}, fields: [] }), o.unmountComponentAtNode((0, i.ensureNotNull)(Y)), (Y = null)
            },
            fields: a
          }
        if (d < a.length) {
