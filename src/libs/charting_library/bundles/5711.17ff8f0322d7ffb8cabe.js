  ...
  [5711],
  {
    ...
    35057: (e, t, r) => {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            i &&
              ...
              n.createElement(
                'button',
                { className: C.close, onClick: a, onKeyDown: l, 'data-name': 'close', 'aria-label': v, type: 'button', ref: m },
      ...
      class B extends n.PureComponent {
            ...
            (this._handleKeyDown = (e) => {
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, a.hashFromEvent)(e))) {
                  ...
                  if (null !== r) {
                    if (
                      (e.preventDefault(), 'true' === (t = r).getAttribute('data-haspopup') && 'true' !== t.getAttribute('data-expanded'))
                    )
                      return void this._handleClose()
                    if ((0, c.isTextEditingField)(r)) return void n.focus()
                    if (n.contains(r)) return this.props.onKeyboardClose && this.props.onKeyboardClose(), void this._handleClose()
                  }
                }
                let t, r
                ;(function (e) {
        ...
        componentDidMount() {
          let e, t
          this.props.ignoreClosePopupsAndDialog || f.subscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          let e, t
          this.props.ignoreClosePopupsAndDialog || f.unsubscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
      ...
      function d(e) {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement('div', { className: i()(u.title, m && !f && u.active, b && u.mobile), 'data-name': 'list-item-title' }, t),
    ...
    96040: (e, t, r) => {
      ...
      let n = r(44352),
        ...
        l = r(27306)
      function c(e) {
        const { className: t, isActive: c, onClick: u, onMouseDown: d, title: h, hidden: p, 'data-name': v = 'remove-button', ...m } = e
        return o.createElement(s.Icon, {
          ...m,
          'data-name': v,
