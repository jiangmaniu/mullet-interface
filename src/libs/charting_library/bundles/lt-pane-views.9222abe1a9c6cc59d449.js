;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1583],
  {
      ...
      class x extends _.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const i = this._source.priceScale(),
            r =
              null !== (t = null === (e = this._source.ownerSource()) || void 0 === e ? void 0 : e.firstValue()) && void 0 !== t ? t : null
      ...
      t.LineToolCircleLinesPaneView = class extends r {
        ...
        _updateImpl() {
          if ((super._updateImpl(), (this._renderer = null), !(this._source.points().length < 2))) {
            let e = this._model.timeScale()
            if (this._source.priceScale() && !this._source.priceScale().isEmpty() && !e.isEmpty()) {
              let t = this._source.points()[0],
                i = this._source.points()[1],
                r = i ? i.index - t.index : 1
              if (((this._lines = []), 0 !== r)) {
                let o = e.visibleBarsStrictRange()
                if (r > 0) for (var h = t.index; h <= o.lastBar(); h += r) this._lines.push({ x: e.indexToCoordinate(h) })
                ...
                if (!(this._points.length < 2)) {
                  ...
                  let _ = this._model.timeScale().width(),
                  ...
                  if (2 === this._source.points().length) {
                    let x = [].concat(this._points)
                    c.append(this.createLineAnchor({ points: x }, 0))
                  } else
                    c.append(
                      this.createLineAnchor(
                        { points: [new n(this._points[0].x, this._source.priceScale().height() / 2)], hittestResult: a.MovePoint },
                        1
                      )
                    )
                  this._renderer = c
      ...
      class b extends x.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          V &&
            ...
            ((this._pipFormatter = new g.PipFormatter(V.pricescale, V.minmov, V.type, V.minmove2, V.typespecs)), (this._lastSymbolInfo = V))
        ...
        _updateImpl(e, t) {
          ...
          if (null !== x) {
            ...
            if (i.visible.value()) {
              ...
              let m
              null !== f && (u.append(f), (m = null !== (a = (0, h.getTextBoundaries)(f, t, e)) && void 0 !== a ? a : void 0))
              const w = {
                points: [r, o],
                color: i.color.value(),
                linewidth: p.levelsStyle.childs().linewidth.value(),
    ...
    13616: (e, t, i) => {
      ...
      let s = i(99031).TrendLineRenderer,
            ...
            for (var s = this._source.properties(), c = this._source.levelsCount(), u = 1; u <= c; u++) {
              ...
              if (p.visible.value()) {
                ...
                f.push(new n(this._center.x - 0.5 * i * _, this._center.y - 0.5 * r * _)),
                  f.push(new n(this._center.x + 0.5 * i * _, this._center.y + 0.5 * r * _))
                let v = new n(this._center.x, this._center.y + 0.5 * r * _)
                this._levels.push({
                  color: g,
                  points: f,
                  labelPoint: v,
            ...
            if (!(this._points.length < 2)) {
              ...
              for (u = 0; u < this._levels.length; u++) {
                ...
                ;(y.points = R.points),
                  ...
                  (y.fillBackground = m),
                  (y.transparency = w)
                let T = new o(a.MovePoint, null, R.index)
                x.append(new d(y, T))
        ...
        _updateImpl(e, t) {
          ...
          for (let o = 0; o < this._levels.length; o++) {
            ...
            if (p.showLabels.value()) {
              ...
              this._needLabelExclusionPath(h) && (a = null !== (i = (0, s.getTextBoundaries)(h, t, e)) && void 0 !== i ? i : void 0),
          ...
          2 === this._source.points().length
            ...
            : this._points.length > 0 &&
              this._renderer.append(
                this.createLineAnchor({ points: [new n.Point(this._points[0].x, e / 2)], hittestResult: l.HitTarget.MovePoint }, 0)
              )
        }
        _needLabelExclusionPath(e) {
        ...
        _updateImpl() {
          if ((super._updateImpl(), (this._renderer = null), (this._levels = []), this._points.length < 3)) this._updateRenderer()
            ...
            o.dotProduct(l) < 0 && (h = 2 * Math.PI - h),
              ...
              Math.abs(d - h) > Math.PI && ((this._edge1 = Math.min(d, h)), (this._edge2 = Math.max(d, h) - 2 * Math.PI))
            for (let c = this._source.properties(), u = 1; u <= this._source.levelsCount(); u++) {
              let p = c['level' + u]
              if (p.visible.value()) {
                let _ = p.coeff.value(),
                  g = p.color.value(),
        ...
        _updateImpl() {
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              if ((this._trendLineRendererPoints12.setData(g(e, t)), s.append(this._trendLineRendererPoints12), 2 === this._points.length))
      ...
      t.GannSquarePaneView = class extends r {
        ...
        _updateImpl() {
          if (
            ...
            this._vlevels = []
            let x = i ? e.index - t.index : t.index - e.index,
              m = i ? t.index : e.index
            for (p = 1; p <= 7; p++) {
              var w
            ...
            let Y = new n(this._points[0].x, this._points[1].y)
            Y.data = 2
            let j = new n(this._points[1].x, this._points[0].y)
    ...
    46258: (e, t, i) => {
      'use strict'
      let n = i(79191).LineSourcePaneView,
        r = i(47043),
      ...
      class f extends h {
        ...
        _bodyWidth(e) {
          if (0 === this._adapter.getText().length) return 0
          e.save(), (e.font = this._adapter.getBodyFont())
          let t = e.measureText(this._adapter.getText()).width
          return e.restore(), Math.round(10 + t)
        }
        _getQuantity() {
          let e = this._adapter.getQuantity()
          return isNaN(e) ? e : a(this._adapter.getQuantity(), ' ')
        }
        _quantityWidth(e) {
          if (0 === this._getQuantity().length) return 0
          e.save(), (e.font = this._adapter.getQuantityFont())
          let t = e.measureText(this._getQuantity()).width
          return e.restore(), Math.round(Math.max(this._height(), 10 + t))
        }
        _reverseButtonWidth() {
        ...
        _drawQuantityText(e, t, i) {
          e.save(),
            ...
            (e.font = this._adapter.getQuantityFont()),
            (e.fillStyle = this._adapter.getQuantityTextColor())
          let n = t + this._quantityWidth(e) / 2,
            r = i + this._height() / 2
        ...
        _drawReverseButton(e, t, i) {
          ...
          let n = this._reverseButtonWidth(),
            r = this._height()
        ...
        _drawCloseButton(e, t, i) {
          ...
          let n = this._closeButtonWidth(),
            r = this._height()
          e.fillRect(t + 0.5, i + 0.5, n - 1, r - 1), e.strokeRect(t, i, n, r)
          let s = t + n,
            o = i + r
          e.strokeStyle = this._adapter.getCloseButtonIconColor()
          let a = (this._closeButtonWidth() - 8) / 2,
            l = (this._height() - 8) / 2
          _(
            e,
            [
        ...
        _drawImpl(e) {
          ...
          let d = Math.round(this._data.points[0].y),
      ...
      class C extends T {
        ...
        drawBalloon(e, t, i, r, s, o) {
          ...
          if ((e.beginPath(), 'down' === s)) {
            let l = new n(t.x - a, t.y - this._arrowOffset - this._arrowHeight - r)
            return (
          ...
          let d = new n(t.x - a, t.y + this._arrowOffset + this._arrowHeight + r)
          return (
        ...
        drawTargetLabel(e) {
          e.save(), e.translate(0.5, 0.5)
          let t = y(this._targetFontSize1, this._font, 'normal'),
          ...
          e.font = t
          let l = e.measureText(r).width,
            d = e.measureText(s).width,
            h = e.measureText(' ').width
          e.font = n
          let c = e.measureText(o).width,
          ...
          let I = L + this._targetFontSize1 + 3,
            A = m(e, S - u - _ - p)
          e.fillText(o, P + A, I)
          let k = m(e, S - c - p - _ - u)
            ...
            ;(e.fillStyle = B),
              'up' === this._data.direction
                ...
                : (R(e, b.x - 1, b.y + this._targetHeight + 2, this._targetWidth + 2, H, 5),
                  ...
                  E && e.drawImage(E, b.x + V - E.width - 4, b.y + this._targetHeight + 10 - Math.abs(H - E.height) / 2)),
              e.restore()
          } else e.restore()
        }
        drawStartLabel(e) {
          e.save(), e.translate(0.5, 0.5)
          let t = y(this._sourceFontSize1, this._font, 'normal'),
            i = y(this._sourceFontSize2, this._font, 'normal')
          e.font = t
          let n = e.measureText(this._data.sourceLine1).width
          e.font = i
          let r = e.measureText(this._data.sourceLine2).width
          ;(this._sourceWidth = Math.max(n, r) + 6 + 4), (this._sourceHeight = this._sourceFontSize1 + this._sourceFontSize2 + 6 + 4)
          let s = this._data.points[0],
            o = s.x + this._sourceWidth - e.canvas.width + 5
          this._sourceRectLeftOffset = Math.max(20, Math.min(this._sourceWidth - 15, o))
          let a = this.drawBalloon(e, s, this._sourceWidth, this._sourceHeight, this._data.direction, this._sourceRectLeftOffset)
          ...
          let l = m(e, this._sourceWidth - 6 - 4),
            d = 2 + a.x + 3 + l,
            h = 2 + a.y + 2
          ;(e.font = t),
        ...
        _drawImpl(e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            let s = Math.max(8, 4 * this._data.linewidth)
            t.fillStyle = this._data.color
            let o = r.y < 0 ? 1 : -1
            if (Math.abs(r.x) < 1 || Math.abs(r.y) < 1) var a = Math.atan(r.x / r.y)
              ...
              if (r.length() > s)
                for (;;) {
                  ...
                  let g = Math.sqrt((l - h) * (l - h) + (d - c) * (d - c))
        ...
        targetLabelHitTest(e) {
          ...
          let i = 'up' === this._data.direction ? -1 : 1,
            n = this._radius,
        ...
        sourceLabelHitTest(e) {
          ...
          let t = 'up' === this._data.direction ? 1 : -1,
            i = this._radius,
        ...
        hitTest(e) {
          ...
          let c = this.targetLabelHitTest(e)
      ...
      t.PredictionPaneView = class extends r {
        ...
        _updateImpl() {
          if (
            ...
            let e = this._source.ownerSource().formatter(),
              t = this._source.points()[1],
              n = this._source.points()[0]
            this._targetLine3 = P(e.format(t.price))
            let r = t.price - n.price,
            ...
            let h = this._model.mainSeries().isDWM(),
            ...
            let w = this._model.timeScale().indexToUserTime(n.index)
      ...
      class v extends g {
        ...
        _drawImpl(e) {
          if (null !== this._data && null !== this._points && 0 !== this._points.length) {
            ...
            let i = t.measureText(this._data.label)
        ...
        hitTest(e) {
          ...
          let t = this._points[0].x - this._measureCache.tailLeft,
      ...
      t.PriceLabelPaneView = class extends a {
        ...
        _updateImpl() {
          if ((super._updateImpl(), (this._renderer = null), this._source.points().length > 0)) {
            let e = this._source.points()[0].price,
              t = this._source.priceScale()
            if (!t || t.isEmpty()) return
            let i = this._source.ownerSource().firstValue()
    ...
    75219: (e, t, i) => {
      'use strict'
      let n = i(81139).ArcWedgeRenderer,
      ...
      t.ProjectionLinePaneView = class extends r {
        constructor(e, t) {
          super(e, t), (this._baseTrendRenderer = new s()), (this._edgeTrendRenderer = new s()), (this._arcWedgeRenderer = new n())
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer
        }
      ...
      class A extends o.LineSourcePaneView {
        ...
        _creareMiddleLabel(e, t, i) {
          ...
          return (
            ...
            this._addCenterLabel(t, this._middleLabelRenderer, { p: f, txt: v, color: T, vertAlign: 'middle', offsetY: 0, border: 'white' })
          )
        }
        _createStopLabel(e, t) {
          ...
          const v = u.formatter(),
            m =
              null !== (s = null === (i = v.formatChange) || void 0 === i ? void 0 : i.call(v, Math.max(o, a), Math.min(o, a))) &&
              void 0 !== s
                ? s
                : v.format(p),
        ...
        _createTargetLabel(e, t) {
          ...
          const m = p.formatter(),
            w =
              null !== (s = null === (i = m.formatChange) || void 0 === i ? void 0 : i.call(m, Math.max(o, a), Math.min(o, a))) &&
              void 0 !== s
                ? s
                : m.format(_),
          ...
          e.moveTo(a, Math.round(x(this._data) * r)),
            ...
            void 0 !== this._data.plate &&
              (function (e, t, i, n, r) {
                ...
                if (
                  ((e.lineWidth = v), e.beginPath(), e.arc(_, g, x, 0, 2 * Math.PI, !0), e.closePath(), e.stroke(), i.outsideBorderWidth)
                ) {
                  e.save()
    ...
    5362: (e, t, i) => {
      ...
      class d extends o.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          return (
            (n = this._data.point.y + n + this._data.height / 2), Math.abs(n - e.y) <= 3 ? new a.HitTestResult(a.HitTarget.MovePoint) : null
          )
        }
        _drawImpl(e) {
          const t = e.context
    ...
    44666: (e, t, i) => {
      ...
      class r extends n.LineSourcePaneView {
        renderer() {
          return (
            this._invalidated && (this._updateImpl(), (this._invalidated = !1)), this.createLineAnchor({ points: this._getPoints() }, 0)
          )
        }
      }
    },
        ...
        _updateImpl(e, t) {
          ...
          for (let o = 0; o < this._levels.length; o++) {
            ...
            if (m) {
              ...
              this._needLabelExclusionPath(d) && (a = null !== (i = (0, s.getTextBoundaries)(d, t, e)) && void 0 !== i ? i : void 0),
                u.append(d)
            }
            const d = {
                x: this._levels[o].x,
      ...
      class H {
        ...
        updateSource(e, t) {
          ...
          if (void 0 === r) {
            ...
            ;(r = { effectiveState: null, rowIndex: e, width: 0 }), this._sourcesToRow.set(n, r), this._rowsToSources.set(e, n)
          }
      ...
      class V extends A.AlertableLineSourcePaneView {
        ...
        _statLabelData() {
          ...
          if (g || f || v) {
            if (
              ((l = ''),
              g && ((h = t.index - e.index), (l += o.t(null, void 0, i(33355)).format({ count: (0, a.forceLTRStr)(String(h)) }))),
              f)
            ) {
      ...
      class o extends s.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            if (
              (t.arc(this._data.center.x, this._data.center.y, this._data.prevRadius, this._data.edge2, this._data.edge1, !1),
              this._data.gradient)
            ) {
    ...
    23966: (e, t, i) => {
      ...
      function v(e, t, i) {
        return null !== e
          ? (0, l.intersectPolygonAndHalfplane)(e, (0, s.halfplaneThroughPoint)(((n = t), (0, s.line)(1, 0, -n)), new s.Point(i, 0)))
          : null
        let n
      }
      function x(e, t) {
    ...
    28621: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          else if ((this._data.skipLines || this._extendAndDrawLineSegment(t, i, n, e.mediaSize), 4 === this._data.points.length)) {
      ...
      class c extends s.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          i.beginPath(),
            ...
            i.lineTo(o.x, o.y),
            i.lineTo(r.x, r.y),
            this._data.fillBackground && ((i.fillStyle = (0, a.generateColor)(this._data.backcolor, this._data.transparency)), i.fill()),
            i.stroke()
        }
      }
    },
