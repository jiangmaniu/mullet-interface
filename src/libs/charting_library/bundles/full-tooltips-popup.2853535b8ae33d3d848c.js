            ...
            n.createElement(
              ...
              u || c
                ? n.createElement(
                    ...
                    n.createElement(
                      'span',
                      { className: r(!u && c && d().ellipsisContainer, u && d().textWrapContainer, u && c && d().textWrapWithEllipsis) },
                      m
                    ),
                    n.createElement('span', { className: d().visuallyHidden, 'aria-hidden': !0 }, m)
                  )
                : n.createElement(n.Fragment, null, m, n.createElement('span', { className: d().visuallyHidden, 'aria-hidden': !0 }, m))
            ),
          ...
          Array.isArray(e) || (0, n.isValidElement)(e)
            ? n.Children.toArray(e)
                .reduce((e, t) => {
                  let o = ''
                  return (
                    (o = (0, n.isValidElement)(t) && r(t) ? s(t.props.children) : (0, n.isValidElement)(t) && !r(t) ? '' : i(t)),
                    e.concat(o)
                  )
                }, '')
                .trim()
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(h, { className: i(v.drawer, u[`position${t}`], m), ref: y, 'data-name': e['data-name'] }, d)
            )
          )
        )
      }
          ...
          return (
            void 0 !== e.additionalWidgets &&
              (b = e.additionalWidgets.map(
                (e) => (w.has(e) || w.set(e, (0, c.randomHash)()), e.renderer((0, u.ensureDefined)(w.get(e)), f.additionalWidget))
              )),
            n.createElement(
              'div',
