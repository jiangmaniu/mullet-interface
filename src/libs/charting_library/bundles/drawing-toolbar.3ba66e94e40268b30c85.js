  ...
  [2878],
  {
                ...
                ;(l = [].concat(t(l), [h])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(o.target) &&
                        ((n && 0 === n.scrollTop && 0 < l) || ((i = n) && i.scrollHeight - i.scrollTop <= i.clientHeight && l < 0)
                          ? d(o)
                          : o.stopPropagation()))
                  }),
            ...
            (e.enableBodyScroll = function (e) {
              if (i) {
                ...
                ;(e.ontouchstart = null),
                  ...
                  s && 0 === l.length && (document.removeEventListener('touchmove', d, o ? { passive: !1 } : void 0), (s = !1))
              } else
            ...
            if (s.CheckMobile.iOS())
              return (
                ...
                () => {
                  r--,
                    null !== c.current &&
                      (a ? 0 === r && (document.body.style.overscrollBehavior = '') : (0, i.enableBodyScroll)(c.current))
                }
              )
          }, []),
    ...
    37159: (e, t, o) => {
      ...
      class y extends n.PureComponent {
        ...
        render() {
          const { children: e, isVisibleScrollbar: t, isVisibleFade: o, isVisibleButtons: i, onMouseOver: l, onMouseOut: s } = this.props,
          ...
          return n.createElement(x.Measure, { onResize: this._handleResizeWrap }, (h) =>
            n.createElement(
              ...
              n.createElement(
                'div',
                { className: a()(E.scrollWrap, { [E.noScrollBar]: !t }), onScroll: this._handleScroll, ref: (e) => (this._scroll = e) },
              ...
              i &&
                n.createElement(
                  ...
                  n.createElement('div', { className: E.iconWrap }, n.createElement(w.Icon, { icon: k, className: E.icon }))
                ),
              i &&
                n.createElement(
                  'div',
      ...
      const $ = [
        ...
        le = new Set(ie)
      const se = [
          { title: W.t(null, { context: 'emoji_group' }, o(88906)), emojis: [], content: n.createElement(P.IconItem, { icon: Q }) },
          { title: W.t(null, { context: 'emoji_group' }, o(51853)), emojis: $, content: n.createElement(P.IconItem, { icon: Y }) },
          { title: W.t(null, { context: 'emoji_group' }, o(33282)), emojis: te, content: n.createElement(P.IconItem, { icon: K }) },
          { title: W.t(null, { context: 'emoji_group' }, o(10522)), emojis: oe, content: n.createElement(P.IconItem, { icon: q }) },
          { title: W.t(null, { context: 'emoji_group' }, o(14143)), emojis: X, content: n.createElement(P.IconItem, { icon: G }) },
          { title: W.t(null, { context: 'emoji_group' }, o(98355)), emojis: ne, content: n.createElement(P.IconItem, { icon: J }) },
          { title: W.t(null, { context: 'emoji_group' }, o(74245)), emojis: ee, content: n.createElement(P.IconItem, { icon: Z }) }
        ],
        ae = { [I.Icons]: U.drawingToolsIcons.heart, [I.Emojis]: U.drawingToolsIcons.smile, [I.Stickers]: U.drawingToolsIcons.sticker },
        re = [
          {
            title: I.Emojis,
      ...
      const be = o(11121),
        fe = (0, n.forwardRef)((e, t) => {
            ...
            n.createElement(
              'div',
              {
                ...
                onKeyDown: function (e) {
                  ...
                  e.preventDefault(), P(!1), S && (null === (t = null == H ? void 0 : H.current) || void 0 === t || t.focus())
                },
                ref: B
              },
              n.createElement(
          ...
          function K() {
            D.current &&
              (clearTimeout(D.current), (D.current = 0), y ? P(!1) : g || y || r.mobiletouch || (!h && !C) ? !N.current && f && f() : P(!0))
          }
        })
      var Te = o(38297),
        we = o(85034),
      ...
      const Ne = new Set(Be)
      const De = [
          { title: W.t(null, { context: 'emoji_group' }, o(88906)), emojis: [], content: n.createElement(P.IconItem, { icon: Ie }) },
      ...
      function tt(e) {
        ...
        return n.createElement(
          fe,
          {
            ...
            onClickWhenGrayed: () => (0, h.emit)('onGrayedObjectClicked', { type: 'drawing', name: p.lineToolsInfo[r].localizedName }),
      ...
      class pt extends n.PureComponent {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              s.map((s, a) => {
                ...
                const { name: h } = s,
                  m =
                    null === (d = null === (u = p.lineToolsInfo[h]) || void 0 === u ? void 0 : u.selectHotkey) || void 0 === d
                      ? void 0
                      : d.hash,
                  v = p.lineToolsInfo[h],
                  g = l[h]
        ...
        _getActiveToolName() {
          var e
          return null === (e = this.props.lineTools.find((e) => gt(e) && e.name === d.tool.value())) || void 0 === e ? void 0 : e.name
        }
        async _selectTool(e) {
          d.tool.setValue(e)
        }
      ...
      class xt extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleRemoveAll = () => {
              Et('remove all'), this.props.chartWidgetCollection.activeChartWidget.value().removeAllStudiesDrawingTools()
            }),
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(dt.AccessibleMenuItem, { 'data-name': 'remove-all', label: c, onClick: this._handleRemoveAll, theme: e })
          )
        }
        _handleArrowClick() {
          kt('menu')
      ...
      const At = {
        drawings: { active: U.drawingToolsIcons.hideAllDrawingToolsActive, inactive: U.drawingToolsIcons.hideAllDrawingTools },
        indicators: { active: U.drawingToolsIcons.hideAllIndicatorsActive, inactive: U.drawingToolsIcons.hideAllIndicators },
        positions: { active: U.drawingToolsIcons.hideAllPositionsToolsActive, inactive: U.drawingToolsIcons.hideAllPositionsTools },
        all: { active: U.drawingToolsIcons.hideAllDrawingsActive, inactive: U.drawingToolsIcons.hideAllDrawings }
      }
      function Bt(e) {
        const { isSmallTablet: t } = e,
          [{ isActive: i, hideMode: s }, a] = (0, n.useState)(() => ({ isActive: !1, hideMode: (0, Ft.getSavedHideMode)() }))
        ;(0, n.useEffect)(
          () => (
      ...
      function Ut(e) {
        ...
        function s(e) {
          void 0 !== e &&
            ((0, bt.trackEvent)('GUI', 'Magnet mode', e === Ot.MagnetMode.WeakMagnet ? 'Weak' : 'Strong'), (0, Pt.setMagnetMode)(e))
        }
      }
      var Zt
      !(function (e) {
        ...
        so = (0, n.forwardRef)((e, t) => {
          ...
          return n.createElement(
            'button',
            {
              ...
              className: s(io.toggleButton, 'apply-common-tooltip common-tooltip-vertical', !o && io.collapsed, io.accessible),
              onClick: function () {
        ...
        constructor(e) {
          ...
          super(e),
            ...
            this._filteredLineTools.forEach((e) => {
              e.items.forEach((e) => {
                'title' in e || (this._grayedTools[e.name] = this._toolsFilter.isToolGrayed(p.lineToolsInfo[e.name].localizedName))
              })
            }),
            (this.state = {
              isHovered: !1,
        ...
        componentDidMount() {
          ...
          T.isDrawingToolbarVisible.subscribe(this._handleChangeVisibility),
            ...
            this.props.widgetbarSettled &&
              ...
              v.CheckMobile.any() &&
                (null === (e = window.widgetbar) || void 0 === e || e.visible().subscribe(this._handleWidgetbarVisible)))
        }
        componentWillUnmount() {
          var e
                      ...
                      n.createElement(
                          ...
                          n.createElement(
                            ...
                            this._filteredLineTools.map((o) =>
                              n.createElement(pt, {
                                ...
                                favoriting:
                                  this._features.favoriting && !('linetool-group-cursors' === o.id && (0, g.isOnMobileAppPage)('any')),
                        ...
                        !o &&
                          ...
                          n.createElement(
                            'div',
                            { className: mo.group, style: a },
                            n.createElement(xt, { chartWidgetCollection: t, isSmallTablet: e, toolName: 'removeAllDrawingTools' })
                          ),
                        ...
                        !o &&
                          ...
                          n.createElement(
                            ...
                            !1,
                            this._features.tools && this._features.favoriting && n.createElement(Vt, { id: Zt.FavoriteDrawings }),
                            h() &&
                              n.createElement(B, { id: Zt.ObjectTree, action: this._handleObjectsTreeClick, toolName: 'showObjectsTree' })
                          )
                      )
                    )
                  )
      ...
      const a = [
        {
          ...
          items: [{ name: 'cursor' }, { name: 'dot' }, { name: 'arrow' }, { name: 'eraser' }, null].filter(s.isExistent),
          trackLabel: null
        },
        {
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [{ name: 'LineToolAnchoredVWAP' }, { name: 'LineToolFixedRangeVolumeProfile' }, null].filter(s.isExistent)
            },
            {
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [!(0, i.onWidget)() && l.enabled('image_drawingtool') ? { name: 'LineToolImage' } : null, null, null].filter(
                s.isExistent
              )
            }
          ],
