          ...
          if ('price' === e.type) {
            ...
            if (null !== i) {
              ...
              const n = this._editable
                ? new s.HitTestResult(s.HitTarget.MovePoint, { cursorType: o.PaneCursorType.VerticalResize, activeItem: e })
                : null
            ...
            if (null !== i) {
              ...
              t.setData({ ...d, x: i })
              const n = this._editable
                ? new s.HitTestResult(s.HitTarget.MovePoint, { cursorType: o.PaneCursorType.HorizontalResize, activeItem: e })
                : null
              return t.setHitTest(n), t
            }
          }
