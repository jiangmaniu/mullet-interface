        ...
        function () {
          ...
          ;(l = function () {}),
              ...
              return (
                ...
                (s.prototype.defaultOptions = {
                  ...
                  uploadprogress: function (e, t, i) {
                    var n, s, r, o, l
                    if (e.previewElement) {
                      for (l = [], s = 0, r = (o = e.previewElement.querySelectorAll('[data-dz-uploadprogress]')).length; s < r; s++)
                ...
                (t = function () {
                  var e, t, i, n, s, r, o
                  for (n = arguments[0], r = 0, o = (i = 2 <= arguments.length ? u.call(arguments, 1) : []).length; r < o; r++)
                    ...
                    'form' === this.element.tagName && this.element.setAttribute('enctype', 'multipart/form-data'),
                      this.element.classList.contains('dropzone') &&
                        ...
                        this.element.appendChild(
                          s.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + '</span></div>')
                        ),
                ...
                (s.prototype.paste = function (e) {
                  ...
                  if (null != (null != e && null != (i = e.clipboardData) ? i.items : void 0))
                    return this.emit('paste', e), (t = e.clipboardData.items).length ? this._addFilesFromItems(t) : void 0
                }),
                ...
                (s.prototype.cancelUpload = function (e) {
                  ...
                  if (e.status === s.UPLOADING) {
                    ...
                    ((a = e.status) !== s.ADDED && a !== s.QUEUED) ||
                      ((e.status = s.CANCELED), this.emit('canceled', e), this.options.uploadMultiple && this.emit('canceledmultiple', [e]))
                ...
                (s.prototype.uploadFiles = function (e) {
                  var i, r, o, l, a, u, p, d, c, h, m, f, g, v, y, F, w, E, b, C, k, z, L, x, A, T, D, S, _, M, U, N, I, R, P
                  ...
                  (o = function () {
                    ...
                    for (s = [], t = 0, n = e.length; t < n; t++)
                      (i = e[t]), s.push(P._errorProcessing(e, y || P.options.dictResponseError.replace('{{statusCode}}', b.status), b))
                    return s
                  }),
                  (F = (function (t) {
                    return function (n) {
                      ...
                      for (c = [], a = 0, d = e.length; a < d; a++) (i = e[a]), c.push(t.emit('uploadprogress', i, r, i.upload.bytesSent))
                      return c
                    }
                  })(this)),
                  (b.onload = (function (t) {
                  ...
                  if (((r = new FormData()), this.options.params)) for (m in (M = this.options.params)) (E = M[m]), r.append(m, E)
                  ...
                  if ((this.options.uploadMultiple && this.emit('sendingmultiple', e, b, r), 'FORM' === this.element.tagName))
                    for (z = 0, T = (U = this.element.querySelectorAll('input, textarea, select, button')).length; z < T; z++)
                      if (
                      ...
                      else (!h || ('checkbox' !== (I = h.toLowerCase()) && 'radio' !== I) || d.checked) && r.append(c, d.value)
            ...
            (t.isBrowserSupported = function () {
              var e, i, n, s
              if (
                ((e = !0), window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector)
              )
                if ('classList' in document.createElement('a'))
                  for (i = 0, n = (s = t.blacklistedBrowsers).length; i < n; i++) s[i].test(navigator.userAgent) && (e = !1)
                else e = !1
              else e = !1
              return e
            }),
              ...
              if (
                ...
                (r = function (i) {
                  if ('readystatechange' !== i.type || 'complete' === n.readyState)
                    return ('load' === i.type ? e : n)[a](l + i.type, r, !1), !s && (s = !0) ? t.call(e, i.type || i) : void 0
                }),
                (o = function () {
                  try {
                    u.doScroll('left')
