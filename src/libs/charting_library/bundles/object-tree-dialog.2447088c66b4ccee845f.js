;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4862],
  {
      ...
      function h(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement('div', { className: i()(d.title, v && !g && d.active, S && d.mobile), 'data-name': 'list-item-title' }, t),
    ...
    3085: (e, t, n) => {
      ...
      var u
      !(function (e) {
        ;(e[(e.Vertical = 0)] = 'Vertical'), (e[(e.Horizontal = 1)] = 'Horizontal'), (e[(e.HorizontalRtl = 2)] = 'HorizontalRtl')
      })(u || (u = {}))
      const d = {
          0: {
            isHorizontal: !1,
    ...
    11386: (e, t, n) => {
      ...
      function N(e) {
        ...
        return (
          ...
          o.useMemo(
            () => ({ currentSymbol: i, symbolDrawingsMaps: l, removeSymbolDrawings: d, changeSymbol: p, hiddenSymbols: c }),
            [i, l, d, p, c]
          )
        )
      ...
      function k(e) {
        const { isMobile: t, isSmallWidth: r, chartWidget: i, onClose: c, onInitialized: u } = e,
          { currentSymbol: d, symbolDrawingsMaps: h, removeSymbolDrawings: f, changeSymbol: v, hiddenSymbols: g } = N(i),
          [b, S] = o.useState(null),
          [w, E] = o.useMemo(() => {
            var e
            if (null !== d && null !== h) {
              const t = []
              let n = b
              if (null === n) for (n = 2; n > 0 && !(((null === (e = h[n].get(d)) || void 0 === e ? void 0 : e.size) || 0) > 0); ) n--
              return (
                h[n].forEach((e, n) => {
                  g.includes(n) ||
                    t.push({
                ...
                t.sort((e, t) =>
                  e.drawingsCount === t.drawingsCount ? e.symbol.localeCompare(t.symbol) : e.drawingsCount > t.drawingsCount ? -1 : 1
                ),
                [t, n]
              )
            }
            ...
            0 === w.length
              ...
              : w.map(({ symbol: e, drawingsCount: r, onRemove: i, onClick: s }) => {
                  return o.createElement(p.DialogContentItem, {
                    ...
                    subtitle:
                      ((l = r),
                      a.t(null, { plural: '{drawingsCount} drawings', count: l }, n(90755)).format({ drawingsCount: l.toString() })),
                    removeBtnLabel: I,
                    isActive: e === d,
                    isMobile: t,
                    onClick: s,
    ...
    34489: (e, t, n) => {
      ...
      const Ae = (e) => e.nodes,
        ...
        qe = (0, Be.createSelector)([Ae, $e], (e, t) => t.reduce((t, n) => [...t, ...Xe(e, (0, I.ensureDefined)(n))], []))
      function Xe(e, t) {
        const n = []
      ...
      const Je = (0, Be.createSelector)([Ae, $e, Fe], (e, t, n) => {
        ...
        et = (0, Be.createSelector)([Ae, Ue, Fe], (e, t, n) => {
          const o = new Set(n)
          return [{ id: 'drag-list', level: -1, children: t }].reduce((t, n) => [...t, ...tt(e, (0, I.ensureDefined)(n), o)], [])
        })
      function tt(e, t, n) {
        const o = []
      ...
      function* rt() {
        for (;;) {
          ...
          const a = dt(t, e === ie ? 'next' : 'previous', n, l),
            { id: c } = a
          i.includes(c) && r ? (yield (0, E.put)(ke(r, !1, 1)), yield (0, E.put)(De(c))) : yield (0, E.put)(ke(c, !0, 1)),
            yield (0, E.put)(Ne(c))
        }
      }
      function* it(e, t) {
      ...
      function* st(e, t = () => !0) {
        for (;;) {
          ...
          const l = new Set(i)
          ;(i = s.reduce((e, t) => (l.has(t.id) && e.push(t.id), e), [])), e ? e(i) : yield (0, E.put)(Ee(i)), yield (0, E.put)(De(o))
        }
      }
      function* lt(e = () => !0, t) {
        ...
        u.map((e) => e.id).includes(d.id)
          ...
          : h && e(u, d, o) && (yield (0, E.put)(((e, t, n) => ({ type: le, node: e, dropType: t, boundBox: n }))(d, o, i)))
      }
      function* at(e) {
      ...
      const zt = (0, V.connect)(Pt, Ft, null, { context: Ot })(function (e) {
          ...
          return o.createElement(Bt, { ...e, connectDragSource: n, connectDropTarget: i, connectDragPreview: r, ref: t })
        }),
            ...
            ? o.createElement(
                ...
                o.createElement(
                  ...
                  t.map((e) => {
                    ...
                    return o.createElement(Wt, { id: e.id, key: e.id, nodeRenderer: r, isDragPreview: !0, isOffset: e.level > 1 })
                  })
                )
              )
            : null
      ...
      const mn = o.forwardRef(function (e, t) {
            ...
            for (let s = 0; s < r.length; s++) {
              ...
              l.isSticky && (i = l.id),
                1 === l.level &&
                  (void 0 !== n &&
                    n !== l.parentId &&
                    t.push({ type: 'separator', node: o.createElement('div', { key: n + '_separator', className: hn.separator }) }),
                  (n = l.parentId)),
                t.push({
                  type: 'node',
                  stickyNodeId: i,
        ...
        const K = (0, o.useCallback)((e) => {
          ...
          Y = (0, o.useMemo)(() => (null === g ? { index: -1 } : { index: G.current.findIndex((e) => e.node.key === g.id) }), [g])
        d(F)
        ...
        ;(0, o.useEffect)(() => (0, I.ensureNotNull)(J.current).resetAfterIndex(0, !0), [j]),
          (0, o.useEffect)(() => {
            ...
            R && e <= R && t && 'stickyNodeId' in t && t.stickyNodeId && (e -= 1), (0, I.ensureNotNull)(J.current).scrollToItem(e)
          }, [Y])
      ...
      const vn = (0, V.connect)(
          function (e) {
            return { renderList: Je(e), orderedNodes: qe(e), isMultiSelecting: Ye(e), selectedIds: Ue(e), scrollToId: ze(e) }
          },
          function (e) {
            return (0, pt.bindActionCreators)(
              {
      ...
      function bn(e) {
        ...
        return (
          ...
          (0, o.useEffect)(
            () => (null !== v && a && (p && (p.current = performance.now()), v.dispatch(((e) => ({ type: $, nodes: e }))(a))), () => {}),
            [v, a]
          ),
          (0, o.useEffect)(() => {
      ...
      !(function (e) {
        ...
        (function (e) {
          ;(e[(e.NoSync = 0)] = 'NoSync'), (e[(e.SyncInLayout = 1)] = 'SyncInLayout'), (e[(e.GlobalSync = 2)] = 'GlobalSync')
        })(On || (On = {}))
      var Fn = n(31261),
        zn = n(20723)
      function Wn(e) {
      ...
      function ro(e) {
        ...
        ;(0, o.useEffect)(() => {
          const e = {}
          u.onLockChanged().subscribe(e, () => N(u.isLocked())), u.onVisibilityChanged().subscribe(e, () => x(u.isVisible()))
        ...
        const V = Pn.enabled('test_show_object_tree_debug') ? `<${u.id()}> (${u.zOrder()}) ${u.title()}` : u.title().value(),
          G = a || P,
          K = b && s,
          U = !!v && v.isTouch,
          Z = !!v && v.isDialog,
          ...
          o.createElement(
              ...
              onClick:
                1 === g
                  ...
                  : function (e) {
                      ...
                      if (H.current) e.preventDefault(), clearTimeout(H.current), (H.current = null), m.openProperties(u), W(!1)
                      else {
            ...
            !K &&
              o.createElement(
                ...
                $,
                !1,
                o.createElement('span', { className: f(no.title, m.isMain(u) && no.main, (!u.isVisible() || !R) && no.disabled), ...j }, V),
                o.createElement(
                  'span',
        ...
        function q(e) {
          e.defaultPrevented || b || !u.fullyConstructed() || (e.preventDefault(), e.persist(), m.openContextMenu(u, () => S(!0), e))
        }
        function X() {
      ...
      class vo {
        ...
        set(e) {
          ...
          this._selectionApi.set(t.map((e) => mo(e).persistentId)), (this._selected = n), this._onChange.fire(this._selected)
        }
        ...
        buildTree() {
          ...
          for (const t of this._controller.model().panes()) {
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (r.pane() === t) {
                const o = [...n.lineTools()].sort((e, t) => (e.zorder() > t.zorder() ? -1 : 1)).map((e) => fo(e.id(), e.instanceId()))
      ...
      class Ko {
          ...
          ;(this._syncStateChanged = new ho.Delegate()),
            ...
            (0, _o.isLineTool)(t)
              ...
              ? (this._title = (0, To.createWVFromGetterAndSubscriptions)(
                  () =>
                    t.symbolTitle(No.TitleDisplayTarget.DataWindow, void 0, void 0, (0, Ct.onWidget)() ? 'exchange' : 'listed_exchange'),
        ...
        gaLabel() {
          return (0, Co.isStudy)(this._dataSource) ? 'Study' : (0, _o.isLineTool)(this._dataSource) ? 'Drawing' : 'Symbol'
        }
        canBeLocked() {
        ...
        isActualInterval() {
          return (!(0, _o.isLineTool)(this._dataSource) && !(0, Co.isStudy)(this._dataSource)) || this._dataSource.isActualInterval()
        }
        ...
        setLocked(e) {
          if ((0, _o.isLineTool)(this._dataSource)) {
            ...
            this._undoModel.setProperty(this._dataSource.properties().frozen, e, t, Eo.lineToolsDoNotAffectChartInvalidation)
          }
        }
        setName(e) {
          if ((0, _o.isLineTool)(this._dataSource)) {
            const t = Po.format({ sourceTitle: this._dataSource.properties().title.value() || Ho(this._dataSource), newSourceTitle: e })
            this._undoModel.setProperty(this._dataSource.properties().title, e, t, Eo.lineToolsDoNotAffectChartInvalidation)
          }
        }
        isCopiable() {
      ...
      class Uo {
        ...
        zOrder() {
          return (
            this._group.lineTools().length > 0 && (this._lastActualZOrder = this._group.lineTools()[0].zorder()), this._lastActualZOrder
          )
        }
        remove() {
        ...
        _insertBeforeTarget() {
          return (0, I.ensureNotNull)(this._lineTools.reduce((e, t) => (null === e ? t : e.zorder() < t.zorder() ? e : t), null))
        }
        _insertAfterTarget() {
          return (0, I.ensureNotNull)(this._lineTools.reduce((e, t) => (null === e ? t : e.zorder() > t.zorder() ? e : t), null))
        }
      ...
      class Zo {
        ...
        canBeGroupped(e) {
          ...
          const t = []
          if ((e.forEach((e) => e.addSourcesToArray(t)), t.some((e) => !(0, _o.isLineTool)(e) || !e.boundToSymbol()))) return !1
          const n = this._undoModel.model(),
      ...
      class hr {
          ...
          return (
            r.push(
              ...
              new $o.Action({
                ...
                options: { label: Yn, icon: nr, onExecute: () => this.remove(e.id()), hotkeyHash: M.isMacKeyboard ? 8 : 46 }
              }),
              new $o.Separator(),
              new $o.Action({ actionId: s.actionId, options: { label: s.label, icon: s.icon, onExecute: () => this.openProperties(e) } })
            ),
            r
          )
        }
        ...
        _normalizeTargetAndDropType(e, t) {
          ...
          return 'inside' === t && ((t = 'before'), (n = (0, I.ensureNotNull)(this.entity([...n.childrenIds()].shift() || '')))), [n, t]
        }
        _getSelectedEntities() {
          ...
          return t.length && rr.logWarn(`Detected dangling sources in selection. They will be ignored: ${JSON.stringify(t)}`), e
        }
        _getEntityById(e) {
          return this._facade.getObjectById(e)
        }
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(f, { className: i(m.drawer, d[`position${t}`], p), ref: b, 'data-name': e['data-name'] }, u)
            )
          )
        )
      }
    ...
    33127: (e, t, n) => {
      ...
      function a(e, t = s.CheckMobile.any()) {
        const n = (0, o.useRef)(null),
          ...
          p = (0, o.useCallback)(() => {
            if (!a.current) return
            const { clientHeight: e, scrollHeight: t, scrollTop: o, clientWidth: r, scrollWidth: i, scrollLeft: s } = a.current,
            ...
            if (s.CheckMobile.iOS())
              return (
                ...
                () => {
                  a--,
                    null !== c.current &&
                      (l ? 0 === a && (document.body.style.overscrollBehavior = '') : (0, r.enableBodyScroll)(c.current))
                }
              )
          }, []),
    ...
    78135: (e, t, n) => {
      ...
      function c(e, t) {
        return (n) => {
          ...
          y === o.AutoStrict &&
            (p < f.y + f.height + b + h ? ((y = o.Top), (_ = i.FromBottomToTop)) : ((y = o.Bottom), (_ = i.FromTopToBottom)))
    ...
    20626: (e, t, n) => {
      ...
      class g extends o.PureComponent {
              ...
              if (e.currentTarget.contains(e.target))
                ...
                switch (o) {
                  case 27: {
                    ...
                    this._handleToggleDropdown(!1), n && o && (null === (t = this._wrapperRef) || void 0 === t || t.focus())
                    break
                  }
                }
              }
            ...
            ? o.createElement(
                ...
                n &&
                  o.createElement(
                    'div',
                    { className: m.arrow },
                    o.createElement('div', { className: m.arrowWrap }, o.createElement(l.ToolWidgetCaret, { dropped: y }))
                  ),
                this.state.isOpened &&
                  (v ? o.createElement(h.MatchMedia, { rule: v }, (e) => this._renderContent(e)) : this._renderContent(c))
              )
            : o.createElement(
                'div',
                {
        ...
        _renderContent(e) {
          const { menuDataName: t, minWidth: n, menuClassName: r, maxHeight: i, drawerPosition: l = 'Bottom', children: a } = this.props,
    ...
    98945: (e, t, n) => {
      ...
      const s = (0, o.forwardRef)(function (e, t) {
        ...
        return o.createElement(i.ToolWidgetIconButton, { 'aria-label': n, ...s, tag: 'button', ref: l, tabIndex: a, 'data-tooltip': n })
      })
    },
    88811: (e, t, n) => {
      'use strict'
