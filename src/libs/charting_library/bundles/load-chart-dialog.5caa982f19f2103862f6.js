    ...
    69654: (e, t, n) => {
      ...
      function u(e) {
        ...
        return a.createElement(
          ...
          a.createElement('div', { className: r()(c.inputContainer, h, u && c.withCancel) }, o || a.createElement(m, { ...g })),
          t,
          ...
          .map((e) => {
            ...
            return (
              n.forEach((e) => {
                ...
                if (Array.isArray(u))
                  for (const e of u) if (f.test(e)) return (d = 1), void (m = null === (c = e.match(f)) || void 0 === c ? void 0 : c.index)
              }),
            ...
            ? l
                ...
                .map((e, t) =>
                  a.createElement(
                    a.Fragment,
                    { key: t },
                    c[t] ? a.createElement('span', { className: o(i.highlighted, s) }, e) : a.createElement('span', null, e)
                  )
                )
            : l
        )
    ...
    16396: (e, t, n) => {
      ...
      function d(e) {
        ...
        return a.createElement(
          ...
          a.createElement('span', { className: o(R.labelRow, y) }, a.createElement('span', { className: o(R.label, p) }, E)),
          (void 0 !== v || _) && a.createElement('span', { className: R.shortcut }, (J = v) && J.split('+').join(' + ')),
          void 0 !== M &&
            a.createElement('span', { onClick: Z ? m : void 0, className: o(R.toolbox, { [R.showOnHover]: S, [R.showOnFocus]: x }) }, M)
        )
        let J
      }
    },
    ...
    12811: (e, t, n) => {
      ...
      function c(e, t) {
        return (n, c, u, m) => {
          ...
          b === a.AutoStrict &&
            (m < f.y + f.height + v + c ? ((b = a.Top), (C = r.FromBottomToTop)) : ((b = a.Bottom), (C = r.FromTopToBottom)))
