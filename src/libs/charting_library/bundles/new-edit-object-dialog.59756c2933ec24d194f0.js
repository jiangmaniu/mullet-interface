  ...
  [6265],
  {
    ...
    63374: (e, t, l) => {
      ...
      const $ = {
          ...
          [x.LineStudyPlotStyle.StepLine]: { type: x.LineStudyPlotStyle.StepLine, order: 2, icon: F, label: i.t(null, void 0, l(79511)) },
          ...
          [x.LineStudyPlotStyle.Columns]: { type: x.LineStudyPlotStyle.Columns, order: 9, icon: q, label: i.t(null, void 0, l(36018)) },
          [x.LineStudyPlotStyle.Circles]: { type: x.LineStudyPlotStyle.Circles, order: 10, icon: K, label: i.t(null, void 0, l(39495)) }
        },
        X = Object.values($)
      ...
      class re extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            {
              grouped: c,
              label: r.createElement('div', { className: te.childRowContainer }, i.t(t.name, { context: 'input' }, l(88601))),
              offset: p
            },
            ...
            r.createElement(
              ...
              !t &&
                r.createElement(
                  r.Fragment,
                  null,
                  r.createElement(ge, { id: e, title: Fe, color: l, transparency: i, display: s, switchable: !1, offset: !0, grouped: !0 }),
      ...
      class xe extends r.PureComponent {
        render() {
          ...
          return r.createElement(Ee.Select, { id: e, disabled: i, className: l, menuItemClassName: n, items: _e, value: t, onChange: o })
        }
      }
      ...
      class Et extends r.PureComponent {
        ...
        _renderColors() {
          ...
          return l
            ...
            .filter((e) => a.has(e))
            .map((e) =>
              r.createElement(ye, { key: e, id: e, title: e, color: l.childs()[e], visible: i.childs()[e], thickness: n.childs()[e] })
            )
        }
      }
      Et.contextType = L.StylePropertyContext
        ...
        render() {
          ...
          return r.createElement(
            ...
            _ &&
              ...
              r.createElement(
                ye,
                { id: 'vahLines', title: _.name, color: k.childs().color, visible: k.childs().visible, thickness: k.childs().width },
                r.createElement(Xe, {
            ...
            r.createElement(
              ye,
              { id: 'pocLines', title: V.name, color: L.childs().color, visible: L.childs().visible, thickness: L.childs().width },
              r.createElement(Xe, {
      ...
      class dl extends al.DialogRenderer {
        ...
        show(e = {}) {
          ...
          h.hasUserEditableInputs() && s.push({ id: 'inputs', label: i.t(null, void 0, l(66304)), Component: k }),
            ...
            this._propertyPages ||
              s.push({ id: 'visibilities', label: i.t(null, void 0, l(21852)), page: this._createVisibilitiesPropertyPage() }),
    ...
    97456: (e, t, l) => {
      ...
      function ae(e, t, l) {
        ...
        const r = (0, i.createRangePropertyDefinition)(
            ...
            { id: 'IntervalsVisibilitiesMinutes', title: V, min: new s.WatchedValue(ne[0]), max: new s.WatchedValue(ne[1]) }
          ),
          c = (0, i.createRangePropertyDefinition)(
            ...
            { id: 'IntervalsVisibilitiesHours', title: R, min: new s.WatchedValue(re[0]), max: new s.WatchedValue(re[1]) }
          ),
