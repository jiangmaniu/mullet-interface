          ...
          ;(e.disableBodyScroll = function (e, r) {
            if (a) {
              ...
              if (
                ...
                let m = { targetElement: e, options: r || {} }
                ;(n = [].concat(t(n), [m])),
              ...
              ;(p = r),
                setTimeout(function () {
                  if (void 0 === c) {
                    let e = !!p && !0 === p.reserveScrollBarGap,
              ...
              let h = { targetElement: e, options: r || {} }
              n = [].concat(t(n), [h])
            }
            let p
          }),
    ...
    89035: (e, t, o) => {
        ...
        return d
          ? r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(w.PopupMenuItem, { className: D.item, onClick: A, onClickArg: M.CompareOption.NewPane, label: L.newPane })
              )
            )
          : r.createElement(
              'div',
              ...
              r.createElement(
                z,
                { onClick: A, value: M.CompareOption.NewPane, isItemSelected: Boolean(n), isSelected: n && p === M.CompareOption.NewPane },
                L.newPane
              )
            )
        function T(e) {
      ...
      function A(e) {
        const { isSelected: t, fullSymbolName: o, onExpandClick: a, actions: s, id: l, isOffset: c, isYield: d } = e,
          ...
          { compareModel: b, hoveredItemId: w, setHoveredItemId: I, clearInput: C, allowExtendTimeScale: E } = (0, k.useEnsuredContext)(S),
          [N, z] = (0, r.useState)(!1),
          D = (0, r.useRef)(null),
            ...
            onClick: function (t) {
              ...
              if ((n.mobiletouch ? j : !N) && o) {
                ;(0, i.getSymbolSearchCompleteOverrideFunction)()(o).then((e) => {
                  const t = b.comparableOnSameScale({ isYield: d }) ? M.CompareOption.SameScale : M.CompareOption.SamePctScale
            ...
            onKeyDown: function (e) {
              ...
              switch (l) {
                ...
                case 13: {
                  ...
                  a && N && (i([{ symbol: f ? a.toUpperCase() : a, resolved: !1, compareOption: x, allowExtendTimeScale: z }]), N(o, d))
                  break
                }
                case 27:
      ...
      function ee(e) {
        ...
        function n() {
          ...
          t.current &&
            ...
            ('compare' !== a.current ||
            '' ===
              (null === (r = null === (e = null == t ? void 0 : t.current) || void 0 === e ? void 0 : e.value) || void 0 === r
                ? void 0
                : r.trim())
              ? 'symbolSearch' === a.current &&
                '' ===
                  (null === (s = null === (n = null == t ? void 0 : t.current) || void 0 === n ? void 0 : n.value) || void 0 === s
                    ? void 0
                    : s.trim()) &&
                o('compare')
              : o('symbolSearch'))
    ...
    16396: (e, t, o) => {
      ...
      function m(e) {
        ...
        return r.createElement(
          ...
          r.createElement('span', { className: a(P.labelRow, f) }, r.createElement('span', { className: a(P.label, b) }, I)),
          (void 0 !== g || y) && r.createElement('span', { className: P.shortcut }, (Z = g) && Z.split('+').join(' + ')),
          void 0 !== D &&
            r.createElement('span', { onClick: j ? u : void 0, className: a(P.toolbox, { [P.showOnHover]: E, [P.showOnFocus]: N }) }, D)
        )
        let Z
      }
    },
