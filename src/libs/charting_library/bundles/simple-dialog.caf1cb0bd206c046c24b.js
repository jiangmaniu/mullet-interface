;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8890],
  {
    ...
    70493: (e, t, n) => {
      'use strict'
      n.r(t), n.d(t, { confirmModule: () => L, renameModule: () => _, showSimpleDialog: () => I, warningModule: () => A })
      var o = n(50959),
        l = n(11542),
        a = n(97754),
        r = n(64388),
      ...
      var w = n(6467)
      function y(e) {
        const { disabled: t, name: n, title: l, appearance: r, intent: i, handler: s, reference: c, type: u, className: d } = e,
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  (function (t) {
                    ...
                    if ('content' in e)
                      return o.createElement(v.TouchScrollContainer, { className: a(B.content, t && B.small, h) }, e.content)
                    return null
                  })(i),
                  l &&
                    l.length > 0 &&
        ...
        return (
          ...
          o.createElement(
            ...
            (function () {
              ...
              if ('html' in e) return o.createElement('div', { className: U.label, dangerouslySetInnerHTML: { __html: e.html } })
              return null
            })(),
            ...
            actions: [
              {
                ...
                intent: u || 'primary',
                handler: ({ dialogClose: e, innerManager: t }) => v({ newValue: C, focusInput: B, dialogClose: e, innerManager: t })
              },
              {
                name: 'cancel',
                type: 'button',
            ...
            if (r.CheckMobile.iOS())
              return (
                ...
                () => {
                  s--,
                    null !== c.current &&
                      (i ? 0 === s && (document.body.style.overscrollBehavior = '') : (0, l.enableBodyScroll)(c.current))
                }
              )
          }, []),
