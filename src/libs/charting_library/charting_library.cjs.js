...
function t(e, n) {
  const i = { ...e }
  for (const o in n)
    'object' !== typeof e[o] || null === e[o] || Array.isArray(e[o]) ? void 0 !== n[o] && (i[o] = n[o]) : (i[o] = t(e[o], n[o]))
  return i
}
...
const s = class {
  constructor(n) {
    ...
    'dark' === (null !== (s = this._options.theme) && void 0 !== s ? s : 'light').toLowerCase() &&
      ...
      this._options.debug && (i || ((i = !0), console.log('Using CL v26.003 (internal id e793d706 @ 2023-10-05T20:27:44.510Z)'))),
      this._create()
  }
  setDebugMode(t) {
  ...
  _create() {
    ...
    const n =
        null !==
          (e = null === (t = this._options.enabled_features) || void 0 === t ? void 0 : t.includes('iframe_loading_compatibility_mode')) &&
        void 0 !== e &&
        e,
      [i, o] = this._render(!n),
