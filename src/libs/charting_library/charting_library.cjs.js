...
Object.defineProperty(exports, '__esModule', { value: !0 }),
  ...
  (e.ChartPriceScaleLabelsToggleHighLowPriceLabelsVisibility = 'Chart.PriceScale.Labels.ToggleHighLowPriceLabelsVisibility'),
  (e.ChartPriceScaleLabelsToggleAveragePriceLabelVisibility = 'Chart.PriceScale.Labels.ToggleAveragePriceLabelVisibility'),
  (e.ChartPriceScaleLabelsToggleIndicatorsNameLabelsVisibility = 'Chart.PriceScale.Labels.ToggleIndicatorsNameLabelsVisibility'),
  (e.ChartPriceScaleLabelsToggleIndicatorsValueLabelsVisibility = 'Chart.PriceScale.Labels.ToggleIndicatorsValueLabelsVisibility'),
  (e.ChartPriceScaleLabelsTogglePrePostMarketLabelsVisibility = 'Chart.PriceScale.Labels.TogglePrePostMarketLabelsVisibility'),
  (e.ChartPriceScaleLabelsToggleNoOverlappingLabelsVisibility = 'Chart.PriceScale.Labels.ToggleNoOverlappingLabelsVisibility'),
  (e.ChartPriceScaleLabelsToggleSeriesLastValueVisibility = 'Chart.PriceScale.Labels.ToggleSeriesLastValueVisibility'),
  (e.ChartPriceScaleLabelsToggleSymbolNameLabelsVisibility = 'Chart.PriceScale.Labels.ToggleSymbolNameLabelsVisibility'),
  (e.ChartPriceScaleLabelsToggleSymbolPrevCloseValueVisibility = 'Chart.PriceScale.Labels.ToggleSymbolPrevCloseValueVisibility'),
  ...
  (te.Empty = 'empty'),
  ((ie = exports.OverridePriceAxisLastValueMode || (exports.OverridePriceAxisLastValueMode = {}))[(ie.LastPriceAndPercentageValue = 0)] =
  ...
  ((ce = exports.TradedGroupHorizontalAlignment || (exports.TradedGroupHorizontalAlignment = {}))[(ce.Left = 0)] = 'Left'),
...
function fe(e, t) {
  const i = { ...e }
  for (const o in t)
    'object' != typeof e[o] || null === e[o] || Array.isArray(e[o]) ? void 0 !== t[o] && (i[o] = t[o]) : (i[o] = fe(e[o], t[o]))
  return i
}
!(function (e) {
...
const De = class {
  ...
  async _create() {
    var e, t, i, o
    const r =
        null !== (t = null === (e = this._options.enabled_features) || void 0 === e ? void 0 : e.includes('iframe_loading_same_origin')) &&
        void 0 !== t &&
        t,
      n =
        r ||
        (null !==
          (o = null === (i = this._options.enabled_features) || void 0 === i ? void 0 : i.includes('iframe_loading_compatibility_mode')) &&
          void 0 !== o &&
          o),
  ...
  _render(e, t) {
        ...
        l = `\n${(function (e, t, i) {
          ...
          for (const n of e)
            n.endsWith('.js')
              ...
              : n.endsWith('.css') && r.push(`<link type="text/css" href="${t ? n.replace(/\.css$/i, '.rtl.css') : n}" rel="stylesheet"/>`)
          return [...o, ...r].join('\n')
        })(r, 'rtl' === a.dir, n)}\n`
      return `<!DOCTYPE html><html ${(d = { bundles: l, localeLanguage: n, htmlAttrs: s, libraryPath: o }).htmlAttrs}><head><base href="${
        d.libraryPath
    ...
    return [
      `<iframe\n\t\tversion="CL v28.5.0 (internal id fb6f897f @ 2024-12-18T12:27:11.562Z)" id="${this._id}" name="${this._id}" src="${
        n.href
...
const Ve =
  !('undefined' == typeof window || !window.navigator || !window.navigator.userAgent) && window.navigator.userAgent.includes('CriOS')
