  ...
  const r = class {
    constructor(t) {
      ...
      'dark' === (null !== (s = this._options.theme) && void 0 !== s ? s : 'light').toLowerCase() &&
        ...
        this._options.debug && (o || ((o = !0), console.log('Using CL v26.003 (internal id e793d706 @ 2023-10-05T20:27:44.510Z)'))),
        this._create()
    }
    setDebugMode(t) {
    ...
    _create() {
      ...
      const n =
          null !==
            (e =
              null === (t = this._options.enabled_features) || void 0 === t ? void 0 : t.includes('iframe_loading_compatibility_mode')) &&
          void 0 !== e &&
          e,
        [i, o] = this._render(!n),
