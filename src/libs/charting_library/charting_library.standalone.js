var TradingView = (function (e) {
  ...
  ;((t = e.ActionId || (e.ActionId = {})).UnknownAction = 'UnknownAction'),
    ...
    (ie.Empty = 'empty'),
    ((oe = e.OverridePriceAxisLastValueMode || (e.OverridePriceAxisLastValueMode = {}))[(oe.LastPriceAndPercentageValue = 0)] =
  ...
  const Ve = class {
    ...
    async _create() {
      ...
      const r =
          null !==
            (t = null === (e = this._options.enabled_features) || void 0 === e ? void 0 : e.includes('iframe_loading_same_origin')) &&
          void 0 !== t &&
          t,
        n =
          r ||
          (null !==
            (o =
              null === (i = this._options.enabled_features) || void 0 === i ? void 0 : i.includes('iframe_loading_compatibility_mode')) &&
            void 0 !== o &&
            o),
