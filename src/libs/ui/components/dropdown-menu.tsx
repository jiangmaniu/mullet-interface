...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Trigger
    ref={ref}
    className={cn('[&>svg.action-icon]:transition-transform [&[data-state=open]>svg.action-icon]:rotate-180', className)}
...
>(({ className, inset, variant = 'default', ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'outline-hidden relative flex cursor-default select-none items-center gap-2 rounded-[6px] px-2.5 py-3 focus:bg-primary focus:text-[white] data-[inset]:pl-8',
