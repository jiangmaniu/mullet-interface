...
export const HeaderRightContent = () => {
  ...
  const renderAccountBoxHover = () => {
    ...
    return (
      <div className="z-[999] group-hover:block xl:absolute xl:top-[53px] xl:hidden xl:shadow-[0px_2px_10px_10px_rgba(227,227,227,0.1)]">
        <div className="min-h-[338px] rounded-b-xl rounded-tr-xl bg-white pb-1 xl:min-w-[380px] xl:border xl:border-[#f3f3f3] xl:pt-[18px] xl:shadow-[0px_2px_10px_10px_rgba(227,227,227,0.1)]">
          <div
            onClick={() => {
              // push('/trade')
            }}
          ...
          <div className="mb-[13px] px-[18px]">
            ...
            <div className="mt-[10px]">
              <Button
                ...
                onClick={() => {
                  // props.user.navIndex = 4
                  // if (isMobileOrIpad) {
                  //   push('/user/outInRecord')
                  // } else {
                  //   push('/user')
                  // }
                }}
  ...
  return (
    <div className="flex items-center">
      <div className="flex items-center gap-x-[26px] mr-[28px]">
        ...
        <img src="/img/uc/user.png" width={36} height={36} />
        <img src="/img/uc/kefu.png" width={36} height={36} />
        <img src="/img/uc/quan.png" width={36} height={36} />
        <img src="/img/uc/caidan.png" width={36} height={36} />
      </div>
      <SwitchLanguage />
    </div>
  )
