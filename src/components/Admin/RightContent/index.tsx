      ...
      <div className="flex items-center md:gap-x-[26px] md:mr-[28px] sm:gap-x-3 sm:mr-4 gap-x-2 mr-1">
          ...
          >
            ...
            >
              <div className="flex flex-col items-end group relative">
                <span className="text-lg !font-dingpro-regular dark:text-primary">{formatNum(balance, { precision: 2 })} USD</span>
                <div className="flex items-center">
        ...
        <Dropdown
          ...
          dropdownRender={(origin) => {
            return (
              <div className="flex p-5 bg-white dark:bg-[var(--dropdown-bg)] w-[290px] z-[800] rounded-xl shadow-dropdown dark:shadow-none dark:border-[--dropdown-border-color] dark:border">
